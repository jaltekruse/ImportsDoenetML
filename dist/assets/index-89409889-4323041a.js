...
See also the "\`dev\` branch (2014–2015) → v0.10.0 Migration Guide" at
  https://github.com/mathquill/mathquill/wiki/%60dev%60-branch-(2014%E2%80%932015)-%E2%86%92-v0.10.0-Migration-Guide`)})(),nt},nt.getInterface=qt;var yr=qt.MIN=1,mt=qt.MAX=2;function qt(c){if(!(yr<=c&&c<=mt))throw"Only interface versions between "+yr+" and "+mt+" supported. You specified: "+c;function d(v){if(!v||!v.nodeType)return null;var k=le(v).children(".mq-root-block").attr(me),w=k&&be.byId[k].controller;return w?r[w.KIND_OF_MQ](w):null}var r={};function n(v,k){for(var w in k&&k.handlers&&(k.handlers={fns:k.handlers,APIClasses:r}),k)if(k.hasOwnProperty(w)){var O=k[w],I=Tt[w];v[w]=I?I(O):O}}d.L=f,d.R=1,d.saneKeyboardEvents=or,d.config=function(v){return n(rt.p,v),this},d.registerEmbed=function(v,k){if(!/^[a-z][a-z0-9]*$/i.test(v))throw"Embed name must start with letter and be only letters and digits";Mt[v]=k};var l=r.AbstractMathQuill=L(Pt,function(v){v.init=function(k){this.__controller=k,this.__options=k.options,this.id=k.id,this.data=k.data},v.__mathquillify=function(k){var w=this.__controller,O=w.root,I=w.container;w.createTextarea();var U=I.addClass(k).contents().detach();O.jQ=le('<span class="mq-root-block"/>').attr(me,O.id).appendTo(I),this.latex(U.text()),this.revert=function(){return I.empty().unbind(".mathquill").removeClass("mq-editable-field mq-math-mode mq-text-mode").append(U)}},v.config=function(k){return n(this.__options,k),this},v.el=function(){return this.__controller.container[0]},v.text=function(){return this.__controller.exportText()},v.latex=function(k){return arguments.length>0?(this.__controller.renderLatexMath(k),this.__controller.blurred&&this.__controller.cursor.hide().parent.blur(),this):this.__controller.exportLatex()},v.html=function(){return this.__controller.root.jQ.html().replace(/ mathquill-(?:command|block)-id="?\d+"?/g,"").replace(/<span class="?mq-cursor( mq-blink)?"?>.?<\/span>/i,"").replace(/ mq-hasCursor|mq-hasCursor ?/,"").replace(/ class=(""|(?= |>))/g,"")},v.reflow=function(){return this.__controller.root.postOrder("reflow"),this}});for(var y in d.prototype=l.prototype,r.EditableField=L(l,function(v,k){v.__mathquillify=function(){return k.__mathquillify.apply(this,arguments),this.__controller.editable=!0,this.__controller.delegateMouseEvents(),this.__controller.editablesTextareaEvents(),this},v.focus=function(){return this.__controller.textarea.focus(),this},v.blur=function(){return this.__controller.textarea.blur(),this},v.write=function(w){return this.__controller.writeLatex(w),this.__controller.scrollHoriz(),this.__controller.blurred&&this.__controller.cursor.hide().parent.blur(),this},v.empty=function(){var w=this.__controller.root,O=this.__controller.cursor;return w.eachChild("postOrder","dispose"),w.ends[f]=w.ends[1]=0,w.jQ.empty(),delete O.selection,O.insAtRightEnd(w),this},v.cmd=function(w){var O=this.__controller.notify(),I=O.cursor;if(/^\\[a-z]+$/i.test(w)&&!I.isTooDeep()){w=w.slice(1);var U=s[w];U&&(w=U(w),I.selection&&w.replaces(I.replaceSelection()),w.createLeftOf(I.show()),this.__controller.scrollHoriz())}else I.parent.write(I,w);return O.blurred&&I.hide().parent.blur(),this},v.select=function(){var w=this.__controller;for(w.notify("move").cursor.insAtRightEnd(w.root);w.cursor[f];)w.selectLeft();return this},v.clearSelection=function(){return this.__controller.cursor.clearSelection(),this},v.moveToDirEnd=function(w){return this.__controller.notify("move").cursor.insAtDirEnd(w,this.__controller.root),this},v.moveToLeftEnd=function(){return this.moveToDirEnd(f)},v.moveToRightEnd=function(){return this.moveToDirEnd(1)},v.keystroke=function(w){w=w.replace(/^\s+|\s+$/g,"").split(/\s+/);for(var O=0;O<w.length;O+=1)this.__controller.keystroke(w[O],{preventDefault:xe});return this},v.typedText=function(w){for(var O=0;O<w.length;O+=1)this.__controller.typedText(w.charAt(O));return this},v.dropEmbedded=function(w,O,I){var U=w-le(window).scrollLeft(),Y=O-le(window).scrollTop(),ue=document.elementFromPoint(U,Y);this.__controller.seek(le(ue),w,O),Ar().setOptions(I).createLeftOf(this.__controller.cursor)},v.clickAt=function(w,O,I){I=I||document.elementFromPoint(w,O);var U=this.__controller,Y=U.root;return se.contains(Y.jQ[0],I)||(I=Y.jQ[0]),U.seek(le(I),w+pageXOffset,O+pageYOffset),U.blurred&&this.focus(),this},v.ignoreNextMousedown=function(w){return this.__controller.cursor.options.ignoreNextMousedown=w,this}}),d.EditableField=function(){throw"wtf don't call me, I'm 'abstract'"},d.EditableField.prototype=r.EditableField.prototype,Qe)(function(v,k){var w=r[v]=k(r);d[v]=function(O,I){var U=d(O);if(U instanceof w||!O||!O.nodeType)return U;var Y=Ie(w.RootBlock(),le(O),rt());return Y.KIND_OF_MQ=v,w(Y).__mathquillify(I,c)},d[v].prototype=w.prototype})(y,Qe[y]);return d}nt.noConflict=function(){return window.MathQuill=ir,nt};var ir=window.MathQuill;function gr(c){for(var d="moveOutOf deleteOutOf selectOutOf upOutOf downOutOf".split(" "),r=0;r<d.length;r+=1)(function(n){c[n]=function(l){this.controller.handle(n,l)}})(d[r]);c.reflow=function(){this.controller.handle("reflow"),this.controller.handle("edited"),this.controller.handle("edit")}}window.MathQuill=nt;var Sr,or=(Sr={8:"Backspace",9:"Tab",10:"Enter",13:"Enter",16:"Shift",17:"Control",18:"Alt",20:"CapsLock",27:"Esc",32:"Spacebar",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"Left",38:"Up",39:"Right",40:"Down",45:"Insert",46:"Del",144:"NumLock"},function(c,d){var r,n=null,l=null,y=se(c),v=se(d.container||y),k=xe;function w(z){k=z,clearTimeout(r),r=setTimeout(z)}function O(z){w(function(fe){k=xe,clearTimeout(r),z(fe)})}v.bind("keydown keypress input keyup focusout paste",function(z){k(z)});var I=!1;function U(){d.keystroke(function(z){var fe,ie=z.which||z.keyCode,Te=Sr[ie],Ke=[];return z.ctrlKey&&Ke.push("Ctrl"),z.originalEvent&&z.originalEvent.metaKey&&Ke.push("Meta"),z.altKey&&Ke.push("Alt"),z.shiftKey&&Ke.push("Shift"),fe=Te||String.fromCharCode(ie),Ke.length||Te?(Ke.push(fe),Ke.join("-")):fe}(n),n)}function Y(){if(!("selectionStart"in(z=y[0]))||z.selectionStart===z.selectionEnd){var z,fe=y.val();fe.length===1?(y.val(""),d.typedText(fe)):fe&&y[0].select&&y[0].select()}}function ue(){var z=y.val();y.val(""),z&&d.paste(z)}return v.bind({keydown:function(z){n=z,l=null,I&&O(function(fe){fe&&fe.type==="focusout"||!y[0].select||y[0].select()}),U()},keypress:function(z){n&&l&&U(),l=z,w(Y)},keyup:function(z){n&&!l&&w(Y)},focusout:function(){n=l=null},cut:function(){O(function(){d.cut()})},copy:function(){O(function(){d.copy()})},paste:function(z){y.focus(),w(ue)}}),{select:function(z){k(),k=xe,clearTimeout(r),y.val(z),z&&y[0].select&&y[0].select(),I=!!z}}}),Z=L(function(c,d,r){function n(k,w){throw"Parse Error: "+w+" at "+(k?"'"+k+"'":"EOF")}c.init=function(k){this._=k},c.parse=function(k){return this.skip(v)._(""+k,function(w,O){return O},n)},c.or=function(k){B("or is passed a parser",k instanceof r);var w=this;return r(function(O,I,U){return w._(O,I,function(Y){return k._(O,I,U)})})},c.then=function(k){var w=this;return r(function(O,I,U){return w._(O,function(Y,ue){var z=k instanceof r?k:k(ue);return B("a parser is returned",z instanceof r),z._(Y,I,U)},U)})},c.many=function(){var k=this;return r(function(w,O,I){for(var U=[];k._(w,Y,ue););return O(w,U);function Y(z,fe){return w=z,U.push(fe),!0}function ue(){return!1}})},c.times=function(k,w){arguments.length<2&&(w=k);var O=this;return r(function(I,U,Y){for(var ue,z=[],fe=!0,ie=0;ie<k;ie+=1)if(!(fe=O._(I,Te,Ke)))return Y(I,ue);for(;ie<w&&fe;ie+=1)fe=O._(I,Te,Yr);return U(I,z);function Te(pr,Yt){return z.push(Yt),I=pr,!0}function Ke(pr,Yt){return ue=Yt,I=pr,!1}function Yr(pr,Yt){return!1}})},c.result=function(k){return this.then(y(k))},c.atMost=function(k){return this.times(0,k)},c.atLeast=function(k){var w=this;return w.times(k).then(function(O){return w.many().map(function(I){return O.concat(I)})})},c.map=function(k){return this.then(function(w){return y(k(w))})},c.skip=function(k){return this.then(function(w){return k.result(w)})},this.string=function(k){var w=k.length,O="expected '"+k+"'";return r(function(I,U,Y){var ue=I.slice(0,w);return ue===k?U(I.slice(w),ue):Y(I,O)})};var l=this.regex=function(k){B("regexp parser is anchored",k.toString().charAt(1)==="^");var w="expected "+k;return r(function(O,I,U){var Y=k.exec(O);if(Y){var ue=Y[0];return I(O.slice(ue.length),ue)}return U(O,w)})},y=r.succeed=function(k){return r(function(w,O){return O(w,k)})},v=(r.fail=function(k){return r(function(w,O,I){return I(w,k)})},r.letter=l(/^[a-z]/i),r.letters=l(/^[a-z]*/i),r.digit=l(/^[0-9]/),r.digits=l(/^[0-9]*/),r.whitespace=l(/^\s+/),r.optWhitespace=l(/^\s*/),r.any=r(function(k,w,O){return k?w(k.slice(1),k.charAt(0)):O(k,"expected any character")}),r.all=r(function(k,w,O){return w("",k)}),r.eof=r(function(k,w,O){return k?O(k,"expected EOF"):w(k,k)}))});Ie.open(function(c){c.focusBlurEvents=function(){var d,r=this,n=r.root,l=r.cursor;function y(){clearTimeout(d),l.selection&&l.selection.jQ.addClass("mq-blur"),v()}function v(){l.hide().parent.blur(),r.container.removeClass("mq-focused"),le(window).unbind("blur",y)}r.textarea.focus(function(){r.blurred=!1,clearTimeout(d),r.container.addClass("mq-focused"),l.parent||l.insAtRightEnd(n),l.selection?(l.selection.jQ.removeClass("mq-blur"),r.selectionChanged()):l.show()}).blur(function(){r.blurred=!0,d=setTimeout(function(){n.postOrder("intentionalBlur"),l.clearSelection().endSelection(),v()}),le(window).bind("blur",y)}),r.blurred=!0,l.hide().parent.blur()}}),Ie.open(function(c,d){c.exportText=function(){return this.root.foldChildren("",function(r,n){return r+n.text()})}}),Ie.open(function(c){rt.p.ignoreNextMousedown=xe,c.delegateMouseEvents=function(){var d=this.root.jQ;this.container.bind("mousedown.mathquill",function(r){var n,l=le(r.target).closest(".mq-root-block"),y=be.byId[l.attr(me)||d.attr(me)].controller,v=y.cursor,k=v.blink,w=y.textareaSpan,O=y.textarea;function I(Y){n=le(Y.target)}function U(Y){v.anticursor||v.startSelection(),y.seek(n,Y.pageX,Y.pageY).cursor.select(),n=ce}r.preventDefault(),r.target.unselectable=!0,v.options.ignoreNextMousedown(r)||(v.options.ignoreNextMousedown=xe,y.blurred&&(y.editable||l.prepend(w),O.focus()),v.blink=xe,y.seek(le(r.target),r.pageX,r.pageY).cursor.startSelection(),l.mousemove(I),le(r.target.ownerDocument).mousemove(U).mouseup(function Y(ue){v.blink=k,v.selection||(y.editable?v.show():w.detach()),l.unbind("mousemove",I),le(ue.target.ownerDocument).unbind("mousemove",U).unbind("mouseup",Y)}))})}}),Ie.open(function(c){c.seek=function(d,r,n){var l=this.notify("select").cursor;if(d){var y=d.attr(me)||d.attr(pe);if(!y){var v=d.parent();y=v.attr(me)||v.attr(pe)}}var k=y?be.byId[y]:this.root;return B("nodeId is the id of some Node that exists",k),l.clearSelection().show(),k.seek(r,l),this.scrollHoriz(),this}}),Ie.open(function(c){c.keystroke=function(d,r){this.cursor.parent.keystroke(d,r,this)}}),be.open(function(c){c.keystroke=function(d,r,n){var l=n.cursor;switch(d){case"Ctrl-Shift-Backspace":case"Ctrl-Backspace":n.ctrlDeleteDir(f);break;case"Shift-Backspace":case"Backspace":n.backspace();break;case"Esc":case"Tab":return void n.escapeDir(1,d,r);case"Shift-Tab":case"Shift-Esc":return void n.escapeDir(f,d,r);case"End":n.notify("move").cursor.insAtRightEnd(l.parent);break;case"Ctrl-End":n.notify("move").cursor.insAtRightEnd(n.root);break;case"Shift-End":for(;l[1];)n.selectRight();break;case"Ctrl-Shift-End":for(;l[1]||l.parent!==n.root;)n.selectRight();break;case"Home":n.notify("move").cursor.insAtLeftEnd(l.parent);break;case"Ctrl-Home":n.notify("move").cursor.insAtLeftEnd(n.root);break;case"Shift-Home":for(;l[f];)n.selectLeft();break;case"Ctrl-Shift-Home":for(;l[f]||l.parent!==n.root;)n.selectLeft();break;case"Left":n.moveLeft();break;case"Shift-Left":n.selectLeft();break;case"Ctrl-Left":break;case"Right":n.moveRight();break;case"Shift-Right":n.selectRight();break;case"Ctrl-Right":break;case"Up":n.moveUp();break;case"Down":n.moveDown();break;case"Shift-Up":if(l[f])for(;l[f];)n.selectLeft();else n.selectLeft();case"Shift-Down":if(l[1])for(;l[1];)n.selectRight();else n.selectRight();case"Ctrl-Up":case"Ctrl-Down":break;case"Ctrl-Shift-Del":case"Ctrl-Del":n.ctrlDeleteDir(1);break;case"Shift-Del":case"Del":n.deleteForward();break;case"Meta-A":case"Ctrl-A":for(n.notify("move").cursor.insAtRightEnd(n.root);l[f];)n.selectLeft();break;default:return}r.preventDefault(),n.scrollHoriz()},c.moveOutOf=c.moveTowards=c.deleteOutOf=c.deleteTowards=c.unselectInto=c.selectOutOf=c.selectTowards=function(){B("overridden or never called on this node")}}),Ie.open(function(c){function d(r,n){var l=r.notify("upDown").cursor,y=n+"Into",v=n+"OutOf";return l[1][y]?l.insAtLeftEnd(l[1][y]):l[f][y]?l.insAtRightEnd(l[f][y]):l.parent.bubble(function(k){var w=k[v];if(w&&(typeof w=="function"&&(w=k[v](l)),w instanceof be&&l.jumpUpDown(k,w),w!==!0))return!1}),r}this.onNotify(function(r){r!=="move"&&r!=="upDown"||this.show().clearSelection()}),c.escapeDir=function(r,n,l){$(r);var y=this.cursor;if(y.parent!==this.root&&l.preventDefault(),y.parent!==this.root)return y.parent.moveOutOf(r,y),this.notify("move")},Tt.leftRightIntoCmdGoes=function(r){if(r&&r!=="up"&&r!=="down")throw'"up" or "down" required for leftRightIntoCmdGoes option, got "'+r+'"';return r},c.moveDir=function(r){$(r);var n=this.cursor,l=n.options.leftRightIntoCmdGoes;return n.selection?n.insDirOf(r,n.selection.ends[r]):n[r]?n[r].moveTowards(r,n,l):n.parent.moveOutOf(r,n,l),this.notify("move")},c.moveLeft=function(){return this.moveDir(f)},c.moveRight=function(){return this.moveDir(1)},c.moveUp=function(){return d(this,"up")},c.moveDown=function(){return d(this,"down")},this.onNotify(function(r){r!=="upDown"&&(this.upDownCache={})}),this.onNotify(function(r){r==="edit"&&this.show().deleteSelection()}),c.deleteDir=function(r){$(r);var n=this.cursor,l=n.selection;return this.notify("edit"),l||(n[r]?n[r].deleteTowards(r,n):n.parent.deleteOutOf(r,n)),n[f].siblingDeleted&&n[f].siblingDeleted(n.options,1),n[1].siblingDeleted&&n[1].siblingDeleted(n.options,f),n.parent.bubble("reflow"),this},c.ctrlDeleteDir=function(r){$(r);var n=this.cursor;return!n[r]||n.selection?this.deleteDir(r):(this.notify("edit"),r===f?a(n.parent.ends[f],n[f]).remove():a(n[1],n.parent.ends[1]).remove(),n.insAtDirEnd(r,n.parent),n[f].siblingDeleted&&n[f].siblingDeleted(n.options,1),n[1].siblingDeleted&&n[1].siblingDeleted(n.options,f),n.parent.bubble("reflow"),this)},c.backspace=function(){return this.deleteDir(f)},c.deleteForward=function(){return this.deleteDir(1)},this.onNotify(function(r){r!=="select"&&this.endSelection()}),c.selectDir=function(r){var n=this.notify("select").cursor,l=n.selection;$(r),n.anticursor||n.startSelection();var y=n[r];y?l&&l.ends[r]===y&&n.anticursor[-r]!==y?y.unselectInto(r,n):y.selectTowards(r,n):n.parent.selectOutOf(r,n),n.clearSelection(),n.select()||n.show()},c.selectLeft=function(){return this.selectDir(f)},c.selectRight=function(){return this.selectDir(1)}}),Ie.open(function(c){rt.p.substituteTextarea=function(){return le("<textarea autocapitalize=off autocomplete=off autocorrect=off spellcheck=false x-palm-disable-ste-all=true />")[0]},c.createTextarea=function(){var d=this.textareaSpan=le('<span class="mq-textarea"></span>'),r=this.options.substituteTextarea();if(!r.nodeType)throw"substituteTextarea() must return a DOM element, got "+r;r=this.textarea=le(r).appendTo(d);var n=this;n.cursor.selectionChanged=function(){n.selectionChanged()}},c.selectionChanged=function(){var d=this;Dt(d.container[0]),d.textareaSelectionTimeout===ce&&(d.textareaSelectionTimeout=setTimeout(function(){d.setTextareaSelection()}))},c.setTextareaSelection=function(){this.textareaSelectionTimeout=ce;var d="";this.cursor.selection&&(d=this.cursor.selection.join("latex"),this.options.statelessClipboard&&(d="$"+d+"$")),this.selectFn(d)},c.staticMathTextareaEvents=function(){var d=this,r=(d.root,d.cursor),n=d.textarea,l=d.textareaSpan;function y(){l.detach(),d.blurred=!0}this.container.prepend(se('<span class="mq-selectable">').text("$"+d.exportLatex()+"$")),d.blurred=!0,n.bind("cut paste",!1).bind("copy",function(){d.setTextareaSelection()}).focus(function(){d.blurred=!1}).blur(function(){r.selection&&r.selection.clear(),setTimeout(y)}),d.selectFn=function(v){n.val(v),v&&n.select()}},rt.p.substituteKeyboardEvents=or,c.editablesTextareaEvents=function(){var d=this.textarea,r=this.textareaSpan,n=this.options.substituteKeyboardEvents(d,this);this.selectFn=function(l){n.select(l)},this.container.prepend(r),this.focusBlurEvents()},c.typedText=function(d){if(d===`
`)return this.handle("enter");var r=this.notify().cursor;r.parent.write(r,d),this.scrollHoriz()},c.cut=function(){var d=this,r=d.cursor;r.selection&&setTimeout(function(){d.notify("edit"),r.parent.bubble("reflow")})},c.copy=function(){this.setTextareaSelection()},c.paste=function(d){this.options.statelessClipboard&&(d=d.slice(0,1)==="$"&&d.slice(-1)==="$"?d.slice(1,-1):"\\text{"+d+"}"),this.writeLatex(d).cursor.show()}});var Re=function(){function c(ie){for(var Te=ie[0]||Me(),Ke=1;Ke<ie.length;Ke+=1)ie[Ke].children().adopt(Te,Te.ends[1],0);return Te}var d=Z.string,r=Z.regex,n=Z.letter,l=Z.any,y=Z.optWhitespace,v=Z.succeed,k=Z.fail,w=n.map(function(ie){return et(ie)}),O=r(/^[^${}\\_^]/).map(function(ie){return j(ie)}),I=r(/^[^\\a-eg-zA-Z]/).or(d("\\").then(r(/^[a-z]+/i).or(r(/^\s+/).result(" ")).or(l))).then(function(ie){var Te=s[ie];return Te?Te(ie).parser():k("unknown command: \\"+ie)}).or(w).or(O),U=d("{").then(function(){return ue}).skip(d("}")),Y=y.then(U.or(I.map(function(ie){var Te=Me();return ie.adopt(Te,0,0),Te}))),ue=Y.many().map(c).skip(y),z=d("[").then(Y.then(function(ie){return ie.join("latex")!=="]"?v(ie):k()}).many().map(c).skip(y)).skip(d("]")),fe=ue;return fe.block=Y,fe.optBlock=z,fe}();Ie.open(function(c,d){c.exportLatex=function(){return this.root.latex().replace(/(\\[a-z]+) (?![a-z])/gi,"$1")},Tt.maxDepth=function(r){return typeof r=="number"?r:ce},c.writeLatex=function(r){var n=this.notify("edit").cursor,l=Z.all,y=Z.eof,v=Re.skip(y).or(l.result(!1)).parse(r);return v&&!v.isEmpty()&&v.prepareInsertionAt(n)&&(v.children().adopt(n.parent,n[f],n[1]),v.jQize().insertBefore(n.jQ),n[f]=v.ends[1],v.finalizeInsert(n.options,n),v.ends[1][1].siblingCreated&&v.ends[1][1].siblingCreated(n.options,f),v.ends[f][f].siblingCreated&&v.ends[f][f].siblingCreated(n.options,1),n.parent.bubble("reflow")),this},c.renderLatexMath=function(r){var n=this.root,l=this.cursor,y=(l.options,n.jQ),v=Z.all,k=Z.eof,w=Re.skip(k).or(v.result(!1)).parse(r);if(n.eachChild("postOrder","dispose"),n.ends[f]=n.ends[1]=0,w&&w.prepareInsertionAt(l)){w.children().adopt(n,0,0);var O=w.join("html");y.html(O),n.jQize(y.children()),n.finalizeInsert(l.options)}else y.empty();delete l.selection,l.insAtRightEnd(n)},c.renderLatexText=function(r){var n=this.root,l=this.cursor;n.jQ.children().slice(1).remove(),n.eachChild("postOrder","dispose"),n.ends[f]=n.ends[1]=0,delete l.selection,l.show().insAtRightEnd(n);var y=Z.regex,v=Z.string,k=Z.eof,w=Z.all,O=v("$").then(Re).skip(v("$").or(k)).map(function(ue){var z=br(l);z.createBlocks();var fe=z.ends[f];return ue.children().adopt(fe,0,0),z}),I=v("\\$").result("$").or(y(/^[^$]/)).map(j),U=O.or(I).many().skip(k).or(w.result(!1)).parse(r);if(U){for(var Y=0;Y<U.length;Y+=1)U[Y].adopt(n,n.ends[1],0);n.jQize().appendTo(n.jQ),n.finalizeInsert(l.options)}}}),Ie.open(function(c){c.scrollHoriz=function(){var d=this.cursor,r=d.selection,n=this.root.jQ[0].getBoundingClientRect();if(r){var l=r.jQ[0].getBoundingClientRect(),y=l.left-(n.left+20),v=l.right-(n.right-20);if(r.ends[f]===d[1])if(y<0)w=y;else{if(!(v>0))return;w=l.left-v<n.left+20?y:v}else if(v>0)w=v;else{if(!(y<0))return;w=l.right-y>n.right-20?v:y}}else{var k=d.jQ[0].getBoundingClientRect().left;if(k>n.right-20)var w=k-(n.right-20);else{if(!(k<n.left+20))return;w=k-(n.left+20)}}this.root.jQ.stop().animate({scrollLeft:"+="+w},100)}});var Er=L(be,function(c,d){c.finalizeInsert=function(r,n){var l=this;l.postOrder("finalizeTree",r),l.postOrder("contactWeld",n),l.postOrder("blur"),l.postOrder("reflow"),l[1].siblingCreated&&l[1].siblingCreated(r,f),l[f].siblingCreated&&l[f].siblingCreated(r,1),l.bubble("reflow")},c.prepareInsertionAt=function(r){var n=r.options.maxDepth;if(n!==ce){var l=r.depth();if(l>n)return!1;this.removeNodesDeeperThan(n-l)}return!0},c.removeNodesDeeperThan=function(r){for(var n,l=0,y=[[this,l]];y.length;)(n=y.shift())[0].children().each(function(v){var k=v instanceof Me?1:0;(l=n[1]+k)<=r?y.push([v,l]):(k?v.children():v).remove()})}}),qe=L(Er,function(c,d){c.init=function(r,n,l){var y=this;d.init.call(y),y.ctrlSeq||(y.ctrlSeq=r),n&&(y.htmlTemplate=n),l&&(y.textTemplate=l)},c.replaces=function(r){r.disown(),this.replacedFragment=r},c.isEmpty=function(){return this.foldChildren(!0,function(r,n){return r&&n.isEmpty()})},c.parser=function(){var r=Re.block,n=this;return r.times(n.numBlocks()).map(function(l){n.blocks=l;for(var y=0;y<l.length;y+=1)l[y].adopt(n,n.ends[1],0);return n})},c.createLeftOf=function(r){var n=this,l=n.replacedFragment;n.createBlocks(),d.createLeftOf.call(n,r),l&&(l.adopt(n.ends[f],0,0),l.jQ.appendTo(n.ends[f].jQ),n.placeCursor(r),n.prepareInsertionAt(r)),n.finalizeInsert(r.options),n.placeCursor(r)},c.createBlocks=function(){for(var r=this,n=r.numBlocks(),l=r.blocks=Array(n),y=0;y<n;y+=1)(l[y]=Me()).adopt(r,r.ends[1],0)},c.placeCursor=function(r){r.insAtRightEnd(this.foldChildren(this.ends[f],function(n,l){return n.isEmpty()?n:l}))},c.moveTowards=function(r,n,l){var y=l&&this[l+"Into"];n.insAtDirEnd(-r,y||this.ends[-r])},c.deleteTowards=function(r,n){this.isEmpty()?n[r]=this.remove()[r]:this.moveTowards(r,n,null)},c.selectTowards=function(r,n){n[-r]=this,n[r]=this[r]},c.selectChildren=function(){return ht(this,this)},c.unselectInto=function(r,n){n.insAtDirEnd(-r,n.anticursor.ancestors[this.id])},c.seek=function(r,n){function l(w){var O={};return O[f]=w.jQ.offset().left,O[1]=O[f]+w.jQ.outerWidth(),O}var y=this,v=l(y);if(r<v[f])return n.insLeftOf(y);if(r>v[1])return n.insRightOf(y);var k=v[f];y.eachChild(function(w){var O=l(w);return r<O[f]?(r-k<O[f]-r?w[f]?n.insAtRightEnd(w[f]):n.insLeftOf(y):n.insAtLeftEnd(w),!1):r>O[1]?void(w[1]?k=O[1]:v[1]-r<r-O[1]?n.insRightOf(y):n.insAtRightEnd(w)):(w.seek(r,n),!1)})},c.numBlocks=function(){var r=this.htmlTemplate.match(/&\d+/g);return r?r.length:0},c.html=function(){var r=this,n=r.blocks,l=" mathquill-command-id="+r.id,y=r.htmlTemplate.match(/<[^<>]+>|[^<>]+/g);B("no unmatched angle brackets",y.join("")===this.htmlTemplate);for(var v=0,k=y[0];k;k=y[v+=1])if(k.slice(-2)==="/>")y[v]=k.slice(0,-2)+l+"/>";else if(k.charAt(0)==="<"){B("not an unmatched top-level close tag",k.charAt(1)!=="/"),y[v]=k.slice(0,-1)+l+">";var w=1;do B("no missing close tags",k=y[v+=1]),k.slice(0,2)==="</"?w-=1:k.charAt(0)==="<"&&k.slice(-2)!=="/>"&&(w+=1);while(w>0)}return y.join("").replace(/>&(\d+)/g,function(O,I){return" mathquill-block-id="+n[I].id+">"+n[I].join("html")})},c.latex=function(){return this.foldChildren(this.ctrlSeq,function(r,n){return r+"{"+(n.latex()||" ")+"}"})},c.textTemplate=[""],c.text=function(){var r=this,n=0;return r.foldChildren(r.textTemplate[n],function(l,y){n+=1;var v=y.text();return l&&r.textTemplate[n]==="("&&v[0]==="("&&v.slice(-1)===")"?l+v.slice(1,-1)+r.textTemplate[n]:l+v+(r.textTemplate[n]||"")})}}),ct=L(qe,function(c,d){c.init=function(r,n,l){l||(l=r&&r.length>1?r.slice(1):r),d.init.call(this,r,n,[l])},c.parser=function(){return Z.succeed(this)},c.numBlocks=function(){return 0},c.replaces=function(r){r.remove()},c.createBlocks=xe,c.moveTowards=function(r,n){n.jQ.insDirOf(r,this.jQ),n[-r]=this,n[r]=this[r]},c.deleteTowards=function(r,n){n[r]=this.remove()[r]},c.seek=function(r,n){r-this.jQ.offset().left<this.jQ.outerWidth()/2?n.insLeftOf(this):n.insRightOf(this)},c.latex=function(){return this.ctrlSeq},c.text=function(){return this.textTemplate},c.placeCursor=xe,c.isEmpty=function(){return!0}}),j=L(ct,function(c,d){c.init=function(r,n){d.init.call(this,r,"<span>"+(n||r)+"</span>")}}),ee=L(ct,function(c,d){c.init=function(r,n,l){d.init.call(this,r,'<span class="mq-binary-operator">'+n+"</span>",l)}}),Me=L(Er,function(c,d){c.join=function(r){return this.foldChildren("",function(n,l){return n+l[r]()})},c.html=function(){return this.join("html")},c.latex=function(){return this.join("latex")},c.text=function(){return this.ends[f]===this.ends[1]&&this.ends[f]!==0?this.ends[f].text():this.join("text")},c.keystroke=function(r,n,l){return!l.options.spaceBehavesLikeTab||r!=="Spacebar"&&r!=="Shift-Spacebar"?d.keystroke.apply(this,arguments):(n.preventDefault(),void l.escapeDir(r==="Shift-Spacebar"?f:1,r,n))},c.moveOutOf=function(r,n,l){l&&this.parent[l+"Into"]||!this[r]?n.insDirOf(r,this.parent):n.insAtDirEnd(-r,this[r])},c.selectOutOf=function(r,n){n.insDirOf(r,this.parent)},c.deleteOutOf=function(r,n){n.unwrapGramp()},c.seek=function(r,n){var l=this.ends[1];if(!l||l.jQ.offset().left+l.jQ.outerWidth()<r)return n.insAtRightEnd(this);if(r<this.ends[f].jQ.offset().left)return n.insAtLeftEnd(this);for(;r<l.jQ.offset().left;)l=l[f];return l.seek(r,n)},c.chToCmd=function(r,n){var l;return r.match(/^[a-eg-zA-Z]$/)?et(r):/^\d$/.test(r)?Pr(r):n&&n.typingSlashWritesDivisionSymbol&&r==="/"?s["÷"](r):n&&n.typingAsteriskWritesTimesSymbol&&r==="*"?s["×"](r):(l=we[r]||s[r])?l(r):j(r)},c.write=function(r,n){var l=this.chToCmd(n,r.options);r.selection&&l.replaces(r.replaceSelection()),r.isTooDeep()||l.createLeftOf(r.show())},c.focus=function(){return this.jQ.addClass("mq-hasCursor"),this.jQ.removeClass("mq-empty"),this},c.blur=function(){return this.jQ.removeClass("mq-hasCursor"),this.isEmpty()&&this.jQ.addClass("mq-empty"),this}});rt.p.mouseEvents=!0,Qe.StaticMath=function(c){return L(c.AbstractMathQuill,function(d,r){this.RootBlock=Me,d.__mathquillify=function(n,l){return this.config(n),r.__mathquillify.call(this,"mq-math-mode"),this.__options.mouseEvents&&(this.__controller.delegateMouseEvents(),this.__controller.staticMathTextareaEvents()),this},d.init=function(){r.init.apply(this,arguments),this.__controller.root.postOrder("registerInnerField",this.innerFields=[],c.MathField)},d.latex=function(){var n=r.latex.apply(this,arguments);return arguments.length>0&&this.__controller.root.postOrder("registerInnerField",this.innerFields=[],c.MathField),n}})};var X=L(Me,gr);Qe.MathField=function(c){return L(c.EditableField,function(d,r){this.RootBlock=X,d.__mathquillify=function(n,l){return this.config(n),l>1&&(this.__controller.root.reflow=xe),r.__mathquillify.call(this,"mq-editable-field mq-math-mode"),delete this.__controller.root.reflow,this}})};var Ve=L(be,function(c,d){function r(n){n.jQ[0].normalize();var l=n.jQ[0].firstChild;if(l){B("only node in TextBlock span is Text node",l.nodeType===3);var y=It(l.data);return y.jQadd(l),n.children().disown(),y.adopt(n,0,0)}}c.ctrlSeq="\\text",c.replaces=function(n){n instanceof a?this.replacedText=n.remove().jQ.text():typeof n=="string"&&(this.replacedText=n)},c.jQadd=function(n){d.jQadd.call(this,n),this.ends[f]&&this.ends[f].jQadd(this.jQ[0].firstChild)},c.createLeftOf=function(n){var l=this;if(d.createLeftOf.call(this,n),l[1].siblingCreated&&l[1].siblingCreated(n.options,f),l[f].siblingCreated&&l[f].siblingCreated(n.options,1),l.bubble("reflow"),n.insAtRightEnd(l),l.replacedText)for(var y=0;y<l.replacedText.length;y+=1)l.write(n,l.replacedText.charAt(y))},c.parser=function(){var n=this,l=Z.string,y=Z.regex;return Z.optWhitespace.then(l("{")).then(y(/^[^}]*/)).skip(l("}")).map(function(v){return v.length===0?a():(It(v).adopt(n,0,0),n)})},c.textContents=function(){return this.foldChildren("",function(n,l){return n+l.text})},c.text=function(){return'"'+this.textContents()+'"'},c.latex=function(){var n=this.textContents();return n.length===0?"":"\\text{"+n.replace(/\\/g,"\\backslash ").replace(/[{}]/g,"\\$&")+"}"},c.html=function(){return'<span class="mq-text-mode" mathquill-command-id='+this.id+">"+this.textContents()+"</span>"},c.moveTowards=function(n,l){l.insAtDirEnd(-n,this)},c.moveOutOf=function(n,l){l.insDirOf(n,this)},c.unselectInto=c.moveTowards,c.selectTowards=qe.prototype.selectTowards,c.deleteTowards=qe.prototype.deleteTowards,c.selectOutOf=function(n,l){l.insDirOf(n,this)},c.deleteOutOf=function(n,l){this.isEmpty()&&l.insRightOf(this)},c.write=function(n,l){if(n.show().deleteSelection(),l!=="$")n[f]?n[f].appendText(l):It(l).createLeftOf(n);else if(this.isEmpty())n.insRightOf(this),j("\\$","$").createLeftOf(n);else if(n[1])if(n[f]){var y=Ve(),v=this.ends[f];v.disown().jQ.detach(),v.adopt(y,0,0),n.insLeftOf(this),d.createLeftOf.call(y,n)}else n.insLeftOf(this);else n.insRightOf(this)},c.seek=function(n,l){l.hide();var y=r(this),v=this.jQ.width()/this.text.length,k=Math.round((n-this.jQ.offset().left)/v);k<=0?l.insAtLeftEnd(this):k>=y.text.length?l.insAtRightEnd(this):l.insLeftOf(y.splitRight(k));for(var w=n-l.show().offset().left,O=w&&w<0?f:1,I=O;l[O]&&w*I>0;)l[O].moveTowards(O,l),I=w,w=n-l.offset().left;if(O*w<-O*I&&l[-O].moveTowards(-O,l),l.anticursor){if(l.anticursor.parent===this){var U=l[f]&&l[f].text.length;if(this.anticursorPosition===U)l.anticursor=Pe.copy(l);else{if(this.anticursorPosition<U){var Y=l[f].splitRight(this.anticursorPosition);l[f]=Y}else Y=l[1].splitRight(this.anticursorPosition-U);l.anticursor=Pe(this,Y[f],Y)}}}else this.anticursorPosition=l[f]&&l[f].text.length},c.blur=function(n){Me.prototype.blur.call(this),n&&(this.textContents()===""?(this.remove(),n[f]===this?n[f]=this[f]:n[1]===this&&(n[1]=this[1])):r(this))},c.focus=Me.prototype.focus}),It=L(be,function(c,d){function r(n,l){return l.charAt(n===f?0:-1+l.length)}c.init=function(n){d.init.call(this),this.text=n},c.jQadd=function(n){this.dom=n,this.jQ=le(n)},c.jQize=function(){return this.jQadd(document.createTextNode(this.text))},c.appendText=function(n){this.text+=n,this.dom.appendData(n)},c.prependText=function(n){this.text=n+this.text,this.dom.insertData(0,n)},c.insTextAtDirEnd=function(n,l){$(l),l===1?this.appendText(n):this.prependText(n)},c.splitRight=function(n){var l=It(this.text.slice(n)).adopt(this.parent,this,this[1]);return l.jQadd(this.dom.splitText(n)),this.text=this.text.slice(0,n),l},c.moveTowards=function(n,l){$(n);var y=r(-n,this.text),v=this[-n];return v?v.insTextAtDirEnd(y,n):It(y).createDir(-n,l),this.deleteTowards(n,l)},c.latex=function(){return this.text},c.deleteTowards=function(n,l){this.text.length>1?n===1?(this.dom.deleteData(0,1),this.text=this.text.slice(1)):(this.dom.deleteData(-1+this.text.length,1),this.text=this.text.slice(0,-1)):(this.remove(),this.jQ.remove(),l[n]=this[n])},c.selectTowards=function(n,l){$(n);var y=l.anticursor,v=r(-n,this.text);if(y[n]===this){var k=It(v).createDir(n,l);y[n]=k,l.insDirOf(n,k)}else{var w=this[-n];w?w.insTextAtDirEnd(v,n):(k=It(v).createDir(-n,l)).jQ.insDirOf(-n,l.selection.jQ),this.text.length===1&&y[-n]===this&&(y[-n]=this[-n])}return this.deleteTowards(n,l)}});function Nt(c,d,r){return L(Ve,{ctrlSeq:c,htmlTemplate:"<"+d+" "+r+">&0</"+d+">"})}s.text=s.textnormal=s.textrm=s.textup=s.textmd=Ve,s.em=s.italic=s.italics=s.emph=s.textit=s.textsl=Nt("\\textit","i",'class="mq-text-mode"'),s.strong=s.bold=s.textbf=Nt("\\textbf","b",'class="mq-text-mode"'),s.sf=s.textsf=Nt("\\textsf","span",'class="mq-sans-serif mq-text-mode"'),s.tt=s.texttt=Nt("\\texttt","span",'class="mq-monospace mq-text-mode"'),s.textsc=Nt("\\textsc","span",'style="font-variant:small-caps" class="mq-text-mode"'),s.uppercase=Nt("\\uppercase","span",'style="text-transform:uppercase" class="mq-text-mode"'),s.lowercase=Nt("\\lowercase","span",'style="text-transform:lowercase" class="mq-text-mode"');var br=L(qe,function(c,d){c.init=function(r){d.init.call(this,"$"),this.cursor=r},c.htmlTemplate='<span class="mq-math-mode">&0</span>',c.createBlocks=function(){d.createBlocks.call(this),this.ends[f].cursor=this.cursor,this.ends[f].write=function(r,n){n!=="$"?Me.prototype.write.call(this,r,n):this.isEmpty()?(r.insRightOf(this.parent),this.parent.deleteTowards(dir,r),j("\\$","$").createLeftOf(r.show())):r[1]?r[f]?Me.prototype.write.call(this,r,n):r.insLeftOf(this.parent):r.insRightOf(this.parent)}},c.latex=function(){return"$"+this.ends[f].latex()+"$"}}),Lr=L(X,function(c,d){c.keystroke=function(r){if(r!=="Spacebar"&&r!=="Shift-Spacebar")return d.keystroke.apply(this,arguments)},c.write=function(r,n){var l;r.show().deleteSelection(),n==="$"?br(r).createLeftOf(r):(n==="<"?l="&lt;":n===">"&&(l="&gt;"),j(n,l).createLeftOf(r))}});Qe.TextField=function(c){return L(c.EditableField,function(d,r){this.RootBlock=Lr,d.__mathquillify=function(){return r.__mathquillify.call(this,"mq-editable-field mq-text-mode")},d.latex=function(n){return arguments.length>0?(this.__controller.renderLatexText(n),this.__controller.blurred&&this.__controller.cursor.hide().parent.blur(),this):this.__controller.exportLatex()}})},we["\\"]=L(qe,function(c,d){c.ctrlSeq="\\",c.replaces=function(r){this._replacedFragment=r.disown(),this.isEmpty=function(){return!1}},c.htmlTemplate='<span class="mq-latex-command-input mq-non-leaf">\\<span>&0</span></span>',c.textTemplate=["\\"],c.createBlocks=function(){d.createBlocks.call(this),this.ends[f].focus=function(){return this.parent.jQ.addClass("mq-hasCursor"),this.isEmpty()&&this.parent.jQ.removeClass("mq-empty"),this},this.ends[f].blur=function(){return this.parent.jQ.removeClass("mq-hasCursor"),this.isEmpty()&&this.parent.jQ.addClass("mq-empty"),this},this.ends[f].write=function(r,n){r.show().deleteSelection(),n.match(/[a-z]/i)?j(n).createLeftOf(r):(this.parent.renderCommand(r),n==="\\"&&this.isEmpty()||r.parent.write(r,n))},this.ends[f].keystroke=function(r,n,l){return r==="Tab"||r==="Enter"||r==="Spacebar"?(this.parent.renderCommand(l.cursor),void n.preventDefault()):d.keystroke.apply(this,arguments)}},c.createLeftOf=function(r){if(d.createLeftOf.call(this,r),this._replacedFragment){var n=this.jQ[0];this.jQ=this._replacedFragment.jQ.addClass("mq-blur").bind("mousedown mousemove",function(l){return le(l.target=n).trigger(l),!1}).insertBefore(this.jQ).add(this.jQ)}},c.latex=function(){return"\\"+this.ends[f].latex()+" "},c.renderCommand=function(r){this.jQ=this.jQ.last(),this.remove(),this[1]?r.insLeftOf(this[1]):r.insAtRightEnd(this.parent);var n=this.ends[f].latex();n||(n=" ");var l=s[n];l?(l=l(n),this._replacedFragment&&l.replaces(this._replacedFragment),l.createLeftOf(r)):((l=Ve()).replaces(n),l.createLeftOf(r),r.insRightOf(l),this._replacedFragment&&this._replacedFragment.remove())}});var jt,ft,Dt=xe,Ft=document.createElement("div").style;for(var Or in{transform:1,WebkitTransform:1,MozTransform:1,OTransform:1,msTransform:1})if(Or in Ft){ft=Or;break}ft?jt=function(c,d,r){c.css(ft,"scale("+d+","+r+")")}:"filter"in Ft?(Dt=function(c){c.className=c.className},jt=function(c,d,r){d/=1+(r-1)/2,c.css("fontSize",r+"em"),c.hasClass("mq-matrixed-container")||c.addClass("mq-matrixed-container").wrapInner('<span class="mq-matrixed"></span>');var n=c.children().css("filter","progid:DXImageTransform.Microsoft.Matrix(M11="+d+",SizingMethod='auto expand')");function l(){c.css("marginRight",(n.width()-1)*(d-1)/d+"px")}l();var y=setInterval(l);le(window).load(function(){clearTimeout(y),l()})}):jt=function(c,d,r){c.css("fontSize",r+"em")};var it=L(qe,function(c,d){c.init=function(r,n,l){d.init.call(this,r,"<"+n+" "+l+">&0</"+n+">")}});s.mathrm=g(it,"\\mathrm","span",'class="mq-roman mq-font"'),s.mathit=g(it,"\\mathit","i",'class="mq-font"'),s.mathbf=g(it,"\\mathbf","b",'class="mq-font"'),s.mathsf=g(it,"\\mathsf","span",'class="mq-sans-serif mq-font"'),s.mathtt=g(it,"\\mathtt","span",'class="mq-monospace mq-font"'),s.underline=g(it,"\\underline","span",'class="mq-non-leaf mq-underline"'),s.overline=s.bar=g(it,"\\overline","span",'class="mq-non-leaf mq-overline"'),s.overrightarrow=g(it,"\\overrightarrow","span",'class="mq-non-leaf mq-overarrow mq-arrow-right"'),s.overleftarrow=g(it,"\\overleftarrow","span",'class="mq-non-leaf mq-overarrow mq-arrow-left"'),s.overleftrightarrow=g(it,"\\overleftrightarrow","span",'class="mq-non-leaf mq-overarrow mq-arrow-both"'),s.overarc=g(it,"\\overarc","span",'class="mq-non-leaf mq-overarc"'),s.dot=L(qe,function(c,d){c.init=function(){d.init.call(this,"\\dot",'<span class="mq-non-leaf"><span class="mq-dot-recurring-inner"><span class="mq-dot-recurring">&#x2d9;</span><span class="mq-empty-box">&0</span></span></span>')}}),s.textcolor=L(qe,function(c,d){c.setColor=function(r){this.color=r,this.htmlTemplate='<span class="mq-textcolor" style="color:'+r+'">&0</span>'},c.latex=function(){return"\\textcolor{"+this.color+"}{"+this.blocks[0].latex()+"}"},c.parser=function(){var r=this,n=Z.optWhitespace,l=Z.string,y=Z.regex;return n.then(l("{")).then(y(/^[#\w\s.,()%-]*/)).skip(l("}")).then(function(v){return r.setColor(v),d.parser.call(r)})},c.isStyleBlock=function(){return!0}}),s.class=L(qe,function(c,d){c.parser=function(){var r=this,n=Z.string,l=Z.regex;return Z.optWhitespace.then(n("{")).then(l(/^[-\w\s\\\xA0-\xFF]*/)).skip(n("}")).then(function(y){return r.cls=y||"",r.htmlTemplate='<span class="mq-class '+y+'">&0</span>',d.parser.call(r)})},c.latex=function(){return"\\class{"+this.cls+"}{"+this.blocks[0].latex()+"}"},c.isStyleBlock=function(){return!0}});var St=L(qe,function(c,d){c.ctrlSeq="_{...}^{...}",c.createLeftOf=function(r){if(this.replacedFragment||r[f]||!r.options.supSubsRequireOperand)return d.createLeftOf.apply(this,arguments)},c.contactWeld=function(r){for(var n=f;n;n=n===f&&1)if(this[n]instanceof St){for(var l="sub";l;l=l==="sub"&&"sup"){var y=this[l],v=this[n][l];if(y){if(v)if(y.isEmpty())w=Pe(v,0,v.ends[f]);else{y.jQ.children().insAtDirEnd(-n,v.jQ);var k=y.children().disown(),w=Pe(v,k.ends[1],v.ends[f]);n===f?k.adopt(v,v.ends[1],0):k.adopt(v,0,v.ends[f])}else this[n].addBlock(y.disown());this.placeCursor=function(O,I){return function(U){U.insAtDirEnd(-n,O||I)}}(v,y)}}this.remove(),r&&r[f]===this&&(n===1&&w?w[f]?r.insRightOf(w[f]):r.insAtLeftEnd(w.parent):r.insRightOf(this[n]));break}},rt.p.charsThatBreakOutOfSupSub="",c.finalizeTree=function(){this.ends[f].write=function(r,n){if(r.options.autoSubscriptNumerals&&this===this.parent.sub){if(n==="_")return;var l=this.chToCmd(n,r.options);return l instanceof ct?r.deleteSelection():r.clearSelection().insRightOf(this.parent),l.createLeftOf(r.show())}r[f]&&!r[1]&&!r.selection&&r.options.charsThatBreakOutOfSupSub.indexOf(n)>-1&&r.insRightOf(this.parent),Me.p.write.apply(this,arguments)}},c.moveTowards=function(r,n,l){n.options.autoSubscriptNumerals&&!this.sup?n.insDirOf(r,this):d.moveTowards.apply(this,arguments)},c.deleteTowards=function(r,n){if(n.options.autoSubscriptNumerals&&this.sub){var l=this.sub.ends[-r];l instanceof ct?l.remove():l&&l.deleteTowards(r,n.insAtDirEnd(-r,this.sub)),this.sub.isEmpty()&&(this.sub.deleteOutOf(f,n.insAtLeftEnd(this.sub)),this.sup&&n.insDirOf(-r,this))}else d.deleteTowards.apply(this,arguments)},c.latex=function(){function r(n,l){var y=l&&l.latex();return l?n+(y.length===1?y:"{"+(y||" ")+"}"):""}return r("_",this.sub)+r("^",this.sup)},c.addBlock=function(r){this.supsub==="sub"?(this.sup=this.upInto=this.sub.upOutOf=r,r.adopt(this,this.sub,0).downOutOf=this.sub,r.jQ=le('<span class="mq-sup"/>').append(r.jQ.children()).attr(me,r.id).prependTo(this.jQ)):(this.sub=this.downInto=this.sup.downOutOf=r,r.adopt(this,0,this.sup).upOutOf=this.sup,r.jQ=le('<span class="mq-sub"></span>').append(r.jQ.children()).attr(me,r.id).appendTo(this.jQ.removeClass("mq-sup-only")),this.jQ.append('<span style="display:inline-block;width:0">&#8203;</span>'));for(var n=0;n<2;n+=1)(function(l,y,v,k){l[y].deleteOutOf=function(w,O){if(O.insDirOf(this[w]?-w:w,this.parent),!this.isEmpty()){var I=this.ends[w];this.children().disown().withDirAdopt(w,O.parent,O[w],O[-w]).jQ.insDirOf(-w,O.jQ),O[-w]=I}l.supsub=v,delete l[y],delete l[k+"Into"],l[v][k+"OutOf"]=ar,delete l[v].deleteOutOf,y==="sub"&&le(l.jQ.addClass("mq-sup-only")[0].lastChild).remove(),this.remove()}})(this,"sub sup".split(" ")[n],"sup sub".split(" ")[n],"down up".split(" ")[n])},c.reflow=function(){var r=this.jQ,n=r.prev();if(n.length){var l=r.children(".mq-sup");if(l.length){var y=parseInt(l.css("font-size")),v=l.offset().top+l.height()-n.offset().top-.7*y,k=parseInt(l.css("margin-bottom"));l.css("margin-bottom",k+v)}}}});function ar(c){var d=this.parent,r=c;do{if(r[1])return c.insLeftOf(d);r=r.parent.parent}while(r!==d);c.insRightOf(d)}s.subscript=s._=L(St,function(c,d){c.supsub="sub",c.htmlTemplate='<span class="mq-supsub mq-non-leaf"><span class="mq-sub">&0</span><span style="display:inline-block;width:0">&#8203;</span></span>',c.textTemplate=["_"],c.finalizeTree=function(){this.downInto=this.sub=this.ends[f],this.sub.upOutOf=ar,d.finalizeTree.call(this)}}),s.superscript=s.supscript=s["^"]=L(St,function(c,d){c.supsub="sup",c.htmlTemplate='<span class="mq-supsub mq-non-leaf mq-sup-only"><span class="mq-sup">&0</span></span>',c.textTemplate=["^"],c.finalizeTree=function(){this.upInto=this.sup=this.ends[1],this.sup.downOutOf=ar,d.finalizeTree.call(this)}});var Bt=L(qe,function(c,d){c.init=function(r,n){var l='<span class="mq-large-operator mq-non-leaf"><span class="mq-to"><span>&1</span></span><big>'+n+'</big><span class="mq-from"><span>&0</span></span></span>';ct.prototype.init.call(this,r,l)},c.createLeftOf=function(r){d.createLeftOf.apply(this,arguments),r.options.sumStartsWithNEquals&&(et("n").createLeftOf(r),Wt().createLeftOf(r))},c.latex=function(){function r(n){return n.length===1?n:"{"+(n||" ")+"}"}return this.ctrlSeq+"_"+r(this.ends[f].latex())+"^"+r(this.ends[1].latex())},c.parser=function(){for(var r=Z.string,n=Z.optWhitespace,l=Z.succeed,y=Re.block,v=this,k=v.blocks=[Me(),Me()],w=0;w<k.length;w+=1)k[w].adopt(v,v.ends[1],0);return n.then(r("_").or(r("^"))).then(function(O){var I=k[O==="_"?0:1];return y.then(function(U){return U.children().adopt(I,I.ends[1],0),l(v)})}).many().result(v)},c.finalizeTree=function(){this.downInto=this.ends[f],this.upInto=this.ends[1],this.ends[f].upOutOf=this.ends[1],this.ends[1].downOutOf=this.ends[f]}});s["∑"]=s.sum=s.summation=g(Bt,"\\sum ","&sum;"),s["∏"]=s.prod=s.product=g(Bt,"\\prod ","&prod;"),s.coprod=s.coproduct=g(Bt,"\\coprod ","&#8720;"),s["∫"]=s.int=s.integral=L(Bt,function(c,d){c.init=function(){ct.prototype.init.call(this,"\\int ",'<span class="mq-int mq-non-leaf"><big>&int;</big><span class="mq-supsub mq-non-leaf"><span class="mq-sup"><span class="mq-sup-inner">&1</span></span><span class="mq-sub">&0</span><span style="display:inline-block;width:0">&#8203</span></span></span>')},c.createLeftOf=qe.p.createLeftOf});var Xt=s.frac=s.dfrac=s.cfrac=s.fraction=L(qe,function(c,d){c.ctrlSeq="\\frac",c.htmlTemplate='<span class="mq-fraction mq-non-leaf"><span class="mq-numerator">&0</span><span class="mq-denominator">&1</span><span style="display:inline-block;width:0">&#8203;</span></span>',c.textTemplate=["(",")/(",")"],c.finalizeTree=function(){this.upInto=this.ends[1].upOutOf=this.ends[f],this.downInto=this.ends[f].downOutOf=this.ends[1]}}),Ht=s.over=we["/"]=L(Xt,function(c,d){c.createLeftOf=function(r){if(!this.replacedFragment){for(var n=r[f];n&&!(n instanceof ee||n instanceof(s.text||xe)||n instanceof Bt||n.ctrlSeq==="\\ "||/^[,;:]$/.test(n.ctrlSeq));)n=n[f];n instanceof Bt&&n[1]instanceof St&&(n=n[1])[1]instanceof St&&n[1].ctrlSeq!=n.ctrlSeq&&(n=n[1]),n===r[f]||r.isTooDeep(1)||(this.replaces(a(n[1]||r.parent.ends[f],r[f])),r[f]=n)}d.createLeftOf.call(this,r)}}),sr=s.sqrt=s["√"]=L(qe,function(c,d){c.ctrlSeq="\\sqrt",c.htmlTemplate='<span class="mq-non-leaf"><span class="mq-scaled mq-sqrt-prefix">&radic;</span><span class="mq-non-leaf mq-sqrt-stem">&0</span></span>',c.textTemplate=["sqrt(",")"],c.parser=function(){return Re.optBlock.then(function(r){return Re.block.map(function(n){var l=Kt();return l.blocks=[r,n],r.adopt(l,0,0),n.adopt(l,r,0),l})}).or(d.parser.call(this))},c.reflow=function(){var r=this.ends[1].jQ;jt(r.prev(),1,r.innerHeight()/+r.css("fontSize").slice(0,-2)-.1)}}),Kt=(s.hat=L(qe,function(c,d){c.ctrlSeq="\\hat",c.htmlTemplate='<span class="mq-non-leaf"><span class="mq-hat-prefix">^</span><span class="mq-hat-stem">&0</span></span>',c.textTemplate=["hat(",")"]}),s.nthroot=L(sr,function(c,d){c.htmlTemplate='<sup class="mq-nthroot mq-non-leaf">&0</sup><span class="mq-scaled"><span class="mq-sqrt-prefix mq-scaled">&radic;</span><span class="mq-sqrt-stem mq-non-leaf">&1</span></span>',c.textTemplate=["sqrt[","](",")"],c.latex=function(){return"\\sqrt["+this.ends[f].latex()+"]{"+this.ends[1].latex()+"}"}})),vr=L(qe,function(c,d){c.init=function(r,n,l){var y='<span class="mq-non-leaf"><span class="mq-diacritic-above">'+n+'</span><span class="mq-diacritic-stem">&0</span></span>';d.init.call(this,r,y,l)}});function xr(c,d){c.jQadd=function(){d.jQadd.apply(this,arguments),this.delimjQs=this.jQ.children(":first").add(this.jQ.children(":last")),this.contentjQ=this.jQ.children(":eq(1)")},c.reflow=function(){var r=this.contentjQ.outerHeight()/parseFloat(this.contentjQ.css("fontSize"));jt(this.delimjQs,tt(1+.2*(r-1),1.2),1.2*r)}}s.vec=g(vr,"\\vec","&rarr;",["vec(",")"]),s.tilde=g(vr,"\\tilde","~",["tilde(",")"]);var je=L(L(qe,xr),function(c,d){c.init=function(r,n,l,y,v){d.init.call(this,"\\left"+y,ce,[n,l]),this.side=r,this.sides={},this.sides[f]={ch:n,ctrlSeq:y},this.sides[1]={ch:l,ctrlSeq:v}},c.numBlocks=function(){return 1},c.html=function(){return this.htmlTemplate='<span class="mq-non-leaf"><span class="mq-scaled mq-paren'+(this.side===1?" mq-ghost":"")+'">'+this.sides[f].ch+'</span><span class="mq-non-leaf">&0</span><span class="mq-scaled mq-paren'+(this.side===f?" mq-ghost":"")+'">'+this.sides[1].ch+"</span></span>",d.html.call(this)},c.latex=function(){return"\\left"+this.sides[f].ctrlSeq+this.ends[f].latex()+"\\right"+this.sides[1].ctrlSeq},c.matchBrack=function(r,n,l){return l instanceof je&&l.side&&l.side!==-n&&(!r.restrictMismatchedBrackets||Ne[this.sides[this.side].ch]===l.sides[l.side].ch||{"(":"]","[":")"}[this.sides[f].ch]===l.sides[1].ch)&&l},c.closeOpposing=function(r){r.side=0,r.sides[this.side]=this.sides[this.side],r.delimjQs.eq(this.side===f?0:1).removeClass("mq-ghost").html(this.sides[this.side].ch)},c.createLeftOf=function(r){if(!this.replacedFragment){var n=r.options;if(this.sides[f].ch==="|")var l=this.matchBrack(n,1,r[1])||this.matchBrack(n,f,r[f])||this.matchBrack(n,0,r.parent.parent);else l=this.matchBrack(n,-this.side,r[-this.side])||this.matchBrack(n,-this.side,r.parent.parent)}if(l){var y=this.side=-l.side;this.closeOpposing(l),l===r.parent.parent&&r[y]&&a(r[y],r.parent.ends[y],-y).disown().withDirAdopt(-y,l.parent,l,l[y]).jQ.insDirOf(y,l.jQ),l.bubble("reflow")}else y=(l=this).side,l.replacedFragment?l.side=0:r[-y]&&(l.replaces(a(r[-y],r.parent.ends[-y],y)),r[-y]=0),d.createLeftOf.call(l,r);y===f?r.insAtLeftEnd(l.ends[f]):r.insRightOf(l)},c.placeCursor=xe,c.unwrap=function(){this.ends[f].children().disown().adopt(this.parent,this,this[1]).jQ.insertAfter(this.jQ),this.remove()},c.deleteSide=function(r,n,l){var y=this.parent,v=this[r],k=y.ends[r];if(r===this.side)return this.unwrap(),void(v?l.insDirOf(-r,v):l.insAtDirEnd(r,y));var w=l.options,O=!this.side;if(this.side=-r,this.matchBrack(w,r,this.ends[f].ends[this.side])){this.closeOpposing(this.ends[f].ends[this.side]);var I=this.ends[f].ends[r];this.unwrap(),I.siblingCreated&&I.siblingCreated(l.options,r),v?l.insDirOf(-r,v):l.insAtDirEnd(r,y)}else{if(this.matchBrack(w,r,this.parent.parent))this.parent.parent.closeOpposing(this),this.parent.parent.unwrap();else{if(n&&O)return this.unwrap(),void(v?l.insDirOf(-r,v):l.insAtDirEnd(r,y));this.sides[r]={ch:Ne[this.sides[this.side].ch],ctrlSeq:Ne[this.sides[this.side].ctrlSeq]},this.delimjQs.removeClass("mq-ghost").eq(r===f?0:1).addClass("mq-ghost").html(this.sides[r].ch)}v?(I=this.ends[f].ends[r],a(v,k,-r).disown().withDirAdopt(-r,this.ends[f],I,0).jQ.insAtDirEnd(r,this.ends[f].jQ.removeClass("mq-empty")),I.siblingCreated&&I.siblingCreated(l.options,r),l.insDirOf(-r,v)):n?l.insDirOf(r,this):l.insAtDirEnd(r,this.ends[f])}},c.deleteTowards=function(r,n){this.deleteSide(-r,!1,n)},c.finalizeTree=function(){this.ends[f].deleteOutOf=function(r,n){this.parent.deleteSide(r,!0,n)},this.finalizeTree=this.intentionalBlur=function(){this.delimjQs.eq(this.side===f?1:0).removeClass("mq-ghost"),this.side=0}},c.siblingCreated=function(r,n){n===-this.side&&this.finalizeTree()}}),Ne={"(":")",")":"(","[":"]","]":"[","{":"}","}":"{","\\{":"\\}","\\}":"\\{","&lang;":"&rang;","&rang;":"&lang;","\\langle ":"\\rangle ","\\rangle ":"\\langle ","|":"|","\\lVert ":"\\rVert ","\\rVert ":"\\lVert "};function Gt(c,d){d=d||c;var r=Ne[c],n=Ne[d];we[c]=g(je,f,c,r,d,n),we[r]=g(je,1,c,r,d,n)}Gt("("),Gt("["),Gt("{","\\{"),s.langle=g(je,f,"&lang;","&rang;","\\langle ","\\rangle "),s.rangle=g(je,1,"&lang;","&rang;","\\langle ","\\rangle "),we["|"]=g(je,f,"|","|","|","|"),s.lVert=g(je,f,"&#8741;","&#8741;","\\lVert ","\\rVert "),s.rVert=g(je,1,"&#8741;","&#8741;","\\lVert ","\\rVert "),s.left=L(qe,function(c){c.parser=function(){var d=Z.regex,r=Z.string,n=(Z.succeed,Z.optWhitespace);return n.then(d(/^(?:[([|]|\\\{|\\langle(?![a-zA-Z])|\\lVert(?![a-zA-Z]))/)).then(function(l){var y=l.charAt(0)==="\\"?l.slice(1):l;return l=="\\langle"&&(y="&lang;",l+=" "),l=="\\lVert"&&(y="&#8741;",l+=" "),Re.then(function(v){return r("\\right").skip(n).then(d(/^(?:[\])|]|\\\}|\\rangle(?![a-zA-Z])|\\rVert(?![a-zA-Z]))/)).map(function(k){var w=k.charAt(0)==="\\"?k.slice(1):k;k=="\\rangle"&&(w="&rang;",k+=" "),k=="\\rVert"&&(w="&#8741;",k+=" ");var O=je(0,y,w,l,k);return O.blocks=[v],v.adopt(O,0,0),O})})})}}),s.right=L(qe,function(c){c.parser=function(){return Z.fail("unmatched \\right")}});var Xr=s.binom=s.binomial=L(L(qe,xr),function(c,d){c.ctrlSeq="\\binom",c.htmlTemplate='<span class="mq-non-leaf"><span class="mq-paren mq-scaled">(</span><span class="mq-non-leaf"><span class="mq-array mq-non-leaf"><span>&0</span><span>&1</span></span></span><span class="mq-paren mq-scaled">)</span></span>',c.textTemplate=["choose(",",",")"]});s.choose=L(Xr,function(c){c.createLeftOf=Ht.prototype.createLeftOf}),s.editable=s.MathQuillMathField=L(qe,function(c,d){c.ctrlSeq="\\MathQuillMathField",c.htmlTemplate='<span class="mq-editable-field"><span class="mq-root-block">&0</span></span>',c.parser=function(){var r=this,n=Z.string,l=Z.regex,y=Z.succeed;return n("[").then(l(/^[a-z][a-z0-9]*/i)).skip(n("]")).map(function(v){r.name=v}).or(y()).then(d.parser.call(r))},c.finalizeTree=function(r){var n=Ie(this.ends[f],this.jQ,r);n.KIND_OF_MQ="MathField",n.editable=!0,n.createTextarea(),n.editablesTextareaEvents(),n.cursor.insAtRightEnd(n.root),gr(n.root)},c.registerInnerField=function(r,n){r.push(r[this.name]=n(this.ends[f].controller))},c.latex=function(){return this.ends[f].latex()},c.text=function(){return this.ends[f].text()}});var Ar=s.embed=L(ct,function(c,d){c.setOptions=function(r){function n(){return""}return this.text=r.text||n,this.htmlTemplate=r.htmlString||"",this.latex=r.latex||n,this},c.parser=function(){var r=this,n=Z.string,l=Z.regex,y=Z.succeed;return n("{").then(l(/^[a-z][a-z0-9]*/i)).skip(n("}")).then(function(v){return n("[").then(l(/^[-\w\s]*/)).skip(n("]")).or(y()).map(function(k){return r.setOptions(Mt[v](k))})})}});s.notin=s.cong=s.equiv=s.oplus=s.otimes=L(ee,function(c,d){c.init=function(r){d.init.call(this,"\\"+r+" ","&"+r+";")}}),s["≠"]=s.ne=s.neq=g(ee,"\\ne ","&ne;"),s["∗"]=s.ast=s.star=s.loast=s.lowast=g(ee,"\\ast ","&lowast;"),s.therefor=s.therefore=g(ee,"\\therefore ","&there4;"),s.cuz=s.because=g(ee,"\\because ","&#8757;"),s.prop=s.propto=g(ee,"\\propto ","&prop;"),s["≈"]=s.asymp=s.approx=g(ee,"\\approx ","&asymp;"),s.isin=s.in=g(ee,"\\in ","&isin;"),s.ni=s.contains=g(ee,"\\ni ","&ni;"),s.notni=s.niton=s.notcontains=s.doesnotcontain=g(ee,"\\not\\ni ","&#8716;"),s.sub=s.subset=g(ee,"\\subset ","&sub;"),s.sup=s.supset=s.superset=g(ee,"\\supset ","&sup;"),s.nsub=s.notsub=s.nsubset=s.notsubset=g(ee,"\\not\\subset ","&#8836;"),s.nsup=s.notsup=s.nsupset=s.notsupset=s.nsuperset=s.notsuperset=g(ee,"\\not\\supset ","&#8837;"),s.sube=s.subeq=s.subsete=s.subseteq=g(ee,"\\subseteq ","&sube;"),s.supe=s.supeq=s.supsete=s.supseteq=s.supersete=s.superseteq=g(ee,"\\supseteq ","&supe;"),s.nsube=s.nsubeq=s.notsube=s.notsubeq=s.nsubsete=s.nsubseteq=s.notsubsete=s.notsubseteq=g(ee,"\\not\\subseteq ","&#8840;"),s.nsupe=s.nsupeq=s.notsupe=s.notsupeq=s.nsupsete=s.nsupseteq=s.notsupsete=s.notsupseteq=s.nsupersete=s.nsuperseteq=s.notsupersete=s.notsuperseteq=g(ee,"\\not\\supseteq ","&#8841;"),s.N=s.naturals=s.Naturals=g(j,"\\mathbb{N}","&#8469;"),s.P=s.primes=s.Primes=s.projective=s.Projective=s.probability=s.Probability=g(j,"\\mathbb{P}","&#8473;"),s.Z=s.integers=s.Integers=g(j,"\\mathbb{Z}","&#8484;"),s.Q=s.rationals=s.Rationals=g(j,"\\mathbb{Q}","&#8474;"),s.R=s.reals=s.Reals=g(j,"\\mathbb{R}","&#8477;"),s.C=s.complex=s.Complex=s.complexes=s.Complexes=s.complexplane=s.Complexplane=s.ComplexPlane=g(j,"\\mathbb{C}","&#8450;"),s.H=s.Hamiltonian=s.quaternions=s.Quaternions=g(j,"\\mathbb{H}","&#8461;"),s.quad=s.emsp=g(j,"\\quad ","    "),s.qquad=g(j,"\\qquad ","        "),s.diamond=g(j,"\\diamond ","&#9671;"),s.bigtriangleup=g(j,"\\bigtriangleup ","&#9651;"),s.ominus=g(j,"\\ominus ","&#8854;"),s.uplus=g(j,"\\uplus ","&#8846;"),s.bigtriangledown=g(j,"\\bigtriangledown ","&#9661;"),s.sqcap=g(j,"\\sqcap ","&#8851;"),s.triangleleft=g(j,"\\triangleleft ","&#8882;"),s.sqcup=g(j,"\\sqcup ","&#8852;"),s.triangleright=g(j,"\\triangleright ","&#8883;"),s.odot=s.circledot=g(j,"\\odot ","&#8857;"),s.bigcirc=g(j,"\\bigcirc ","&#9711;"),s.dagger=g(j,"\\dagger ","&#0134;"),s.ddagger=g(j,"\\ddagger ","&#135;"),s.wr=g(j,"\\wr ","&#8768;"),s.amalg=g(j,"\\amalg ","&#8720;"),s.models=g(j,"\\models ","&#8872;"),s.prec=g(j,"\\prec ","&#8826;"),s.succ=g(j,"\\succ ","&#8827;"),s.preceq=g(j,"\\preceq ","&#8828;"),s.succeq=g(j,"\\succeq ","&#8829;"),s.simeq=g(j,"\\simeq ","&#8771;"),s.mid=g(j,"\\mid ","&#8739;"),s.ll=g(j,"\\ll ","&#8810;"),s.gg=g(j,"\\gg ","&#8811;"),s.parallel=g(j,"\\parallel ","&#8741;"),s.nparallel=g(j,"\\nparallel ","&#8742;"),s.bowtie=g(j,"\\bowtie ","&#8904;"),s.sqsubset=g(j,"\\sqsubset ","&#8847;"),s.sqsupset=g(j,"\\sqsupset ","&#8848;"),s.smile=g(j,"\\smile ","&#8995;"),s.sqsubseteq=g(j,"\\sqsubseteq ","&#8849;"),s.sqsupseteq=g(j,"\\sqsupseteq ","&#8850;"),s.doteq=g(j,"\\doteq ","&#8784;"),s.frown=g(j,"\\frown ","&#8994;"),s.vdash=g(j,"\\vdash ","&#8870;"),s.dashv=g(j,"\\dashv ","&#8867;"),s.nless=g(j,"\\nless ","&#8814;"),s.ngtr=g(j,"\\ngtr ","&#8815;"),s.longleftarrow=g(j,"\\longleftarrow ","&#8592;"),s.longrightarrow=g(j,"\\longrightarrow ","&#8594;"),s.Longleftarrow=g(j,"\\Longleftarrow ","&#8656;"),s.Longrightarrow=g(j,"\\Longrightarrow ","&#8658;"),s.longleftrightarrow=g(j,"\\longleftrightarrow ","&#8596;"),s.updownarrow=g(j,"\\updownarrow ","&#8597;"),s.Longleftrightarrow=g(j,"\\Longleftrightarrow ","&#8660;"),s.Updownarrow=g(j,"\\Updownarrow ","&#8661;"),s.mapsto=g(j,"\\mapsto ","&#8614;"),s.nearrow=g(j,"\\nearrow ","&#8599;"),s.hookleftarrow=g(j,"\\hookleftarrow ","&#8617;"),s.hookrightarrow=g(j,"\\hookrightarrow ","&#8618;"),s.searrow=g(j,"\\searrow ","&#8600;"),s.leftharpoonup=g(j,"\\leftharpoonup ","&#8636;"),s.rightharpoonup=g(j,"\\rightharpoonup ","&#8640;"),s.swarrow=g(j,"\\swarrow ","&#8601;"),s.leftharpoondown=g(j,"\\leftharpoondown ","&#8637;"),s.rightharpoondown=g(j,"\\rightharpoondown ","&#8641;"),s.nwarrow=g(j,"\\nwarrow ","&#8598;"),s.ldots=g(j,"\\ldots ","&#8230;"),s.cdots=g(j,"\\cdots ","&#8943;"),s.vdots=g(j,"\\vdots ","&#8942;"),s.ddots=g(j,"\\ddots ","&#8945;"),s.surd=g(j,"\\surd ","&#8730;"),s.triangle=g(j,"\\triangle ","&#9651;"),s.ell=g(j,"\\ell ","&#8467;"),s.top=g(j,"\\top ","&#8868;"),s.flat=g(j,"\\flat ","&#9837;"),s.natural=g(j,"\\natural ","&#9838;"),s.sharp=g(j,"\\sharp ","&#9839;"),s.wp=g(j,"\\wp ","&#8472;"),s.bot=g(j,"\\bot ","&#8869;"),s.clubsuit=g(j,"\\clubsuit ","&#9827;"),s.diamondsuit=g(j,"\\diamondsuit ","&#9826;"),s.heartsuit=g(j,"\\heartsuit ","&#9825;"),s.spadesuit=g(j,"\\spadesuit ","&#9824;"),s.parallelogram=g(j,"\\parallelogram ","&#9649;"),s.square=g(j,"\\square ","&#11036;"),s.oint=g(j,"\\oint ","&#8750;"),s.bigcap=g(j,"\\bigcap ","&#8745;"),s.bigcup=g(j,"\\bigcup ","&#8746;"),s.bigsqcup=g(j,"\\bigsqcup ","&#8852;"),s.bigvee=g(j,"\\bigvee ","&#8744;"),s.bigwedge=g(j,"\\bigwedge ","&#8743;"),s.bigodot=g(j,"\\bigodot ","&#8857;"),s.bigotimes=g(j,"\\bigotimes ","&#8855;"),s.bigoplus=g(j,"\\bigoplus ","&#8853;"),s.biguplus=g(j,"\\biguplus ","&#8846;"),s.lfloor=g(j,"\\lfloor ","&#8970;"),s.rfloor=g(j,"\\rfloor ","&#8971;"),s.lceil=g(j,"\\lceil ","&#8968;"),s.rceil=g(j,"\\rceil ","&#8969;"),s.opencurlybrace=s.lbrace=g(j,"\\lbrace ","{"),s.closecurlybrace=s.rbrace=g(j,"\\rbrace ","}"),s.lbrack=g(j,"["),s.rbrack=g(j,"]"),s.slash=g(j,"/"),s.vert=g(j,"|"),s.perp=s.perpendicular=g(j,"\\perp ","&perp;"),s.nabla=s.del=g(j,"\\nabla ","&nabla;"),s.hbar=g(j,"\\hbar ","&#8463;"),s.AA=s.Angstrom=s.angstrom=g(j,"\\text\\AA ","&#8491;"),s.ring=s.circ=s.circle=g(j,"\\circ ","&#8728;"),s.bull=s.bullet=g(j,"\\bullet ","&bull;"),s.setminus=s.smallsetminus=g(j,"\\setminus ","&#8726;"),s.not=s["¬"]=s.neg=g(j,"\\neg ","&not;"),s["…"]=s.dots=s.ellip=s.hellip=s.ellipsis=s.hellipsis=g(j,"\\dots ","&hellip;"),s.converges=s.darr=s.dnarr=s.dnarrow=s.downarrow=g(j,"\\downarrow ","&darr;"),s.dArr=s.dnArr=s.dnArrow=s.Downarrow=g(j,"\\Downarrow ","&dArr;"),s.diverges=s.uarr=s.uparrow=g(j,"\\uparrow ","&uarr;"),s.uArr=s.Uparrow=g(j,"\\Uparrow ","&uArr;"),s.to=g(ee,"\\to ","&rarr;"),s.rarr=s.rightarrow=g(j,"\\rightarrow ","&rarr;"),s.implies=g(ee,"\\Rightarrow ","&rArr;"),s.rArr=s.Rightarrow=g(j,"\\Rightarrow ","&rArr;"),s.gets=g(ee,"\\gets ","&larr;"),s.larr=s.leftarrow=g(j,"\\leftarrow ","&larr;"),s.impliedby=g(ee,"\\Leftarrow ","&lArr;"),s.lArr=s.Leftarrow=g(j,"\\Leftarrow ","&lArr;"),s.harr=s.lrarr=s.leftrightarrow=g(j,"\\leftrightarrow ","&harr;"),s.iff=g(ee,"\\Leftrightarrow ","&hArr;"),s.hArr=s.lrArr=s.Leftrightarrow=g(j,"\\Leftrightarrow ","&hArr;"),s.Re=s.Real=s.real=g(j,"\\Re ","&real;"),s.Im=s.imag=s.image=s.imagin=s.imaginary=s.Imaginary=g(j,"\\Im ","&image;"),s.part=s.partial=g(j,"\\partial ","&part;"),s.infty=s.infin=s.infinity=g(j,"\\infty ","&infin;"),s.pounds=g(j,"\\pounds ","&pound;"),s.alef=s.alefsym=s.aleph=s.alephsym=g(j,"\\aleph ","&alefsym;"),s.xist=s.xists=s.exist=s.exists=g(j,"\\exists ","&exist;"),s.nexists=s.nexist=g(j,"\\nexists ","&#8708;"),s.and=s.land=s.wedge=g(ee,"\\wedge ","&and;"),s.or=s.lor=s.vee=g(ee,"\\vee ","&or;"),s.o=s.O=s.empty=s.emptyset=s.oslash=s.Oslash=s.nothing=s.varnothing=g(ee,"\\varnothing ","&empty;"),s.cup=s.union=g(ee,"\\cup ","&cup;"),s.cap=s.intersect=s.intersection=g(ee,"\\cap ","&cap;"),s.deg=s.degree=g(j,"\\degree ","&deg;"),s.ang=s.angle=g(j,"\\angle ","&ang;"),s.measuredangle=g(j,"\\measuredangle ","&#8737;");var Pr=L(j,function(c,d){c.createLeftOf=function(r){r.options.autoSubscriptNumerals&&r.parent!==r.parent.parent.sub&&(r[f]instanceof Se&&r[f].isItalic!==!1||r[f]instanceof St&&r[f][f]instanceof Se&&r[f][f].isItalic!==!1)?(s._().createLeftOf(r),d.createLeftOf.call(this,r),r.insRightOf(r.parent.parent)):d.createLeftOf.call(this,r)}}),Se=L(ct,function(c,d){c.init=function(r,n){d.init.call(this,r,"<var>"+(n||r)+"</var>")},c.text=function(){var r=this.ctrlSeq;return this.isPartOfOperator?r[0]=="\\"?r=r.slice(1,r.length):r[r.length-1]==" "&&(r=r.slice(0,-1)):(!this[f]||this[f]instanceof Se||this[f]instanceof ee||this[f].ctrlSeq==="\\ "||(r="*"+r),!this[1]||this[1]instanceof ee||this[1]instanceof St||(r+="*")),r}});rt.p.autoCommands={_maxLength:0},Tt.autoCommands=function(c){if(!/^[a-z]+(?: [a-z]+)*$/i.test(c))throw'"'+c+'" not a space-delimited list of only letters';for(var d=c.split(" "),r={},n=0,l=0;l<d.length;l+=1){var y=d[l];if(y.length<2)throw'autocommand "'+y+'" not minimum length of 2';if(s[y]===Dr)throw'"'+y+'" is a built-in operator name';r[y]=1,n=We(n,y.length)}return r._maxLength=n,r};var et=L(Se,function(c,d){function r(n){return!n||n instanceof ee||n instanceof Bt}c.init=function(n){return d.init.call(this,this.letter=n)},c.createLeftOf=function(n){d.createLeftOf.apply(this,arguments);var l=n.options.autoCommands,y=l._maxLength;if(y>0){for(var v="",k=this,w=0;k instanceof et&&k.ctrlSeq===k.letter&&w<y;)v=k.letter+v,k=k[f],w+=1;for(;v.length;){if(l.hasOwnProperty(v)){for(w=1,k=this;w<v.length;w+=1,k=k[f]);return a(k,this).remove(),n[f]=k[f],s[v](v).createLeftOf(n)}v=v.slice(1)}}},c.italicize=function(n){return this.isItalic=n,this.isPartOfOperator=!n,this.jQ.toggleClass("mq-operator-name",!n),this},c.finalizeTree=c.siblingDeleted=c.siblingCreated=function(n,l){l!==f&&this[1]instanceof et||this.autoUnItalicize(n)},c.autoUnItalicize=function(n){var l=n.autoOperatorNames;if(l._maxLength!==0){for(var y=this.letter,v=this[f];v instanceof et;v=v[f])y=v.letter+y;for(var k=this[1];k instanceof et;k=k[1])y+=k.letter;a(v[1]||this.parent.ends[f],k[f]||this.parent.ends[1]).each(function(Te){Te.italicize(!0).jQ.removeClass("mq-first mq-last mq-followed-by-supsub"),Te.ctrlSeq=Te.letter});e:for(var w=0,O=v[1]||this.parent.ends[f];w<y.length;w+=1,O=O[1])for(var I=tt(l._maxLength,y.length-w);I>0;I-=1){var U=y.slice(w,w+I);if(l.hasOwnProperty(U)){for(var Y=0,ue=O;Y<I;Y+=1,ue=ue[1]){ue.italicize(!1);var z=ue}var fe=wr.hasOwnProperty(U);if(O.ctrlSeq=(fe?"\\":"\\operatorname{")+O.ctrlSeq,z.ctrlSeq+=fe?" ":"}",lr.hasOwnProperty(U)&&z[f][f][f].jQ.addClass("mq-last"),r(O[f])||O.jQ.addClass("mq-first"),!r(z[1]))if(z[1]instanceof St){var ie=z[1];(ie.siblingCreated=ie.siblingDeleted=function(){ie.jQ.toggleClass("mq-after-operator-name",!(ie[1]instanceof je))})()}else z.jQ.toggleClass("mq-last",!(z[1]instanceof je));w+=I-1,O=z;continue e}}}}}),wr={},yt=rt.p.autoOperatorNames={_maxLength:9},lr={limsup:1,liminf:1,projlim:1,injlim:1};(function(){for(var c="arg deg det dim exp gcd hom inf ker lg lim ln log max min sup limsup liminf injlim projlim Pr".split(" "),d=0;d<c.length;d+=1)wr[c[d]]=yt[c[d]]=1;var r="sin cos tan arcsin arccos arctan sinh cosh tanh sec csc cot coth".split(" ");for(d=0;d<r.length;d+=1)wr[r[d]]=1;var n="sin cos tan sec cosec csc cotan cot ctg".split(" ");for(d=0;d<n.length;d+=1)yt[n[d]]=yt["arc"+n[d]]=yt[n[d]+"h"]=yt["ar"+n[d]+"h"]=yt["arc"+n[d]+"h"]=1;var l="gcf hcf lcm proj span".split(" ");for(d=0;d<l.length;d+=1)yt[l[d]]=1})(),Tt.autoOperatorNames=function(c){if(!/^[a-z]+(?: [a-z]+)*$/i.test(c))throw'"'+c+'" not a space-delimited list of only letters';for(var d=c.split(" "),r={},n=0,l=0;l<d.length;l+=1){var y=d[l];if(y.length<2)throw'"'+y+'" not minimum length of 2';r[y]=1,n=We(n,y.length)}return r._maxLength=n,r};var Dr=L(ct,function(c,d){c.init=function(r){this.ctrlSeq=r},c.createLeftOf=function(r){for(var n=this.ctrlSeq,l=0;l<n.length;l+=1)et(n.charAt(l)).createLeftOf(r)},c.parser=function(){for(var r=this.ctrlSeq,n=Me(),l=0;l<r.length;l+=1)et(r.charAt(l)).adopt(n,n.ends[1],0);return Z.succeed(n.children())}});for(var Qr in yt)yt.hasOwnProperty(Qr)&&(s[Qr]=Dr);s.operatorname=L(qe,function(c){c.createLeftOf=xe,c.numBlocks=function(){return 1},c.parser=function(){return Re.block.map(function(d){return d.children()})}}),s.f=L(et,function(c,d){c.init=function(){ct.p.init.call(this,this.letter="f",'<var class="mq-f">f</var>')},c.italicize=function(r){return this.jQ.html("f").toggleClass("mq-f",r),d.italicize.apply(this,arguments)}}),s[" "]=s.space=g(j,"\\ ","&nbsp;"),s["'"]=s.prime=g(j,"'","&prime;"),s["″"]=s.dprime=g(j,"″","&Prime;"),s.backslash=g(j,"\\backslash ","\\"),we["\\"]||(we["\\"]=s.backslash),s.$=g(j,"\\$","$");var Jt=L(ct,function(c,d){c.init=function(r,n){d.init.call(this,r,'<span class="mq-nonSymbola">'+(n||r)+"</span>")}});s["@"]=Jt,s["&"]=g(Jt,"\\&","&amp;"),s["%"]=g(Jt,"\\%","%"),s.alpha=s.beta=s.gamma=s.delta=s.zeta=s.eta=s.theta=s.iota=s.kappa=s.mu=s.nu=s.xi=s.rho=s.sigma=s.tau=s.chi=s.psi=s.omega=L(Se,function(c,d){c.init=function(r){d.init.call(this,"\\"+r+" ","&"+r+";")}}),s.phi=g(Se,"\\phi ","&#981;"),s.phiv=s.varphi=g(Se,"\\varphi ","&phi;"),s.epsilon=g(Se,"\\epsilon ","&#1013;"),s.epsiv=s.varepsilon=g(Se,"\\varepsilon ","&epsilon;"),s.piv=s.varpi=g(Se,"\\varpi ","&piv;"),s.sigmaf=s.sigmav=s.varsigma=g(Se,"\\varsigma ","&sigmaf;"),s.thetav=s.vartheta=s.thetasym=g(Se,"\\vartheta ","&thetasym;"),s.upsilon=s.upsi=g(Se,"\\upsilon ","&upsilon;"),s.gammad=s.Gammad=s.digamma=g(Se,"\\digamma ","&#989;"),s.kappav=s.varkappa=g(Se,"\\varkappa ","&#1008;"),s.rhov=s.varrho=g(Se,"\\varrho ","&#1009;"),s.pi=s.π=g(Jt,"\\pi ","&pi;"),s.lambda=g(Jt,"\\lambda ","&lambda;"),s.Upsilon=s.Upsi=s.upsih=s.Upsih=g(ct,"\\Upsilon ",'<var style="font-family: serif">&upsih;</var>'),s.Gamma=s.Delta=s.Theta=s.Lambda=s.Xi=s.Pi=s.Sigma=s.Phi=s.Psi=s.Omega=s.forall=L(j,function(c,d){c.init=function(r){d.init.call(this,"\\"+r+" ","&"+r+";")}});var zt=L(qe,function(c){c.init=function(d){this.latex=d},c.createLeftOf=function(d){var r=Re.parse(this.latex);r.children().adopt(d.parent,d[f],d[1]),d[f]=r.ends[1],r.jQize().insertBefore(d.jQ),r.finalizeInsert(d.options,d),r.ends[1][1].siblingCreated&&r.ends[1][1].siblingCreated(d.options,f),r.ends[f][f].siblingCreated&&r.ends[f][f].siblingCreated(d.options,1),d.parent.bubble("reflow")},c.parser=function(){var d=Re.parse(this.latex).children();return Z.succeed(d)}});s["¹"]=g(zt,"^1"),s["²"]=g(zt,"^2"),s["³"]=g(zt,"^3"),s["¼"]=g(zt,"\\frac14"),s["½"]=g(zt,"\\frac12"),s["¾"]=g(zt,"\\frac34");var cr=L(ee,function(c){c.init=j.prototype.init,c.contactWeld=c.siblingCreated=c.siblingDeleted=function(d,r){if(r!==1)return this.jQ[0].className=function n(l){return l[f]?l[f]instanceof ee||/^[,;:\(\[]$/.test(l[f].ctrlSeq)?"":"mq-binary-operator":l.parent&&l.parent.parent&&l.parent.parent.isStyleBlock()?n(l.parent.parent):""}(this),this}});s["+"]=g(cr,"+","+"),s["–"]=s["-"]=g(cr,"-","&minus;"),s["±"]=s.pm=s.plusmn=s.plusminus=g(cr,"\\pm ","&plusmn;"),s.mp=s.mnplus=s.minusplus=g(cr,"\\mp ","&#8723;"),we["*"]=s.sdot=s.cdot=g(ee,"\\cdot ","&middot;","*");var Zt=L(ee,function(c,d){c.init=function(r,n){this.data=r,this.strict=n;var l=n?"Strict":"";d.init.call(this,r["ctrlSeq"+l],r["html"+l],r["text"+l])},c.swap=function(r){this.strict=r;var n=r?"Strict":"";this.ctrlSeq=this.data["ctrlSeq"+n],this.jQ.html(this.data["html"+n]),this.textTemplate=[this.data["text"+n]]},c.deleteTowards=function(r,n){if(r===f&&!this.strict)return this.swap(!0),void this.bubble("reflow");d.deleteTowards.apply(this,arguments)}}),kr={ctrlSeq:"\\le ",html:"&le;",text:"≤",ctrlSeqStrict:"<",htmlStrict:"&lt;",textStrict:"<"},Rr={ctrlSeq:"\\ge ",html:"&ge;",text:"≥",ctrlSeqStrict:">",htmlStrict:"&gt;",textStrict:">"};s["<"]=s.lt=g(Zt,kr,!0),s[">"]=s.gt=g(Zt,Rr,!0),s["≤"]=s.le=s.leq=g(Zt,kr,!1),s["≥"]=s.ge=s.geq=g(Zt,Rr,!1);var Wt=L(ee,function(c,d){c.init=function(){d.init.call(this,"=","=")},c.createLeftOf=function(r){if(r[f]instanceof Zt&&r[f].strict)return r[f].swap(!1),void r[f].bubble("reflow");d.createLeftOf.apply(this,arguments)}});s["="]=Wt,s["×"]=s.times=g(ee,"\\times ","&times;","[x]"),s["÷"]=s.div=s.divide=s.divides=g(ee,"\\div ","&divide;","[/]"),we["~"]=s.sim=g(ee,"\\sim ","~","~");var ur=qt(1);for(var dr in ur)(function(c,d){typeof d=="function"?(nt[c]=function(){return $t(),d.apply(this,arguments)},nt[c].prototype=d.prototype):nt[c]=d})(dr,ur[dr])}(),ae.exports=window.MathQuill},755:function(ae,ge){var K;(function(N,ce){typeof ae.exports=="object"?ae.exports=N.document?ce(N,!0):function(se){if(!se.document)throw new Error("jQuery requires a window with a document");return ce(se)}:ce(N)})(typeof window<"u"?window:this,function(N,ce){var se=[],pe=Object.getPrototypeOf,me=se.slice,tt=se.flat?function(e){return se.flat.call(e)}:function(e){return se.concat.apply([],e)},We=se.push,xe=se.indexOf,Ye={},de=Ye.toString,Je=Ye.hasOwnProperty,Ze=Je.toString,g=Ze.call(Object),B={},L=function(e){return typeof e=="function"&&typeof e.nodeType!="number"&&typeof e.item!="function"},f=function(e){return e!=null&&e===e.window},$=N.document,le={type:!0,src:!0,nonce:!0,noModule:!0};function Pe(e,t,i){var o,u,p=(i=i||$).createElement("script");if(p.text=e,t)for(o in le)(u=t[o]||t.getAttribute&&t.getAttribute(o))&&p.setAttribute(o,u);i.head.appendChild(p).parentNode.removeChild(p)}function be(e){return e==null?e+"":typeof e=="object"||typeof e=="function"?Ye[de.call(e)]||"object":typeof e}var lt="3.6.0",a=function(e,t){return new a.fn.init(e,t)};function s(e){var t=!!e&&"length"in e&&e.length,i=be(e);return!L(e)&&!f(e)&&(i==="array"||t===0||typeof t=="number"&&t>0&&t-1 in e)}a.fn=a.prototype={jquery:lt,constructor:a,length:0,toArray:function(){return me.call(this)},get:function(e){return e==null?me.call(this):e<0?this[e+this.length]:this[e]},pushStack:function(e){var t=a.merge(this.constructor(),e);return t.prevObject=this,t},each:function(e){return a.each(this,e)},map:function(e){return this.pushStack(a.map(this,function(t,i){return e.call(t,i,t)}))},slice:function(){return this.pushStack(me.apply(this,arguments))},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},even:function(){return this.pushStack(a.grep(this,function(e,t){return(t+1)%2}))},odd:function(){return this.pushStack(a.grep(this,function(e,t){return t%2}))},eq:function(e){var t=this.length,i=+e+(e<0?t:0);return this.pushStack(i>=0&&i<t?[this[i]]:[])},end:function(){return this.prevObject||this.constructor()},push:We,sort:se.sort,splice:se.splice},a.extend=a.fn.extend=function(){var e,t,i,o,u,p,h=arguments[0]||{},x=1,_=arguments.length,q=!1;for(typeof h=="boolean"&&(q=h,h=arguments[x]||{},x++),typeof h=="object"||L(h)||(h={}),x===_&&(h=this,x--);x<_;x++)if((e=arguments[x])!=null)for(t in e)o=e[t],t!=="__proto__"&&h!==o&&(q&&o&&(a.isPlainObject(o)||(u=Array.isArray(o)))?(i=h[t],p=u&&!Array.isArray(i)?[]:u||a.isPlainObject(i)?i:{},u=!1,h[t]=a.extend(q,p,o)):o!==void 0&&(h[t]=o));return h},a.extend({expando:"jQuery"+(lt+Math.random()).replace(/\D/g,""),isReady:!0,error:function(e){throw new Error(e)},noop:function(){},isPlainObject:function(e){var t,i;return!(!e||de.call(e)!=="[object Object]"||(t=pe(e))&&(typeof(i=Je.call(t,"constructor")&&t.constructor)!="function"||Ze.call(i)!==g))},isEmptyObject:function(e){var t;for(t in e)return!1;return!0},globalEval:function(e,t,i){Pe(e,{nonce:t&&t.nonce},i)},each:function(e,t){var i,o=0;if(s(e))for(i=e.length;o<i&&t.call(e[o],o,e[o])!==!1;o++);else for(o in e)if(t.call(e[o],o,e[o])===!1)break;return e},makeArray:function(e,t){var i=t||[];return e!=null&&(s(Object(e))?a.merge(i,typeof e=="string"?[e]:e):We.call(i,e)),i},inArray:function(e,t,i){return t==null?-1:xe.call(t,e,i)},merge:function(e,t){for(var i=+t.length,o=0,u=e.length;o<i;o++)e[u++]=t[o];return e.length=u,e},grep:function(e,t,i){for(var o=[],u=0,p=e.length,h=!i;u<p;u++)!t(e[u],u)!==h&&o.push(e[u]);return o},map:function(e,t,i){var o,u,p=0,h=[];if(s(e))for(o=e.length;p<o;p++)(u=t(e[p],p,i))!=null&&h.push(u);else for(p in e)(u=t(e[p],p,i))!=null&&h.push(u);return tt(h)},guid:1,support:B}),typeof Symbol=="function"&&(a.fn[Symbol.iterator]=se[Symbol.iterator]),a.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "),function(e,t){Ye["[object "+t+"]"]=t.toLowerCase()});var we=function(e){var t,i,o,u,p,h,x,_,q,A,P,S,E,W,G,V,Ee,Ue,gt,ke="sizzle"+1*new Date,ne=e.document,ut=0,ye=0,Le=Br(),qr=Br(),Ir=Br(),bt=Br(),rr=function(m,b){return m===b&&(P=!0),0},hr={}.hasOwnProperty,dt=[],mr=dt.pop,Ct=dt.push,Oe=dt.push,vt=dt.slice,xt=function(m,b){for(var C=0,D=m.length;C<D;C++)if(m[C]===b)return C;return-1},Qt="checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",Fe="[\\x20\\t\\r\\n\\f]",ve="(?:\\\\[\\da-fA-F]{1,6}[\\x20\\t\\r\\n\\f]?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+",$e="\\[[\\x20\\t\\r\\n\\f]*("+ve+")(?:"+Fe+"*([*^$|!~]?=)"+Fe+`*(?:'((?:\\\\.|[^\\\\'])*)'|"((?:\\\\.|[^\\\\"])*)"|(`+ve+"))|)"+Fe+"*\\]",wt=":("+ve+`)(?:\\((('((?:\\\\.|[^\\\\'])*)'|"((?:\\\\.|[^\\\\"])*)")|((?:\\\\.|[^\\\\()[\\]]|`+$e+")*)|.*)\\)|)",Be=new RegExp(Fe+"+","g"),kt=new RegExp("^[\\x20\\t\\r\\n\\f]+|((?:^|[^\\\\])(?:\\\\.)*)[\\x20\\t\\r\\n\\f]+$","g"),fr=new RegExp("^[\\x20\\t\\r\\n\\f]*,[\\x20\\t\\r\\n\\f]*"),Nr=new RegExp("^[\\x20\\t\\r\\n\\f]*([>+~]|[\\x20\\t\\r\\n\\f])[\\x20\\t\\r\\n\\f]*"),Xn=new RegExp(Fe+"|>"),Yn=new RegExp(wt),Kn=new RegExp("^"+ve+"$"),Fr={ID:new RegExp("^#("+ve+")"),CLASS:new RegExp("^\\.("+ve+")"),TAG:new RegExp("^("+ve+"|[*])"),ATTR:new RegExp("^"+$e),PSEUDO:new RegExp("^"+wt),CHILD:new RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\([\\x20\\t\\r\\n\\f]*(even|odd|(([+-]|)(\\d*)n|)[\\x20\\t\\r\\n\\f]*(?:([+-]|)[\\x20\\t\\r\\n\\f]*(\\d+)|))[\\x20\\t\\r\\n\\f]*\\)|)","i"),bool:new RegExp("^(?:"+Qt+")$","i"),needsContext:new RegExp("^[\\x20\\t\\r\\n\\f]*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\([\\x20\\t\\r\\n\\f]*((?:-\\d)?\\d*)[\\x20\\t\\r\\n\\f]*\\)|)(?=[^-]|$)","i")},Gn=/HTML$/i,Jn=/^(?:input|select|textarea|button)$/i,Zn=/^h\d$/i,jr=/^[^{]+\{\s*\[native \w/,ei=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,nn=/[+~]/,Vt=new RegExp("\\\\[\\da-fA-F]{1,6}[\\x20\\t\\r\\n\\f]?|\\\\([^\\r\\n\\f])","g"),Ut=function(m,b){var C="0x"+m.slice(1)-65536;return b||(C<0?String.fromCharCode(C+65536):String.fromCharCode(C>>10|55296,1023&C|56320))},Cn=/([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g,Tn=function(m,b){return b?m==="\0"?"�":m.slice(0,-1)+"\\"+m.charCodeAt(m.length-1).toString(16)+" ":"\\"+m},qn=function(){S()},ti=zr(function(m){return m.disabled===!0&&m.nodeName.toLowerCase()==="fieldset"},{dir:"parentNode",next:"legend"});try{Oe.apply(dt=vt.call(ne.childNodes),ne.childNodes),dt[ne.childNodes.length].nodeType}catch{Oe={apply:dt.length?function(m,b){Ct.apply(m,vt.call(b))}:function(m,b){for(var C=m.length,D=0;m[C++]=b[D++];);m.length=C-1}}}function _e(m,b,C,D){var T,Q,R,F,H,te,re,J=b&&b.ownerDocument,he=b?b.nodeType:9;if(C=C||[],typeof m!="string"||!m||he!==1&&he!==9&&he!==11)return C;if(!D&&(S(b),b=b||E,G)){if(he!==11&&(H=ei.exec(m)))if(T=H[1]){if(he===9){if(!(R=b.getElementById(T)))return C;if(R.id===T)return C.push(R),C}else if(J&&(R=J.getElementById(T))&&gt(b,R)&&R.id===T)return C.push(R),C}else{if(H[2])return Oe.apply(C,b.getElementsByTagName(m)),C;if((T=H[3])&&i.getElementsByClassName&&b.getElementsByClassName)return Oe.apply(C,b.getElementsByClassName(T)),C}if(i.qsa&&!bt[m+" "]&&(!V||!V.test(m))&&(he!==1||b.nodeName.toLowerCase()!=="object")){if(re=m,J=b,he===1&&(Xn.test(m)||Nr.test(m))){for((J=nn.test(m)&&an(b.parentNode)||b)===b&&i.scope||((F=b.getAttribute("id"))?F=F.replace(Cn,Tn):b.setAttribute("id",F=ke)),Q=(te=h(m)).length;Q--;)te[Q]=(F?"#"+F:":scope")+" "+Hr(te[Q]);re=te.join(",")}try{return Oe.apply(C,J.querySelectorAll(re)),C}catch{bt(m,!0)}finally{F===ke&&b.removeAttribute("id")}}}return _(m.replace(kt,"$1"),b,C,D)}function Br(){var m=[];return function b(C,D){return m.push(C+" ")>o.cacheLength&&delete b[m.shift()],b[C+" "]=D}}function Lt(m){return m[ke]=!0,m}function Ot(m){var b=E.createElement("fieldset");try{return!!m(b)}catch{return!1}finally{b.parentNode&&b.parentNode.removeChild(b),b=null}}function on(m,b){for(var C=m.split("|"),D=C.length;D--;)o.attrHandle[C[D]]=b}function jn(m,b){var C=b&&m,D=C&&m.nodeType===1&&b.nodeType===1&&m.sourceIndex-b.sourceIndex;if(D)return D;if(C){for(;C=C.nextSibling;)if(C===b)return-1}return m?1:-1}function ri(m){return function(b){return b.nodeName.toLowerCase()==="input"&&b.type===m}}function ni(m){return function(b){var C=b.nodeName.toLowerCase();return(C==="input"||C==="button")&&b.type===m}}function Sn(m){return function(b){return"form"in b?b.parentNode&&b.disabled===!1?"label"in b?"label"in b.parentNode?b.parentNode.disabled===m:b.disabled===m:b.isDisabled===m||b.isDisabled!==!m&&ti(b)===m:b.disabled===m:"label"in b&&b.disabled===m}}function nr(m){return Lt(function(b){return b=+b,Lt(function(C,D){for(var T,Q=m([],C.length,b),R=Q.length;R--;)C[T=Q[R]]&&(C[T]=!(D[T]=C[T]))})})}function an(m){return m&&m.getElementsByTagName!==void 0&&m}for(t in i=_e.support={},p=_e.isXML=function(m){var b=m&&m.namespaceURI,C=m&&(m.ownerDocument||m).documentElement;return!Gn.test(b||C&&C.nodeName||"HTML")},S=_e.setDocument=function(m){var b,C,D=m?m.ownerDocument||m:ne;return D!=E&&D.nodeType===9&&D.documentElement&&(W=(E=D).documentElement,G=!p(E),ne!=E&&(C=E.defaultView)&&C.top!==C&&(C.addEventListener?C.addEventListener("unload",qn,!1):C.attachEvent&&C.attachEvent("onunload",qn)),i.scope=Ot(function(T){return W.appendChild(T).appendChild(E.createElement("div")),T.querySelectorAll!==void 0&&!T.querySelectorAll(":scope fieldset div").length}),i.attributes=Ot(function(T){return T.className="i",!T.getAttribute("className")}),i.getElementsByTagName=Ot(function(T){return T.appendChild(E.createComment("")),!T.getElementsByTagName("*").length}),i.getElementsByClassName=jr.test(E.getElementsByClassName),i.getById=Ot(function(T){return W.appendChild(T).id=ke,!E.getElementsByName||!E.getElementsByName(ke).length}),i.getById?(o.filter.ID=function(T){var Q=T.replace(Vt,Ut);return function(R){return R.getAttribute("id")===Q}},o.find.ID=function(T,Q){if(Q.getElementById!==void 0&&G){var R=Q.getElementById(T);return R?[R]:[]}}):(o.filter.ID=function(T){var Q=T.replace(Vt,Ut);return function(R){var F=R.getAttributeNode!==void 0&&R.getAttributeNode("id");return F&&F.value===Q}},o.find.ID=function(T,Q){if(Q.getElementById!==void 0&&G){var R,F,H,te=Q.getElementById(T);if(te){if((R=te.getAttributeNode("id"))&&R.value===T)return[te];for(H=Q.getElementsByName(T),F=0;te=H[F++];)if((R=te.getAttributeNode("id"))&&R.value===T)return[te]}return[]}}),o.find.TAG=i.getElementsByTagName?function(T,Q){return Q.getElementsByTagName!==void 0?Q.getElementsByTagName(T):i.qsa?Q.querySelectorAll(T):void 0}:function(T,Q){var R,F=[],H=0,te=Q.getElementsByTagName(T);if(T==="*"){for(;R=te[H++];)R.nodeType===1&&F.push(R);return F}return te},o.find.CLASS=i.getElementsByClassName&&function(T,Q){if(Q.getElementsByClassName!==void 0&&G)return Q.getElementsByClassName(T)},Ee=[],V=[],(i.qsa=jr.test(E.querySelectorAll))&&(Ot(function(T){var Q;W.appendChild(T).innerHTML="<a id='"+ke+"'></a><select id='"+ke+"-\r\\' msallowcapture=''><option selected=''></option></select>",T.querySelectorAll("[msallowcapture^='']").length&&V.push(`[*^$]=[\\x20\\t\\r\\n\\f]*(?:''|"")`),T.querySelectorAll("[selected]").length||V.push("\\[[\\x20\\t\\r\\n\\f]*(?:value|"+Qt+")"),T.querySelectorAll("[id~="+ke+"-]").length||V.push("~="),(Q=E.createElement("input")).setAttribute("name",""),T.appendChild(Q),T.querySelectorAll("[name='']").length||V.push(`\\[[\\x20\\t\\r\\n\\f]*name[\\x20\\t\\r\\n\\f]*=[\\x20\\t\\r\\n\\f]*(?:''|"")`),T.querySelectorAll(":checked").length||V.push(":checked"),T.querySelectorAll("a#"+ke+"+*").length||V.push(".#.+[+~]"),T.querySelectorAll("\\\f"),V.push("[\\r\\n\\f]")}),Ot(function(T){T.innerHTML="<a href='' disabled='disabled'></a><select disabled='disabled'><option/></select>";var Q=E.createElement("input");Q.setAttribute("type","hidden"),T.appendChild(Q).setAttribute("name","D"),T.querySelectorAll("[name=d]").length&&V.push("name[\\x20\\t\\r\\n\\f]*[*^$|!~]?="),T.querySelectorAll(":enabled").length!==2&&V.push(":enabled",":disabled"),W.appendChild(T).disabled=!0,T.querySelectorAll(":disabled").length!==2&&V.push(":enabled",":disabled"),T.querySelectorAll("*,:x"),V.push(",.*:")})),(i.matchesSelector=jr.test(Ue=W.matches||W.webkitMatchesSelector||W.mozMatchesSelector||W.oMatchesSelector||W.msMatchesSelector))&&Ot(function(T){i.disconnectedMatch=Ue.call(T,"*"),Ue.call(T,"[s!='']:x"),Ee.push("!=",wt)}),V=V.length&&new RegExp(V.join("|")),Ee=Ee.length&&new RegExp(Ee.join("|")),b=jr.test(W.compareDocumentPosition),gt=b||jr.test(W.contains)?function(T,Q){var R=T.nodeType===9?T.documentElement:T,F=Q&&Q.parentNode;return T===F||!(!F||F.nodeType!==1||!(R.contains?R.contains(F):T.compareDocumentPosition&&16&T.compareDocumentPosition(F)))}:function(T,Q){if(Q){for(;Q=Q.parentNode;)if(Q===T)return!0}return!1},rr=b?function(T,Q){if(T===Q)return P=!0,0;var R=!T.compareDocumentPosition-!Q.compareDocumentPosition;return R||(1&(R=(T.ownerDocument||T)==(Q.ownerDocument||Q)?T.compareDocumentPosition(Q):1)||!i.sortDetached&&Q.compareDocumentPosition(T)===R?T==E||T.ownerDocument==ne&&gt(ne,T)?-1:Q==E||Q.ownerDocument==ne&&gt(ne,Q)?1:A?xt(A,T)-xt(A,Q):0:4&R?-1:1)}:function(T,Q){if(T===Q)return P=!0,0;var R,F=0,H=T.parentNode,te=Q.parentNode,re=[T],J=[Q];if(!H||!te)return T==E?-1:Q==E?1:H?-1:te?1:A?xt(A,T)-xt(A,Q):0;if(H===te)return jn(T,Q);for(R=T;R=R.parentNode;)re.unshift(R);for(R=Q;R=R.parentNode;)J.unshift(R);for(;re[F]===J[F];)F++;return F?jn(re[F],J[F]):re[F]==ne?-1:J[F]==ne?1:0}),E},_e.matches=function(m,b){return _e(m,null,null,b)},_e.matchesSelector=function(m,b){if(S(m),i.matchesSelector&&G&&!bt[b+" "]&&(!Ee||!Ee.test(b))&&(!V||!V.test(b)))try{var C=Ue.call(m,b);if(C||i.disconnectedMatch||m.document&&m.document.nodeType!==11)return C}catch{bt(b,!0)}return _e(b,E,null,[m]).length>0},_e.contains=function(m,b){return(m.ownerDocument||m)!=E&&S(m),gt(m,b)},_e.attr=function(m,b){(m.ownerDocument||m)!=E&&S(m);var C=o.attrHandle[b.toLowerCase()],D=C&&hr.call(o.attrHandle,b.toLowerCase())?C(m,b,!G):void 0;return D!==void 0?D:i.attributes||!G?m.getAttribute(b):(D=m.getAttributeNode(b))&&D.specified?D.value:null},_e.escape=function(m){return(m+"").replace(Cn,Tn)},_e.error=function(m){throw new Error("Syntax error, unrecognized expression: "+m)},_e.uniqueSort=function(m){var b,C=[],D=0,T=0;if(P=!i.detectDuplicates,A=!i.sortStable&&m.slice(0),m.sort(rr),P){for(;b=m[T++];)b===m[T]&&(D=C.push(T));for(;D--;)m.splice(C[D],1)}return A=null,m},u=_e.getText=function(m){var b,C="",D=0,T=m.nodeType;if(T){if(T===1||T===9||T===11){if(typeof m.textContent=="string")return m.textContent;for(m=m.firstChild;m;m=m.nextSibling)C+=u(m)}else if(T===3||T===4)return m.nodeValue}else for(;b=m[D++];)C+=u(b);return C},o=_e.selectors={cacheLength:50,createPseudo:Lt,match:Fr,attrHandle:{},find:{},relative:{">":{dir:"parentNode",first:!0}," ":{dir:"parentNode"},"+":{dir:"previousSibling",first:!0},"~":{dir:"previousSibling"}},preFilter:{ATTR:function(m){return m[1]=m[1].replace(Vt,Ut),m[3]=(m[3]||m[4]||m[5]||"").replace(Vt,Ut),m[2]==="~="&&(m[3]=" "+m[3]+" "),m.slice(0,4)},CHILD:function(m){return m[1]=m[1].toLowerCase(),m[1].slice(0,3)==="nth"?(m[3]||_e.error(m[0]),m[4]=+(m[4]?m[5]+(m[6]||1):2*(m[3]==="even"||m[3]==="odd")),m[5]=+(m[7]+m[8]||m[3]==="odd")):m[3]&&_e.error(m[0]),m},PSEUDO:function(m){var b,C=!m[6]&&m[2];return Fr.CHILD.test(m[0])?null:(m[3]?m[2]=m[4]||m[5]||"":C&&Yn.test(C)&&(b=h(C,!0))&&(b=C.indexOf(")",C.length-b)-C.length)&&(m[0]=m[0].slice(0,b),m[2]=C.slice(0,b)),m.slice(0,3))}},filter:{TAG:function(m){var b=m.replace(Vt,Ut).toLowerCase();return m==="*"?function(){return!0}:function(C){return C.nodeName&&C.nodeName.toLowerCase()===b}},CLASS:function(m){var b=Le[m+" "];return b||(b=new RegExp("(^|[\\x20\\t\\r\\n\\f])"+m+"("+Fe+"|$)"))&&Le(m,function(C){return b.test(typeof C.className=="string"&&C.className||C.getAttribute!==void 0&&C.getAttribute("class")||"")})},ATTR:function(m,b,C){return function(D){var T=_e.attr(D,m);return T==null?b==="!=":!b||(T+="",b==="="?T===C:b==="!="?T!==C:b==="^="?C&&T.indexOf(C)===0:b==="*="?C&&T.indexOf(C)>-1:b==="$="?C&&T.slice(-C.length)===C:b==="~="?(" "+T.replace(Be," ")+" ").indexOf(C)>-1:b==="|="&&(T===C||T.slice(0,C.length+1)===C+"-"))}},CHILD:function(m,b,C,D,T){var Q=m.slice(0,3)!=="nth",R=m.slice(-4)!=="last",F=b==="of-type";return D===1&&T===0?function(H){return!!H.parentNode}:function(H,te,re){var J,he,He,oe,Xe,Ge,st=Q!==R?"nextSibling":"previousSibling",Ce=H.parentNode,Rt=F&&H.nodeName.toLowerCase(),ot=!re&&!F,ze=!1;if(Ce){if(Q){for(;st;){for(oe=H;oe=oe[st];)if(F?oe.nodeName.toLowerCase()===Rt:oe.nodeType===1)return!1;Ge=st=m==="only"&&!Ge&&"nextSibling"}return!0}if(Ge=[R?Ce.firstChild:Ce.lastChild],R&&ot){for(ze=(Xe=(J=(he=(He=(oe=Ce)[ke]||(oe[ke]={}))[oe.uniqueID]||(He[oe.uniqueID]={}))[m]||[])[0]===ut&&J[1])&&J[2],oe=Xe&&Ce.childNodes[Xe];oe=++Xe&&oe&&oe[st]||(ze=Xe=0)||Ge.pop();)if(oe.nodeType===1&&++ze&&oe===H){he[m]=[ut,Xe,ze];break}}else if(ot&&(ze=Xe=(J=(he=(He=(oe=H)[ke]||(oe[ke]={}))[oe.uniqueID]||(He[oe.uniqueID]={}))[m]||[])[0]===ut&&J[1]),ze===!1)for(;(oe=++Xe&&oe&&oe[st]||(ze=Xe=0)||Ge.pop())&&((F?oe.nodeName.toLowerCase()!==Rt:oe.nodeType!==1)||!++ze||(ot&&((he=(He=oe[ke]||(oe[ke]={}))[oe.uniqueID]||(He[oe.uniqueID]={}))[m]=[ut,ze]),oe!==H)););return(ze-=T)===D||ze%D==0&&ze/D>=0}}},PSEUDO:function(m,b){var C,D=o.pseudos[m]||o.setFilters[m.toLowerCase()]||_e.error("unsupported pseudo: "+m);return D[ke]?D(b):D.length>1?(C=[m,m,"",b],o.setFilters.hasOwnProperty(m.toLowerCase())?Lt(function(T,Q){for(var R,F=D(T,b),H=F.length;H--;)T[R=xt(T,F[H])]=!(Q[R]=F[H])}):function(T){return D(T,0,C)}):D}},pseudos:{not:Lt(function(m){var b=[],C=[],D=x(m.replace(kt,"$1"));return D[ke]?Lt(function(T,Q,R,F){for(var H,te=D(T,null,F,[]),re=T.length;re--;)(H=te[re])&&(T[re]=!(Q[re]=H))}):function(T,Q,R){return b[0]=T,D(b,null,R,C),b[0]=null,!C.pop()}}),has:Lt(function(m){return function(b){return _e(m,b).length>0}}),contains:Lt(function(m){return m=m.replace(Vt,Ut),function(b){return(b.textContent||u(b)).indexOf(m)>-1}}),lang:Lt(function(m){return Kn.test(m||"")||_e.error("unsupported lang: "+m),m=m.replace(Vt,Ut).toLowerCase(),function(b){var C;do if(C=G?b.lang:b.getAttribute("xml:lang")||b.getAttribute("lang"))return(C=C.toLowerCase())===m||C.indexOf(m+"-")===0;while((b=b.parentNode)&&b.nodeType===1);return!1}}),target:function(m){var b=e.location&&e.location.hash;return b&&b.slice(1)===m.id},root:function(m){return m===W},focus:function(m){return m===E.activeElement&&(!E.hasFocus||E.hasFocus())&&!!(m.type||m.href||~m.tabIndex)},enabled:Sn(!1),disabled:Sn(!0),checked:function(m){var b=m.nodeName.toLowerCase();return b==="input"&&!!m.checked||b==="option"&&!!m.selected},selected:function(m){return m.parentNode&&m.parentNode.selectedIndex,m.selected===!0},empty:function(m){for(m=m.firstChild;m;m=m.nextSibling)if(m.nodeType<6)return!1;return!0},parent:function(m){return!o.pseudos.empty(m)},header:function(m){return Zn.test(m.nodeName)},input:function(m){return Jn.test(m.nodeName)},button:function(m){var b=m.nodeName.toLowerCase();return b==="input"&&m.type==="button"||b==="button"},text:function(m){var b;return m.nodeName.toLowerCase()==="input"&&m.type==="text"&&((b=m.getAttribute("type"))==null||b.toLowerCase()==="text")},first:nr(function(){return[0]}),last:nr(function(m,b){return[b-1]}),eq:nr(function(m,b,C){return[C<0?C+b:C]}),even:nr(function(m,b){for(var C=0;C<b;C+=2)m.push(C);return m}),odd:nr(function(m,b){for(var C=1;C<b;C+=2)m.push(C);return m}),lt:nr(function(m,b,C){for(var D=C<0?C+b:C>b?b:C;--D>=0;)m.push(D);return m}),gt:nr(function(m,b,C){for(var D=C<0?C+b:C;++D<b;)m.push(D);return m})}},o.pseudos.nth=o.pseudos.eq,{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})o.pseudos[t]=ri(t);for(t in{submit:!0,reset:!0})o.pseudos[t]=ni(t);function En(){}function Hr(m){for(var b=0,C=m.length,D="";b<C;b++)D+=m[b].value;return D}function zr(m,b,C){var D=b.dir,T=b.next,Q=T||D,R=C&&Q==="parentNode",F=ye++;return b.first?function(H,te,re){for(;H=H[D];)if(H.nodeType===1||R)return m(H,te,re);return!1}:function(H,te,re){var J,he,He,oe=[ut,F];if(re){for(;H=H[D];)if((H.nodeType===1||R)&&m(H,te,re))return!0}else for(;H=H[D];)if(H.nodeType===1||R)if(he=(He=H[ke]||(H[ke]={}))[H.uniqueID]||(He[H.uniqueID]={}),T&&T===H.nodeName.toLowerCase())H=H[D]||H;else{if((J=he[Q])&&J[0]===ut&&J[1]===F)return oe[2]=J[2];if(he[Q]=oe,oe[2]=m(H,te,re))return!0}return!1}}function sn(m){return m.length>1?function(b,C,D){for(var T=m.length;T--;)if(!m[T](b,C,D))return!1;return!0}:m[0]}function Wr(m,b,C,D,T){for(var Q,R=[],F=0,H=m.length,te=b!=null;F<H;F++)(Q=m[F])&&(C&&!C(Q,D,T)||(R.push(Q),te&&b.push(F)));return R}function ln(m,b,C,D,T,Q){return D&&!D[ke]&&(D=ln(D)),T&&!T[ke]&&(T=ln(T,Q)),Lt(function(R,F,H,te){var re,J,he,He=[],oe=[],Xe=F.length,Ge=R||function(Rt,ot,ze){for(var At=0,Vr=ot.length;At<Vr;At++)_e(Rt,ot[At],ze);return ze}(b||"*",H.nodeType?[H]:H,[]),st=!m||!R&&b?Ge:Wr(Ge,He,m,H,te),Ce=C?T||(R?m:Xe||D)?[]:F:st;if(C&&C(st,Ce,H,te),D)for(re=Wr(Ce,oe),D(re,[],H,te),J=re.length;J--;)(he=re[J])&&(Ce[oe[J]]=!(st[oe[J]]=he));if(R){if(T||m){if(T){for(re=[],J=Ce.length;J--;)(he=Ce[J])&&re.push(st[J]=he);T(null,Ce=[],re,te)}for(J=Ce.length;J--;)(he=Ce[J])&&(re=T?xt(R,he):He[J])>-1&&(R[re]=!(F[re]=he))}}else Ce=Wr(Ce===F?Ce.splice(Xe,Ce.length):Ce),T?T(null,F,Ce,te):Oe.apply(F,Ce)})}function cn(m){for(var b,C,D,T=m.length,Q=o.relative[m[0].type],R=Q||o.relative[" "],F=Q?1:0,H=zr(function(J){return J===b},R,!0),te=zr(function(J){return xt(b,J)>-1},R,!0),re=[function(J,he,He){var oe=!Q&&(He||he!==q)||((b=he).nodeType?H(J,he,He):te(J,he,He));return b=null,oe}];F<T;F++)if(C=o.relative[m[F].type])re=[zr(sn(re),C)];else{if((C=o.filter[m[F].type].apply(null,m[F].matches))[ke]){for(D=++F;D<T&&!o.relative[m[D].type];D++);return ln(F>1&&sn(re),F>1&&Hr(m.slice(0,F-1).concat({value:m[F-2].type===" "?"*":""})).replace(kt,"$1"),C,F<D&&cn(m.slice(F,D)),D<T&&cn(m=m.slice(D)),D<T&&Hr(m))}re.push(C)}return sn(re)}return En.prototype=o.filters=o.pseudos,o.setFilters=new En,h=_e.tokenize=function(m,b){var C,D,T,Q,R,F,H,te=qr[m+" "];if(te)return b?0:te.slice(0);for(R=m,F=[],H=o.preFilter;R;){for(Q in C&&!(D=fr.exec(R))||(D&&(R=R.slice(D[0].length)||R),F.push(T=[])),C=!1,(D=Nr.exec(R))&&(C=D.shift(),T.push({value:C,type:D[0].replace(kt," ")}),R=R.slice(C.length)),o.filter)!(D=Fr[Q].exec(R))||H[Q]&&!(D=H[Q](D))||(C=D.shift(),T.push({value:C,type:Q,matches:D}),R=R.slice(C.length));if(!C)break}return b?R.length:R?_e.error(m):qr(m,F).slice(0)},x=_e.compile=function(m,b){var C,D=[],T=[],Q=Ir[m+" "];if(!Q){for(b||(b=h(m)),C=b.length;C--;)(Q=cn(b[C]))[ke]?D.push(Q):T.push(Q);Q=Ir(m,function(R,F){var H=F.length>0,te=R.length>0,re=function(J,he,He,oe,Xe){var Ge,st,Ce,Rt=0,ot="0",ze=J&&[],At=[],Vr=q,Ln=J||te&&o.find.TAG("*",Xe),On=ut+=Vr==null?1:Math.random()||.1,ii=Ln.length;for(Xe&&(q=he==E||he||Xe);ot!==ii&&(Ge=Ln[ot])!=null;ot++){if(te&&Ge){for(st=0,he||Ge.ownerDocument==E||(S(Ge),He=!G);Ce=R[st++];)if(Ce(Ge,he||E,He)){oe.push(Ge);break}Xe&&(ut=On)}H&&((Ge=!Ce&&Ge)&&Rt--,J&&ze.push(Ge))}if(Rt+=ot,H&&ot!==Rt){for(st=0;Ce=F[st++];)Ce(ze,At,he,He);if(J){if(Rt>0)for(;ot--;)ze[ot]||At[ot]||(At[ot]=mr.call(oe));At=Wr(At)}Oe.apply(oe,At),Xe&&!J&&At.length>0&&Rt+F.length>1&&_e.uniqueSort(oe)}return Xe&&(ut=On,q=Vr),ze};return H?Lt(re):re}(T,D)),Q.selector=m}return Q},_=_e.select=function(m,b,C,D){var T,Q,R,F,H,te=typeof m=="function"&&m,re=!D&&h(m=te.selector||m);if(C=C||[],re.length===1){if((Q=re[0]=re[0].slice(0)).length>2&&(R=Q[0]).type==="ID"&&b.nodeType===9&&G&&o.relative[Q[1].type]){if(!(b=(o.find.ID(R.matches[0].replace(Vt,Ut),b)||[])[0]))return C;te&&(b=b.parentNode),m=m.slice(Q.shift().value.length)}for(T=Fr.needsContext.test(m)?0:Q.length;T--&&(R=Q[T],!o.relative[F=R.type]);)if((H=o.find[F])&&(D=H(R.matches[0].replace(Vt,Ut),nn.test(Q[0].type)&&an(b.parentNode)||b))){if(Q.splice(T,1),!(m=D.length&&Hr(Q)))return Oe.apply(C,D),C;break}}return(te||x(m,re))(D,b,!G,C,!b||nn.test(m)&&an(b.parentNode)||b),C},i.sortStable=ke.split("").sort(rr).join("")===ke,i.detectDuplicates=!!P,S(),i.sortDetached=Ot(function(m){return 1&m.compareDocumentPosition(E.createElement("fieldset"))}),Ot(function(m){return m.innerHTML="<a href='#'></a>",m.firstChild.getAttribute("href")==="#"})||on("type|href|height|width",function(m,b,C){if(!C)return m.getAttribute(b,b.toLowerCase()==="type"?1:2)}),i.attributes&&Ot(function(m){return m.innerHTML="<input/>",m.firstChild.setAttribute("value",""),m.firstChild.getAttribute("value")===""})||on("value",function(m,b,C){if(!C&&m.nodeName.toLowerCase()==="input")return m.defaultValue}),Ot(function(m){return m.getAttribute("disabled")==null})||on(Qt,function(m,b,C){var D;if(!C)return m[b]===!0?b.toLowerCase():(D=m.getAttributeNode(b))&&D.specified?D.value:null}),_e}(N);a.find=we,a.expr=we.selectors,a.expr[":"]=a.expr.pseudos,a.uniqueSort=a.unique=we.uniqueSort,a.text=we.getText,a.isXMLDoc=we.isXML,a.contains=we.contains,a.escapeSelector=we.escape;var De=function(e,t,i){for(var o=[],u=i!==void 0;(e=e[t])&&e.nodeType!==9;)if(e.nodeType===1){if(u&&a(e).is(i))break;o.push(e)}return o},ht=function(e,t){for(var i=[];e;e=e.nextSibling)e.nodeType===1&&e!==t&&i.push(e);return i},Ie=a.expr.match.needsContext;function Qe(e,t){return e.nodeName&&e.nodeName.toLowerCase()===t.toLowerCase()}var rt=/^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i;function Tt(e,t,i){return L(t)?a.grep(e,function(o,u){return!!t.call(o,u,o)!==i}):t.nodeType?a.grep(e,function(o){return o===t!==i}):typeof t!="string"?a.grep(e,function(o){return xe.call(t,o)>-1!==i}):a.filter(t,e,i)}a.filter=function(e,t,i){var o=t[0];return i&&(e=":not("+e+")"),t.length===1&&o.nodeType===1?a.find.matchesSelector(o,e)?[o]:[]:a.find.matches(e,a.grep(t,function(u){return u.nodeType===1}))},a.fn.extend({find:function(e){var t,i,o=this.length,u=this;if(typeof e!="string")return this.pushStack(a(e).filter(function(){for(t=0;t<o;t++)if(a.contains(u[t],this))return!0}));for(i=this.pushStack([]),t=0;t<o;t++)a.find(e,u[t],i);return o>1?a.uniqueSort(i):i},filter:function(e){return this.pushStack(Tt(this,e||[],!1))},not:function(e){return this.pushStack(Tt(this,e||[],!0))},is:function(e){return!!Tt(this,typeof e=="string"&&Ie.test(e)?a(e):e||[],!1).length}});var Pt,Mt=/^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;(a.fn.init=function(e,t,i){var o,u;if(!e)return this;if(i=i||Pt,typeof e=="string"){if(!(o=e[0]==="<"&&e[e.length-1]===">"&&e.length>=3?[null,e,null]:Mt.exec(e))||!o[1]&&t)return!t||t.jquery?(t||i).find(e):this.constructor(t).find(e);if(o[1]){if(t=t instanceof a?t[0]:t,a.merge(this,a.parseHTML(o[1],t&&t.nodeType?t.ownerDocument||t:$,!0)),rt.test(o[1])&&a.isPlainObject(t))for(o in t)L(this[o])?this[o](t[o]):this.attr(o,t[o]);return this}return(u=$.getElementById(o[2]))&&(this[0]=u,this.length=1),this}return e.nodeType?(this[0]=e,this.length=1,this):L(e)?i.ready!==void 0?i.ready(e):e(a):a.makeArray(e,this)}).prototype=a.fn,Pt=a($);var $t=/^(?:parents|prev(?:Until|All))/,nt={children:!0,contents:!0,next:!0,prev:!0};function yr(e,t){for(;(e=e[t])&&e.nodeType!==1;);return e}a.fn.extend({has:function(e){var t=a(e,this),i=t.length;return this.filter(function(){for(var o=0;o<i;o++)if(a.contains(this,t[o]))return!0})},closest:function(e,t){var i,o=0,u=this.length,p=[],h=typeof e!="string"&&a(e);if(!Ie.test(e)){for(;o<u;o++)for(i=this[o];i&&i!==t;i=i.parentNode)if(i.nodeType<11&&(h?h.index(i)>-1:i.nodeType===1&&a.find.matchesSelector(i,e))){p.push(i);break}}return this.pushStack(p.length>1?a.uniqueSort(p):p)},index:function(e){return e?typeof e=="string"?xe.call(a(e),this[0]):xe.call(this,e.jquery?e[0]:e):this[0]&&this[0].parentNode?this.first().prevAll().length:-1},add:function(e,t){return this.pushStack(a.uniqueSort(a.merge(this.get(),a(e,t))))},addBack:function(e){return this.add(e==null?this.prevObject:this.prevObject.filter(e))}}),a.each({parent:function(e){var t=e.parentNode;return t&&t.nodeType!==11?t:null},parents:function(e){return De(e,"parentNode")},parentsUntil:function(e,t,i){return De(e,"parentNode",i)},next:function(e){return yr(e,"nextSibling")},prev:function(e){return yr(e,"previousSibling")},nextAll:function(e){return De(e,"nextSibling")},prevAll:function(e){return De(e,"previousSibling")},nextUntil:function(e,t,i){return De(e,"nextSibling",i)},prevUntil:function(e,t,i){return De(e,"previousSibling",i)},siblings:function(e){return ht((e.parentNode||{}).firstChild,e)},children:function(e){return ht(e.firstChild)},contents:function(e){return e.contentDocument!=null&&pe(e.contentDocument)?e.contentDocument:(Qe(e,"template")&&(e=e.content||e),a.merge([],e.childNodes))}},function(e,t){a.fn[e]=function(i,o){var u=a.map(this,t,i);return e.slice(-5)!=="Until"&&(o=i),o&&typeof o=="string"&&(u=a.filter(o,u)),this.length>1&&(nt[e]||a.uniqueSort(u),$t.test(e)&&u.reverse()),this.pushStack(u)}});var mt=/[^\x20\t\r\n\f]+/g;function qt(e){return e}function ir(e){throw e}function gr(e,t,i,o){var u;try{e&&L(u=e.promise)?u.call(e).done(t).fail(i):e&&L(u=e.then)?u.call(e,t,i):t.apply(void 0,[e].slice(o))}catch(p){i.apply(void 0,[p])}}a.Callbacks=function(e){e=typeof e=="string"?function(A){var P={};return a.each(A.match(mt)||[],function(S,E){P[E]=!0}),P}(e):a.extend({},e);var t,i,o,u,p=[],h=[],x=-1,_=function(){for(u=u||e.once,o=t=!0;h.length;x=-1)for(i=h.shift();++x<p.length;)p[x].apply(i[0],i[1])===!1&&e.stopOnFalse&&(x=p.length,i=!1);e.memory||(i=!1),t=!1,u&&(p=i?[]:"")},q={add:function(){return p&&(i&&!t&&(x=p.length-1,h.push(i)),function A(P){a.each(P,function(S,E){L(E)?e.unique&&q.has(E)||p.push(E):E&&E.length&&be(E)!=="string"&&A(E)})}(arguments),i&&!t&&_()),this},remove:function(){return a.each(arguments,function(A,P){for(var S;(S=a.inArray(P,p,S))>-1;)p.splice(S,1),S<=x&&x--}),this},has:function(A){return A?a.inArray(A,p)>-1:p.length>0},empty:function(){return p&&(p=[]),this},disable:function(){return u=h=[],p=i="",this},disabled:function(){return!p},lock:function(){return u=h=[],i||t||(p=i=""),this},locked:function(){return!!u},fireWith:function(A,P){return u||(P=[A,(P=P||[]).slice?P.slice():P],h.push(P),t||_()),this},fire:function(){return q.fireWith(this,arguments),this},fired:function(){return!!o}};return q},a.extend({Deferred:function(e){var t=[["notify","progress",a.Callbacks("memory"),a.Callbacks("memory"),2],["resolve","done",a.Callbacks("once memory"),a.Callbacks("once memory"),0,"resolved"],["reject","fail",a.Callbacks("once memory"),a.Callbacks("once memory"),1,"rejected"]],i="pending",o={state:function(){return i},always:function(){return u.done(arguments).fail(arguments),this},catch:function(p){return o.then(null,p)},pipe:function(){var p=arguments;return a.Deferred(function(h){a.each(t,function(x,_){var q=L(p[_[4]])&&p[_[4]];u[_[1]](function(){var A=q&&q.apply(this,arguments);A&&L(A.promise)?A.promise().progress(h.notify).done(h.resolve).fail(h.reject):h[_[0]+"With"](this,q?[A]:arguments)})}),p=null}).promise()},then:function(p,h,x){var _=0;function q(A,P,S,E){return function(){var W=this,G=arguments,V=function(){var Ue,gt;if(!(A<_)){if((Ue=S.apply(W,G))===P.promise())throw new TypeError("Thenable self-resolution");gt=Ue&&(typeof Ue=="object"||typeof Ue=="function")&&Ue.then,L(gt)?E?gt.call(Ue,q(_,P,qt,E),q(_,P,ir,E)):(_++,gt.call(Ue,q(_,P,qt,E),q(_,P,ir,E),q(_,P,qt,P.notifyWith))):(S!==qt&&(W=void 0,G=[Ue]),(E||P.resolveWith)(W,G))}},Ee=E?V:function(){try{V()}catch(Ue){a.Deferred.exceptionHook&&a.Deferred.exceptionHook(Ue,Ee.stackTrace),A+1>=_&&(S!==ir&&(W=void 0,G=[Ue]),P.rejectWith(W,G))}};A?Ee():(a.Deferred.getStackHook&&(Ee.stackTrace=a.Deferred.getStackHook()),N.setTimeout(Ee))}}return a.Deferred(function(A){t[0][3].add(q(0,A,L(x)?x:qt,A.notifyWith)),t[1][3].add(q(0,A,L(p)?p:qt)),t[2][3].add(q(0,A,L(h)?h:ir))}).promise()},promise:function(p){return p!=null?a.extend(p,o):o}},u={};return a.each(t,function(p,h){var x=h[2],_=h[5];o[h[1]]=x.add,_&&x.add(function(){i=_},t[3-p][2].disable,t[3-p][3].disable,t[0][2].lock,t[0][3].lock),x.add(h[3].fire),u[h[0]]=function(){return u[h[0]+"With"](this===u?void 0:this,arguments),this},u[h[0]+"With"]=x.fireWith}),o.promise(u),e&&e.call(u,u),u},when:function(e){var t=arguments.length,i=t,o=Array(i),u=me.call(arguments),p=a.Deferred(),h=function(x){return function(_){o[x]=this,u[x]=arguments.length>1?me.call(arguments):_,--t||p.resolveWith(o,u)}};if(t<=1&&(gr(e,p.done(h(i)).resolve,p.reject,!t),p.state()==="pending"||L(u[i]&&u[i].then)))return p.then();for(;i--;)gr(u[i],h(i),p.reject);return p.promise()}});var Sr=/^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/;a.Deferred.exceptionHook=function(e,t){N.console&&N.console.warn&&e&&Sr.test(e.name)&&N.console.warn("jQuery.Deferred exception: "+e.message,e.stack,t)},a.readyException=function(e){N.setTimeout(function(){throw e})};var or=a.Deferred();function Z(){$.removeEventListener("DOMContentLoaded",Z),N.removeEventListener("load",Z),a.ready()}a.fn.ready=function(e){return or.then(e).catch(function(t){a.readyException(t)}),this},a.extend({isReady:!1,readyWait:1,ready:function(e){(e===!0?--a.readyWait:a.isReady)||(a.isReady=!0,e!==!0&&--a.readyWait>0||or.resolveWith($,[a]))}}),a.ready.then=or.then,$.readyState==="complete"||$.readyState!=="loading"&&!$.documentElement.doScroll?N.setTimeout(a.ready):($.addEventListener("DOMContentLoaded",Z),N.addEventListener("load",Z));var Re=function(e,t,i,o,u,p,h){var x=0,_=e.length,q=i==null;if(be(i)==="object")for(x in u=!0,i)Re(e,t,x,i[x],!0,p,h);else if(o!==void 0&&(u=!0,L(o)||(h=!0),q&&(h?(t.call(e,o),t=null):(q=t,t=function(A,P,S){return q.call(a(A),S)})),t))for(;x<_;x++)t(e[x],i,h?o:o.call(e[x],x,t(e[x],i)));return u?e:q?t.call(e):_?t(e[0],i):p},Er=/^-ms-/,qe=/-([a-z])/g;function ct(e,t){return t.toUpperCase()}function j(e){return e.replace(Er,"ms-").replace(qe,ct)}var ee=function(e){return e.nodeType===1||e.nodeType===9||!+e.nodeType};function Me(){this.expando=a.expando+Me.uid++}Me.uid=1,Me.prototype={cache:function(e){var t=e[this.expando];return t||(t={},ee(e)&&(e.nodeType?e[this.expando]=t:Object.defineProperty(e,this.expando,{value:t,configurable:!0}))),t},set:function(e,t,i){var o,u=this.cache(e);if(typeof t=="string")u[j(t)]=i;else for(o in t)u[j(o)]=t[o];return u},get:function(e,t){return t===void 0?this.cache(e):e[this.expando]&&e[this.expando][j(t)]},access:function(e,t,i){return t===void 0||t&&typeof t=="string"&&i===void 0?this.get(e,t):(this.set(e,t,i),i!==void 0?i:t)},remove:function(e,t){var i,o=e[this.expando];if(o!==void 0){if(t!==void 0)for(i=(t=Array.isArray(t)?t.map(j):(t=j(t))in o?[t]:t.match(mt)||[]).length;i--;)delete o[t[i]];(t===void 0||a.isEmptyObject(o))&&(e.nodeType?e[this.expando]=void 0:delete e[this.expando])}},hasData:function(e){var t=e[this.expando];return t!==void 0&&!a.isEmptyObject(t)}};var X=new Me,Ve=new Me,It=/^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,Nt=/[A-Z]/g;function br(e,t,i){var o;if(i===void 0&&e.nodeType===1)if(o="data-"+t.replace(Nt,"-$&").toLowerCase(),typeof(i=e.getAttribute(o))=="string"){try{i=function(u){return u==="true"||u!=="false"&&(u==="null"?null:u===+u+""?+u:It.test(u)?JSON.parse(u):u)}(i)}catch{}Ve.set(e,t,i)}else i=void 0;return i}a.extend({hasData:function(e){return Ve.hasData(e)||X.hasData(e)},data:function(e,t,i){return Ve.access(e,t,i)},removeData:function(e,t){Ve.remove(e,t)},_data:function(e,t,i){return X.access(e,t,i)},_removeData:function(e,t){X.remove(e,t)}}),a.fn.extend({data:function(e,t){var i,o,u,p=this[0],h=p&&p.attributes;if(e===void 0){if(this.length&&(u=Ve.get(p),p.nodeType===1&&!X.get(p,"hasDataAttrs"))){for(i=h.length;i--;)h[i]&&(o=h[i].name).indexOf("data-")===0&&(o=j(o.slice(5)),br(p,o,u[o]));X.set(p,"hasDataAttrs",!0)}return u}return typeof e=="object"?this.each(function(){Ve.set(this,e)}):Re(this,function(x){var _;if(p&&x===void 0)return(_=Ve.get(p,e))!==void 0||(_=br(p,e))!==void 0?_:void 0;this.each(function(){Ve.set(this,e,x)})},null,t,arguments.length>1,null,!0)},removeData:function(e){return this.each(function(){Ve.remove(this,e)})}}),a.extend({queue:function(e,t,i){var o;if(e)return t=(t||"fx")+"queue",o=X.get(e,t),i&&(!o||Array.isArray(i)?o=X.access(e,t,a.makeArray(i)):o.push(i)),o||[]},dequeue:function(e,t){t=t||"fx";var i=a.queue(e,t),o=i.length,u=i.shift(),p=a._queueHooks(e,t);u==="inprogress"&&(u=i.shift(),o--),u&&(t==="fx"&&i.unshift("inprogress"),delete p.stop,u.call(e,function(){a.dequeue(e,t)},p)),!o&&p&&p.empty.fire()},_queueHooks:function(e,t){var i=t+"queueHooks";return X.get(e,i)||X.access(e,i,{empty:a.Callbacks("once memory").add(function(){X.remove(e,[t+"queue",i])})})}}),a.fn.extend({queue:function(e,t){var i=2;return typeof e!="string"&&(t=e,e="fx",i--),arguments.length<i?a.queue(this[0],e):t===void 0?this:this.each(function(){var o=a.queue(this,e,t);a._queueHooks(this,e),e==="fx"&&o[0]!=="inprogress"&&a.dequeue(this,e)})},dequeue:function(e){return this.each(function(){a.dequeue(this,e)})},clearQueue:function(e){return this.queue(e||"fx",[])},promise:function(e,t){var i,o=1,u=a.Deferred(),p=this,h=this.length,x=function(){--o||u.resolveWith(p,[p])};for(typeof e!="string"&&(t=e,e=void 0),e=e||"fx";h--;)(i=X.get(p[h],e+"queueHooks"))&&i.empty&&(o++,i.empty.add(x));return x(),u.promise(t)}});var Lr=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,jt=new RegExp("^(?:([+-])=|)("+Lr+")([a-z%]*)$","i"),ft=["Top","Right","Bottom","Left"],Dt=$.documentElement,Ft=function(e){return a.contains(e.ownerDocument,e)},Or={composed:!0};Dt.getRootNode&&(Ft=function(e){return a.contains(e.ownerDocument,e)||e.getRootNode(Or)===e.ownerDocument});var it=function(e,t){return(e=t||e).style.display==="none"||e.style.display===""&&Ft(e)&&a.css(e,"display")==="none"};function St(e,t,i,o){var u,p,h=20,x=o?function(){return o.cur()}:function(){return a.css(e,t,"")},_=x(),q=i&&i[3]||(a.cssNumber[t]?"":"px"),A=e.nodeType&&(a.cssNumber[t]||q!=="px"&&+_)&&jt.exec(a.css(e,t));if(A&&A[3]!==q){for(_/=2,q=q||A[3],A=+_||1;h--;)a.style(e,t,A+q),(1-p)*(1-(p=x()/_||.5))<=0&&(h=0),A/=p;A*=2,a.style(e,t,A+q),i=i||[]}return i&&(A=+A||+_||0,u=i[1]?A+(i[1]+1)*i[2]:+i[2],o&&(o.unit=q,o.start=A,o.end=u)),u}var ar={};function Bt(e){var t,i=e.ownerDocument,o=e.nodeName,u=ar[o];return u||(t=i.body.appendChild(i.createElement(o)),u=a.css(t,"display"),t.parentNode.removeChild(t),u==="none"&&(u="block"),ar[o]=u,u)}function Xt(e,t){for(var i,o,u=[],p=0,h=e.length;p<h;p++)(o=e[p]).style&&(i=o.style.display,t?(i==="none"&&(u[p]=X.get(o,"display")||null,u[p]||(o.style.display="")),o.style.display===""&&it(o)&&(u[p]=Bt(o))):i!=="none"&&(u[p]="none",X.set(o,"display",i)));for(p=0;p<h;p++)u[p]!=null&&(e[p].style.display=u[p]);return e}a.fn.extend({show:function(){return Xt(this,!0)},hide:function(){return Xt(this)},toggle:function(e){return typeof e=="boolean"?e?this.show():this.hide():this.each(function(){it(this)?a(this).show():a(this).hide()})}});var Ht,sr,Kt=/^(?:checkbox|radio)$/i,vr=/<([a-z][^\/\0>\x20\t\r\n\f]*)/i,xr=/^$|^module$|\/(?:java|ecma)script/i;Ht=$.createDocumentFragment().appendChild($.createElement("div")),(sr=$.createElement("input")).setAttribute("type","radio"),sr.setAttribute("checked","checked"),sr.setAttribute("name","t"),Ht.appendChild(sr),B.checkClone=Ht.cloneNode(!0).cloneNode(!0).lastChild.checked,Ht.innerHTML="<textarea>x</textarea>",B.noCloneChecked=!!Ht.cloneNode(!0).lastChild.defaultValue,Ht.innerHTML="<option></option>",B.option=!!Ht.lastChild;var je={thead:[1,"<table>","</table>"],col:[2,"<table><colgroup>","</colgroup></table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],_default:[0,"",""]};function Ne(e,t){var i;return i=e.getElementsByTagName!==void 0?e.getElementsByTagName(t||"*"):e.querySelectorAll!==void 0?e.querySelectorAll(t||"*"):[],t===void 0||t&&Qe(e,t)?a.merge([e],i):i}function Gt(e,t){for(var i=0,o=e.length;i<o;i++)X.set(e[i],"globalEval",!t||X.get(t[i],"globalEval"))}je.tbody=je.tfoot=je.colgroup=je.caption=je.thead,je.th=je.td,B.option||(je.optgroup=je.option=[1,"<select multiple='multiple'>","</select>"]);var Xr=/<|&#?\w+;/;function Ar(e,t,i,o,u){for(var p,h,x,_,q,A,P=t.createDocumentFragment(),S=[],E=0,W=e.length;E<W;E++)if((p=e[E])||p===0)if(be(p)==="object")a.merge(S,p.nodeType?[p]:p);else if(Xr.test(p)){for(h=h||P.appendChild(t.createElement("div")),x=(vr.exec(p)||["",""])[1].toLowerCase(),_=je[x]||je._default,h.innerHTML=_[1]+a.htmlPrefilter(p)+_[2],A=_[0];A--;)h=h.lastChild;a.merge(S,h.childNodes),(h=P.firstChild).textContent=""}else S.push(t.createTextNode(p));for(P.textContent="",E=0;p=S[E++];)if(o&&a.inArray(p,o)>-1)u&&u.push(p);else if(q=Ft(p),h=Ne(P.appendChild(p),"script"),q&&Gt(h),i)for(A=0;p=h[A++];)xr.test(p.type||"")&&i.push(p);return P}var Pr=/^([^.]*)(?:\.(.+)|)/;function Se(){return!0}function et(){return!1}function wr(e,t){return e===function(){try{return $.activeElement}catch{}}()==(t==="focus")}function yt(e,t,i,o,u,p){var h,x;if(typeof t=="object"){for(x in typeof i!="string"&&(o=o||i,i=void 0),t)yt(e,x,i,o,t[x],p);return e}if(o==null&&u==null?(u=i,o=i=void 0):u==null&&(typeof i=="string"?(u=o,o=void 0):(u=o,o=i,i=void 0)),u===!1)u=et;else if(!u)return e;return p===1&&(h=u,u=function(_){return a().off(_),h.apply(this,arguments)},u.guid=h.guid||(h.guid=a.guid++)),e.each(function(){a.event.add(this,t,u,o,i)})}function lr(e,t,i){i?(X.set(e,t,!1),a.event.add(e,t,{namespace:!1,handler:function(o){var u,p,h=X.get(this,t);if(1&o.isTrigger&&this[t]){if(h.length)(a.event.special[t]||{}).delegateType&&o.stopPropagation();else if(h=me.call(arguments),X.set(this,t,h),u=i(this,t),this[t](),h!==(p=X.get(this,t))||u?X.set(this,t,!1):p={},h!==p)return o.stopImmediatePropagation(),o.preventDefault(),p&&p.value}else h.length&&(X.set(this,t,{value:a.event.trigger(a.extend(h[0],a.Event.prototype),h.slice(1),this)}),o.stopImmediatePropagation())}})):X.get(e,t)===void 0&&a.event.add(e,t,Se)}a.event={global:{},add:function(e,t,i,o,u){var p,h,x,_,q,A,P,S,E,W,G,V=X.get(e);if(ee(e))for(i.handler&&(i=(p=i).handler,u=p.selector),u&&a.find.matchesSelector(Dt,u),i.guid||(i.guid=a.guid++),(_=V.events)||(_=V.events=Object.create(null)),(h=V.handle)||(h=V.handle=function(Ee){return a!==void 0&&a.event.triggered!==Ee.type?a.event.dispatch.apply(e,arguments):void 0}),q=(t=(t||"").match(mt)||[""]).length;q--;)E=G=(x=Pr.exec(t[q])||[])[1],W=(x[2]||"").split(".").sort(),E&&(P=a.event.special[E]||{},E=(u?P.delegateType:P.bindType)||E,P=a.event.special[E]||{},A=a.extend({type:E,origType:G,data:o,handler:i,guid:i.guid,selector:u,needsContext:u&&a.expr.match.needsContext.test(u),namespace:W.join(".")},p),(S=_[E])||((S=_[E]=[]).delegateCount=0,P.setup&&P.setup.call(e,o,W,h)!==!1||e.addEventListener&&e.addEventListener(E,h)),P.add&&(P.add.call(e,A),A.handler.guid||(A.handler.guid=i.guid)),u?S.splice(S.delegateCount++,0,A):S.push(A),a.event.global[E]=!0)},remove:function(e,t,i,o,u){var p,h,x,_,q,A,P,S,E,W,G,V=X.hasData(e)&&X.get(e);if(V&&(_=V.events)){for(q=(t=(t||"").match(mt)||[""]).length;q--;)if(E=G=(x=Pr.exec(t[q])||[])[1],W=(x[2]||"").split(".").sort(),E){for(P=a.event.special[E]||{},S=_[E=(o?P.delegateType:P.bindType)||E]||[],x=x[2]&&new RegExp("(^|\\.)"+W.join("\\.(?:.*\\.|)")+"(\\.|$)"),h=p=S.length;p--;)A=S[p],!u&&G!==A.origType||i&&i.guid!==A.guid||x&&!x.test(A.namespace)||o&&o!==A.selector&&(o!=="**"||!A.selector)||(S.splice(p,1),A.selector&&S.delegateCount--,P.remove&&P.remove.call(e,A));h&&!S.length&&(P.teardown&&P.teardown.call(e,W,V.handle)!==!1||a.removeEvent(e,E,V.handle),delete _[E])}else for(E in _)a.event.remove(e,E+t[q],i,o,!0);a.isEmptyObject(_)&&X.remove(e,"handle events")}},dispatch:function(e){var t,i,o,u,p,h,x=new Array(arguments.length),_=a.event.fix(e),q=(X.get(this,"events")||Object.create(null))[_.type]||[],A=a.event.special[_.type]||{};for(x[0]=_,t=1;t<arguments.length;t++)x[t]=arguments[t];if(_.delegateTarget=this,!A.preDispatch||A.preDispatch.call(this,_)!==!1){for(h=a.event.handlers.call(this,_,q),t=0;(u=h[t++])&&!_.isPropagationStopped();)for(_.currentTarget=u.elem,i=0;(p=u.handlers[i++])&&!_.isImmediatePropagationStopped();)_.rnamespace&&p.namespace!==!1&&!_.rnamespace.test(p.namespace)||(_.handleObj=p,_.data=p.data,(o=((a.event.special[p.origType]||{}).handle||p.handler).apply(u.elem,x))!==void 0&&(_.result=o)===!1&&(_.preventDefault(),_.stopPropagation()));return A.postDispatch&&A.postDispatch.call(this,_),_.result}},handlers:function(e,t){var i,o,u,p,h,x=[],_=t.delegateCount,q=e.target;if(_&&q.nodeType&&!(e.type==="click"&&e.button>=1)){for(;q!==this;q=q.parentNode||this)if(q.nodeType===1&&(e.type!=="click"||q.disabled!==!0)){for(p=[],h={},i=0;i<_;i++)h[u=(o=t[i]).selector+" "]===void 0&&(h[u]=o.needsContext?a(u,this).index(q)>-1:a.find(u,this,null,[q]).length),h[u]&&p.push(o);p.length&&x.push({elem:q,handlers:p})}}return q=this,_<t.length&&x.push({elem:q,handlers:t.slice(_)}),x},addProp:function(e,t){Object.defineProperty(a.Event.prototype,e,{enumerable:!0,configurable:!0,get:L(t)?function(){if(this.originalEvent)return t(this.originalEvent)}:function(){if(this.originalEvent)return this.originalEvent[e]},set:function(i){Object.defineProperty(this,e,{enumerable:!0,configurable:!0,writable:!0,value:i})}})},fix:function(e){return e[a.expando]?e:new a.Event(e)},special:{load:{noBubble:!0},click:{setup:function(e){var t=this||e;return Kt.test(t.type)&&t.click&&Qe(t,"input")&&lr(t,"click",Se),!1},trigger:function(e){var t=this||e;return Kt.test(t.type)&&t.click&&Qe(t,"input")&&lr(t,"click"),!0},_default:function(e){var t=e.target;return Kt.test(t.type)&&t.click&&Qe(t,"input")&&X.get(t,"click")||Qe(t,"a")}},beforeunload:{postDispatch:function(e){e.result!==void 0&&e.originalEvent&&(e.originalEvent.returnValue=e.result)}}}},a.removeEvent=function(e,t,i){e.removeEventListener&&e.removeEventListener(t,i)},a.Event=function(e,t){if(!(this instanceof a.Event))return new a.Event(e,t);e&&e.type?(this.originalEvent=e,this.type=e.type,this.isDefaultPrevented=e.defaultPrevented||e.defaultPrevented===void 0&&e.returnValue===!1?Se:et,this.target=e.target&&e.target.nodeType===3?e.target.parentNode:e.target,this.currentTarget=e.currentTarget,this.relatedTarget=e.relatedTarget):this.type=e,t&&a.extend(this,t),this.timeStamp=e&&e.timeStamp||Date.now(),this[a.expando]=!0},a.Event.prototype={constructor:a.Event,isDefaultPrevented:et,isPropagationStopped:et,isImmediatePropagationStopped:et,isSimulated:!1,preventDefault:function(){var e=this.originalEvent;this.isDefaultPrevented=Se,e&&!this.isSimulated&&e.preventDefault()},stopPropagation:function(){var e=this.originalEvent;this.isPropagationStopped=Se,e&&!this.isSimulated&&e.stopPropagation()},stopImmediatePropagation:function(){var e=this.originalEvent;this.isImmediatePropagationStopped=Se,e&&!this.isSimulated&&e.stopImmediatePropagation(),this.stopPropagation()}},a.each({altKey:!0,bubbles:!0,cancelable:!0,changedTouches:!0,ctrlKey:!0,detail:!0,eventPhase:!0,metaKey:!0,pageX:!0,pageY:!0,shiftKey:!0,view:!0,char:!0,code:!0,charCode:!0,key:!0,keyCode:!0,button:!0,buttons:!0,clientX:!0,clientY:!0,offsetX:!0,offsetY:!0,pointerId:!0,pointerType:!0,screenX:!0,screenY:!0,targetTouches:!0,toElement:!0,touches:!0,which:!0},a.event.addProp),a.each({focus:"focusin",blur:"focusout"},function(e,t){a.event.special[e]={setup:function(){return lr(this,e,wr),!1},trigger:function(){return lr(this,e),!0},_default:function(){return!0},delegateType:t}}),a.each({mouseenter:"mouseover",mouseleave:"mouseout",pointerenter:"pointerover",pointerleave:"pointerout"},function(e,t){a.event.special[e]={delegateType:t,bindType:t,handle:function(i){var o,u=this,p=i.relatedTarget,h=i.handleObj;return p&&(p===u||a.contains(u,p))||(i.type=h.origType,o=h.handler.apply(this,arguments),i.type=t),o}}}),a.fn.extend({on:function(e,t,i,o){return yt(this,e,t,i,o)},one:function(e,t,i,o){return yt(this,e,t,i,o,1)},off:function(e,t,i){var o,u;if(e&&e.preventDefault&&e.handleObj)return o=e.handleObj,a(e.delegateTarget).off(o.namespace?o.origType+"."+o.namespace:o.origType,o.selector,o.handler),this;if(typeof e=="object"){for(u in e)this.off(u,t,e[u]);return this}return t!==!1&&typeof t!="function"||(i=t,t=void 0),i===!1&&(i=et),this.each(function(){a.event.remove(this,e,i,t)})}});var Dr=/<script|<style|<link/i,Qr=/checked\s*(?:[^=]|=\s*.checked.)/i,Jt=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;function zt(e,t){return Qe(e,"table")&&Qe(t.nodeType!==11?t:t.firstChild,"tr")&&a(e).children("tbody")[0]||e}function cr(e){return e.type=(e.getAttribute("type")!==null)+"/"+e.type,e}function Zt(e){return(e.type||"").slice(0,5)==="true/"?e.type=e.type.slice(5):e.removeAttribute("type"),e}function kr(e,t){var i,o,u,p,h,x;if(t.nodeType===1){if(X.hasData(e)&&(x=X.get(e).events))for(u in X.remove(t,"handle events"),x)for(i=0,o=x[u].length;i<o;i++)a.event.add(t,u,x[u][i]);Ve.hasData(e)&&(p=Ve.access(e),h=a.extend({},p),Ve.set(t,h))}}function Rr(e,t){var i=t.nodeName.toLowerCase();i==="input"&&Kt.test(e.type)?t.checked=e.checked:i!=="input"&&i!=="textarea"||(t.defaultValue=e.defaultValue)}function Wt(e,t,i,o){t=tt(t);var u,p,h,x,_,q,A=0,P=e.length,S=P-1,E=t[0],W=L(E);if(W||P>1&&typeof E=="string"&&!B.checkClone&&Qr.test(E))return e.each(function(G){var V=e.eq(G);W&&(t[0]=E.call(this,G,V.html())),Wt(V,t,i,o)});if(P&&(p=(u=Ar(t,e[0].ownerDocument,!1,e,o)).firstChild,u.childNodes.length===1&&(u=p),p||o)){for(x=(h=a.map(Ne(u,"script"),cr)).length;A<P;A++)_=u,A!==S&&(_=a.clone(_,!0,!0),x&&a.merge(h,Ne(_,"script"))),i.call(e[A],_,A);if(x)for(q=h[h.length-1].ownerDocument,a.map(h,Zt),A=0;A<x;A++)_=h[A],xr.test(_.type||"")&&!X.access(_,"globalEval")&&a.contains(q,_)&&(_.src&&(_.type||"").toLowerCase()!=="module"?a._evalUrl&&!_.noModule&&a._evalUrl(_.src,{nonce:_.nonce||_.getAttribute("nonce")},q):Pe(_.textContent.replace(Jt,""),_,q))}return e}function ur(e,t,i){for(var o,u=t?a.filter(t,e):e,p=0;(o=u[p])!=null;p++)i||o.nodeType!==1||a.cleanData(Ne(o)),o.parentNode&&(i&&Ft(o)&&Gt(Ne(o,"script")),o.parentNode.removeChild(o));return e}a.extend({htmlPrefilter:function(e){return e},clone:function(e,t,i){var o,u,p,h,x=e.cloneNode(!0),_=Ft(e);if(!(B.noCloneChecked||e.nodeType!==1&&e.nodeType!==11||a.isXMLDoc(e)))for(h=Ne(x),o=0,u=(p=Ne(e)).length;o<u;o++)Rr(p[o],h[o]);if(t)if(i)for(p=p||Ne(e),h=h||Ne(x),o=0,u=p.length;o<u;o++)kr(p[o],h[o]);else kr(e,x);return(h=Ne(x,"script")).length>0&&Gt(h,!_&&Ne(e,"script")),x},cleanData:function(e){for(var t,i,o,u=a.event.special,p=0;(i=e[p])!==void 0;p++)if(ee(i)){if(t=i[X.expando]){if(t.events)for(o in t.events)u[o]?a.event.remove(i,o):a.removeEvent(i,o,t.handle);i[X.expando]=void 0}i[Ve.expando]&&(i[Ve.expando]=void 0)}}}),a.fn.extend({detach:function(e){return ur(this,e,!0)},remove:function(e){return ur(this,e)},text:function(e){return Re(this,function(t){return t===void 0?a.text(this):this.empty().each(function(){this.nodeType!==1&&this.nodeType!==11&&this.nodeType!==9||(this.textContent=t)})},null,e,arguments.length)},append:function(){return Wt(this,arguments,function(e){this.nodeType!==1&&this.nodeType!==11&&this.nodeType!==9||zt(this,e).appendChild(e)})},prepend:function(){return Wt(this,arguments,function(e){if(this.nodeType===1||this.nodeType===11||this.nodeType===9){var t=zt(this,e);t.insertBefore(e,t.firstChild)}})},before:function(){return Wt(this,arguments,function(e){this.parentNode&&this.parentNode.insertBefore(e,this)})},after:function(){return Wt(this,arguments,function(e){this.parentNode&&this.parentNode.insertBefore(e,this.nextSibling)})},empty:function(){for(var e,t=0;(e=this[t])!=null;t++)e.nodeType===1&&(a.cleanData(Ne(e,!1)),e.textContent="");return this},clone:function(e,t){return e=e!=null&&e,t=t??e,this.map(function(){return a.clone(this,e,t)})},html:function(e){return Re(this,function(t){var i=this[0]||{},o=0,u=this.length;if(t===void 0&&i.nodeType===1)return i.innerHTML;if(typeof t=="string"&&!Dr.test(t)&&!je[(vr.exec(t)||["",""])[1].toLowerCase()]){t=a.htmlPrefilter(t);try{for(;o<u;o++)(i=this[o]||{}).nodeType===1&&(a.cleanData(Ne(i,!1)),i.innerHTML=t);i=0}catch{}}i&&this.empty().append(t)},null,e,arguments.length)},replaceWith:function(){var e=[];return Wt(this,arguments,function(t){var i=this.parentNode;a.inArray(this,e)<0&&(a.cleanData(Ne(this)),i&&i.replaceChild(t,this))},e)}}),a.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(e,t){a.fn[e]=function(i){for(var o,u=[],p=a(i),h=p.length-1,x=0;x<=h;x++)o=x===h?this:this.clone(!0),a(p[x])[t](o),We.apply(u,o.get());return this.pushStack(u)}});var dr=new RegExp("^("+Lr+")(?!px)[a-z%]+$","i"),c=function(e){var t=e.ownerDocument.defaultView;return t&&t.opener||(t=N),t.getComputedStyle(e)},d=function(e,t,i){var o,u,p={};for(u in t)p[u]=e.style[u],e.style[u]=t[u];for(u in o=i.call(e),t)e.style[u]=p[u];return o},r=new RegExp(ft.join("|"),"i");function n(e,t,i){var o,u,p,h,x=e.style;return(i=i||c(e))&&((h=i.getPropertyValue(t)||i[t])!==""||Ft(e)||(h=a.style(e,t)),!B.pixelBoxStyles()&&dr.test(h)&&r.test(t)&&(o=x.width,u=x.minWidth,p=x.maxWidth,x.minWidth=x.maxWidth=x.width=h,h=i.width,x.width=o,x.minWidth=u,x.maxWidth=p)),h!==void 0?h+"":h}function l(e,t){return{get:function(){if(!e())return(this.get=t).apply(this,arguments);delete this.get}}}(function(){function e(){if(q){_.style.cssText="position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0",q.style.cssText="position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%",Dt.appendChild(_).appendChild(q);var A=N.getComputedStyle(q);i=A.top!=="1%",x=t(A.marginLeft)===12,q.style.right="60%",p=t(A.right)===36,o=t(A.width)===36,q.style.position="absolute",u=t(q.offsetWidth/3)===12,Dt.removeChild(_),q=null}}function t(A){return Math.round(parseFloat(A))}var i,o,u,p,h,x,_=$.createElement("div"),q=$.createElement("div");q.style&&(q.style.backgroundClip="content-box",q.cloneNode(!0).style.backgroundClip="",B.clearCloneStyle=q.style.backgroundClip==="content-box",a.extend(B,{boxSizingReliable:function(){return e(),o},pixelBoxStyles:function(){return e(),p},pixelPosition:function(){return e(),i},reliableMarginLeft:function(){return e(),x},scrollboxSize:function(){return e(),u},reliableTrDimensions:function(){var A,P,S,E;return h==null&&(A=$.createElement("table"),P=$.createElement("tr"),S=$.createElement("div"),A.style.cssText="position:absolute;left:-11111px;border-collapse:separate",P.style.cssText="border:1px solid",P.style.height="1px",S.style.height="9px",S.style.display="block",Dt.appendChild(A).appendChild(P).appendChild(S),E=N.getComputedStyle(P),h=parseInt(E.height,10)+parseInt(E.borderTopWidth,10)+parseInt(E.borderBottomWidth,10)===P.offsetHeight,Dt.removeChild(A)),h}}))})();var y=["Webkit","Moz","ms"],v=$.createElement("div").style,k={};function w(e){return a.cssProps[e]||k[e]||(e in v?e:k[e]=function(t){for(var i=t[0].toUpperCase()+t.slice(1),o=y.length;o--;)if((t=y[o]+i)in v)return t}(e)||e)}var O=/^(none|table(?!-c[ea]).+)/,I=/^--/,U={position:"absolute",visibility:"hidden",display:"block"},Y={letterSpacing:"0",fontWeight:"400"};function ue(e,t,i){var o=jt.exec(t);return o?Math.max(0,o[2]-(i||0))+(o[3]||"px"):t}function z(e,t,i,o,u,p){var h=t==="width"?1:0,x=0,_=0;if(i===(o?"border":"content"))return 0;for(;h<4;h+=2)i==="margin"&&(_+=a.css(e,i+ft[h],!0,u)),o?(i==="content"&&(_-=a.css(e,"padding"+ft[h],!0,u)),i!=="margin"&&(_-=a.css(e,"border"+ft[h]+"Width",!0,u))):(_+=a.css(e,"padding"+ft[h],!0,u),i!=="padding"?_+=a.css(e,"border"+ft[h]+"Width",!0,u):x+=a.css(e,"border"+ft[h]+"Width",!0,u));return!o&&p>=0&&(_+=Math.max(0,Math.ceil(e["offset"+t[0].toUpperCase()+t.slice(1)]-p-_-x-.5))||0),_}function fe(e,t,i){var o=c(e),u=(!B.boxSizingReliable()||i)&&a.css(e,"boxSizing",!1,o)==="border-box",p=u,h=n(e,t,o),x="offset"+t[0].toUpperCase()+t.slice(1);if(dr.test(h)){if(!i)return h;h="auto"}return(!B.boxSizingReliable()&&u||!B.reliableTrDimensions()&&Qe(e,"tr")||h==="auto"||!parseFloat(h)&&a.css(e,"display",!1,o)==="inline")&&e.getClientRects().length&&(u=a.css(e,"boxSizing",!1,o)==="border-box",(p=x in e)&&(h=e[x])),(h=parseFloat(h)||0)+z(e,t,i||(u?"border":"content"),p,o,h)+"px"}function ie(e,t,i,o,u){return new ie.prototype.init(e,t,i,o,u)}a.extend({cssHooks:{opacity:{get:function(e,t){if(t){var i=n(e,"opacity");return i===""?"1":i}}}},cssNumber:{animationIterationCount:!0,columnCount:!0,fillOpacity:!0,flexGrow:!0,flexShrink:!0,fontWeight:!0,gridArea:!0,gridColumn:!0,gridColumnEnd:!0,gridColumnStart:!0,gridRow:!0,gridRowEnd:!0,gridRowStart:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{},style:function(e,t,i,o){if(e&&e.nodeType!==3&&e.nodeType!==8&&e.style){var u,p,h,x=j(t),_=I.test(t),q=e.style;if(_||(t=w(x)),h=a.cssHooks[t]||a.cssHooks[x],i===void 0)return h&&"get"in h&&(u=h.get(e,!1,o))!==void 0?u:q[t];(p=typeof i)=="string"&&(u=jt.exec(i))&&u[1]&&(i=St(e,t,u),p="number"),i!=null&&i==i&&(p!=="number"||_||(i+=u&&u[3]||(a.cssNumber[x]?"":"px")),B.clearCloneStyle||i!==""||t.indexOf("background")!==0||(q[t]="inherit"),h&&"set"in h&&(i=h.set(e,i,o))===void 0||(_?q.setProperty(t,i):q[t]=i))}},css:function(e,t,i,o){var u,p,h,x=j(t);return I.test(t)||(t=w(x)),(h=a.cssHooks[t]||a.cssHooks[x])&&"get"in h&&(u=h.get(e,!0,i)),u===void 0&&(u=n(e,t,o)),u==="normal"&&t in Y&&(u=Y[t]),i===""||i?(p=parseFloat(u),i===!0||isFinite(p)?p||0:u):u}}),a.each(["height","width"],function(e,t){a.cssHooks[t]={get:function(i,o,u){if(o)return!O.test(a.css(i,"display"))||i.getClientRects().length&&i.getBoundingClientRect().width?fe(i,t,u):d(i,U,function(){return fe(i,t,u)})},set:function(i,o,u){var p,h=c(i),x=!B.scrollboxSize()&&h.position==="absolute",_=(x||u)&&a.css(i,"boxSizing",!1,h)==="border-box",q=u?z(i,t,u,_,h):0;return _&&x&&(q-=Math.ceil(i["offset"+t[0].toUpperCase()+t.slice(1)]-parseFloat(h[t])-z(i,t,"border",!1,h)-.5)),q&&(p=jt.exec(o))&&(p[3]||"px")!=="px"&&(i.style[t]=o,o=a.css(i,t)),ue(0,o,q)}}}),a.cssHooks.marginLeft=l(B.reliableMarginLeft,function(e,t){if(t)return(parseFloat(n(e,"marginLeft"))||e.getBoundingClientRect().left-d(e,{marginLeft:0},function(){return e.getBoundingClientRect().left}))+"px"}),a.each({margin:"",padding:"",border:"Width"},function(e,t){a.cssHooks[e+t]={expand:function(i){for(var o=0,u={},p=typeof i=="string"?i.split(" "):[i];o<4;o++)u[e+ft[o]+t]=p[o]||p[o-2]||p[0];return u}},e!=="margin"&&(a.cssHooks[e+t].set=ue)}),a.fn.extend({css:function(e,t){return Re(this,function(i,o,u){var p,h,x={},_=0;if(Array.isArray(o)){for(p=c(i),h=o.length;_<h;_++)x[o[_]]=a.css(i,o[_],!1,p);return x}return u!==void 0?a.style(i,o,u):a.css(i,o)},e,t,arguments.length>1)}}),a.Tween=ie,ie.prototype={constructor:ie,init:function(e,t,i,o,u,p){this.elem=e,this.prop=i,this.easing=u||a.easing._default,this.options=t,this.start=this.now=this.cur(),this.end=o,this.unit=p||(a.cssNumber[i]?"":"px")},cur:function(){var e=ie.propHooks[this.prop];return e&&e.get?e.get(this):ie.propHooks._default.get(this)},run:function(e){var t,i=ie.propHooks[this.prop];return this.options.duration?this.pos=t=a.easing[this.easing](e,this.options.duration*e,0,1,this.options.duration):this.pos=t=e,this.now=(this.end-this.start)*t+this.start,this.options.step&&this.options.step.call(this.elem,this.now,this),i&&i.set?i.set(this):ie.propHooks._default.set(this),this}},ie.prototype.init.prototype=ie.prototype,ie.propHooks={_default:{get:function(e){var t;return e.elem.nodeType!==1||e.elem[e.prop]!=null&&e.elem.style[e.prop]==null?e.elem[e.prop]:(t=a.css(e.elem,e.prop,""))&&t!=="auto"?t:0},set:function(e){a.fx.step[e.prop]?a.fx.step[e.prop](e):e.elem.nodeType!==1||!a.cssHooks[e.prop]&&e.elem.style[w(e.prop)]==null?e.elem[e.prop]=e.now:a.style(e.elem,e.prop,e.now+e.unit)}}},ie.propHooks.scrollTop=ie.propHooks.scrollLeft={set:function(e){e.elem.nodeType&&e.elem.parentNode&&(e.elem[e.prop]=e.now)}},a.easing={linear:function(e){return e},swing:function(e){return .5-Math.cos(e*Math.PI)/2},_default:"swing"},a.fx=ie.prototype.init,a.fx.step={};var Te,Ke,Yr=/^(?:toggle|show|hide)$/,pr=/queueHooks$/;function Yt(){Ke&&($.hidden===!1&&N.requestAnimationFrame?N.requestAnimationFrame(Yt):N.setTimeout(Yt,a.fx.interval),a.fx.tick())}function dn(){return N.setTimeout(function(){Te=void 0}),Te=Date.now()}function Mr(e,t){var i,o=0,u={height:e};for(t=t?1:0;o<4;o+=2-t)u["margin"+(i=ft[o])]=u["padding"+i]=e;return t&&(u.opacity=u.width=e),u}function pn(e,t,i){for(var o,u=(Et.tweeners[t]||[]).concat(Et.tweeners["*"]),p=0,h=u.length;p<h;p++)if(o=u[p].call(i,t,e))return o}function Et(e,t,i){var o,u,p=0,h=Et.prefilters.length,x=a.Deferred().always(function(){delete _.elem}),_=function(){if(u)return!1;for(var P=Te||dn(),S=Math.max(0,q.startTime+q.duration-P),E=1-(S/q.duration||0),W=0,G=q.tweens.length;W<G;W++)q.tweens[W].run(E);return x.notifyWith(e,[q,E,S]),E<1&&G?S:(G||x.notifyWith(e,[q,1,0]),x.resolveWith(e,[q]),!1)},q=x.promise({elem:e,props:a.extend({},t),opts:a.extend(!0,{specialEasing:{},easing:a.easing._default},i),originalProperties:t,originalOptions:i,startTime:Te||dn(),duration:i.duration,tweens:[],createTween:function(P,S){var E=a.Tween(e,q.opts,P,S,q.opts.specialEasing[P]||q.opts.easing);return q.tweens.push(E),E},stop:function(P){var S=0,E=P?q.tweens.length:0;if(u)return this;for(u=!0;S<E;S++)q.tweens[S].run(1);return P?(x.notifyWith(e,[q,1,0]),x.resolveWith(e,[q,P])):x.rejectWith(e,[q,P]),this}}),A=q.props;for(function(P,S){var E,W,G,V,Ee;for(E in P)if(G=S[W=j(E)],V=P[E],Array.isArray(V)&&(G=V[1],V=P[E]=V[0]),E!==W&&(P[W]=V,delete P[E]),(Ee=a.cssHooks[W])&&"expand"in Ee)for(E in V=Ee.expand(V),delete P[W],V)E in P||(P[E]=V[E],S[E]=G);else S[W]=G}(A,q.opts.specialEasing);p<h;p++)if(o=Et.prefilters[p].call(q,e,A,q.opts))return L(o.stop)&&(a._queueHooks(q.elem,q.opts.queue).stop=o.stop.bind(o)),o;return a.map(A,pn,q),L(q.opts.start)&&q.opts.start.call(e,q),q.progress(q.opts.progress).done(q.opts.done,q.opts.complete).fail(q.opts.fail).always(q.opts.always),a.fx.timer(a.extend(_,{elem:e,anim:q,queue:q.opts.queue})),q}a.Animation=a.extend(Et,{tweeners:{"*":[function(e,t){var i=this.createTween(e,t);return St(i.elem,e,jt.exec(t),i),i}]},tweener:function(e,t){L(e)?(t=e,e=["*"]):e=e.match(mt);for(var i,o=0,u=e.length;o<u;o++)i=e[o],Et.tweeners[i]=Et.tweeners[i]||[],Et.tweeners[i].unshift(t)},prefilters:[function(e,t,i){var o,u,p,h,x,_,q,A,P="width"in t||"height"in t,S=this,E={},W=e.style,G=e.nodeType&&it(e),V=X.get(e,"fxshow");for(o in i.queue||((h=a._queueHooks(e,"fx")).unqueued==null&&(h.unqueued=0,x=h.empty.fire,h.empty.fire=function(){h.unqueued||x()}),h.unqueued++,S.always(function(){S.always(function(){h.unqueued--,a.queue(e,"fx").length||h.empty.fire()})})),t)if(u=t[o],Yr.test(u)){if(delete t[o],p=p||u==="toggle",u===(G?"hide":"show")){if(u!=="show"||!V||V[o]===void 0)continue;G=!0}E[o]=V&&V[o]||a.style(e,o)}if((_=!a.isEmptyObject(t))||!a.isEmptyObject(E))for(o in P&&e.nodeType===1&&(i.overflow=[W.overflow,W.overflowX,W.overflowY],(q=V&&V.display)==null&&(q=X.get(e,"display")),(A=a.css(e,"display"))==="none"&&(q?A=q:(Xt([e],!0),q=e.style.display||q,A=a.css(e,"display"),Xt([e]))),(A==="inline"||A==="inline-block"&&q!=null)&&a.css(e,"float")==="none"&&(_||(S.done(function(){W.display=q}),q==null&&(A=W.display,q=A==="none"?"":A)),W.display="inline-block")),i.overflow&&(W.overflow="hidden",S.always(function(){W.overflow=i.overflow[0],W.overflowX=i.overflow[1],W.overflowY=i.overflow[2]})),_=!1,E)_||(V?"hidden"in V&&(G=V.hidden):V=X.access(e,"fxshow",{display:q}),p&&(V.hidden=!G),G&&Xt([e],!0),S.done(function(){for(o in G||Xt([e]),X.remove(e,"fxshow"),E)a.style(e,o,E[o])})),_=pn(G?V[o]:0,o,S),o in V||(V[o]=_.start,G&&(_.end=_.start,_.start=0))}],prefilter:function(e,t){t?Et.prefilters.unshift(e):Et.prefilters.push(e)}}),a.speed=function(e,t,i){var o=e&&typeof e=="object"?a.extend({},e):{complete:i||!i&&t||L(e)&&e,duration:e,easing:i&&t||t&&!L(t)&&t};return a.fx.off?o.duration=0:typeof o.duration!="number"&&(o.duration in a.fx.speeds?o.duration=a.fx.speeds[o.duration]:o.duration=a.fx.speeds._default),o.queue!=null&&o.queue!==!0||(o.queue="fx"),o.old=o.complete,o.complete=function(){L(o.old)&&o.old.call(this),o.queue&&a.dequeue(this,o.queue)},o},a.fn.extend({fadeTo:function(e,t,i,o){return this.filter(it).css("opacity",0).show().end().animate({opacity:t},e,i,o)},animate:function(e,t,i,o){var u=a.isEmptyObject(e),p=a.speed(t,i,o),h=function(){var x=Et(this,a.extend({},e),p);(u||X.get(this,"finish"))&&x.stop(!0)};return h.finish=h,u||p.queue===!1?this.each(h):this.queue(p.queue,h)},stop:function(e,t,i){var o=function(u){var p=u.stop;delete u.stop,p(i)};return typeof e!="string"&&(i=t,t=e,e=void 0),t&&this.queue(e||"fx",[]),this.each(function(){var u=!0,p=e!=null&&e+"queueHooks",h=a.timers,x=X.get(this);if(p)x[p]&&x[p].stop&&o(x[p]);else for(p in x)x[p]&&x[p].stop&&pr.test(p)&&o(x[p]);for(p=h.length;p--;)h[p].elem!==this||e!=null&&h[p].queue!==e||(h[p].anim.stop(i),u=!1,h.splice(p,1));!u&&i||a.dequeue(this,e)})},finish:function(e){return e!==!1&&(e=e||"fx"),this.each(function(){var t,i=X.get(this),o=i[e+"queue"],u=i[e+"queueHooks"],p=a.timers,h=o?o.length:0;for(i.finish=!0,a.queue(this,e,[]),u&&u.stop&&u.stop.call(this,!0),t=p.length;t--;)p[t].elem===this&&p[t].queue===e&&(p[t].anim.stop(!0),p.splice(t,1));for(t=0;t<h;t++)o[t]&&o[t].finish&&o[t].finish.call(this);delete i.finish})}}),a.each(["toggle","show","hide"],function(e,t){var i=a.fn[t];a.fn[t]=function(o,u,p){return o==null||typeof o=="boolean"?i.apply(this,arguments):this.animate(Mr(t,!0),o,u,p)}}),a.each({slideDown:Mr("show"),slideUp:Mr("hide"),slideToggle:Mr("toggle"),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(e,t){a.fn[e]=function(i,o,u){return this.animate(t,i,o,u)}}),a.timers=[],a.fx.tick=function(){var e,t=0,i=a.timers;for(Te=Date.now();t<i.length;t++)(e=i[t])()||i[t]!==e||i.splice(t--,1);i.length||a.fx.stop(),Te=void 0},a.fx.timer=function(e){a.timers.push(e),a.fx.start()},a.fx.interval=13,a.fx.start=function(){Ke||(Ke=!0,Yt())},a.fx.stop=function(){Ke=null},a.fx.speeds={slow:600,fast:200,_default:400},a.fn.delay=function(e,t){return e=a.fx&&a.fx.speeds[e]||e,t=t||"fx",this.queue(t,function(i,o){var u=N.setTimeout(i,e);o.stop=function(){N.clearTimeout(u)}})},function(){var e=$.createElement("input"),t=$.createElement("select").appendChild($.createElement("option"));e.type="checkbox",B.checkOn=e.value!=="",B.optSelected=t.selected,(e=$.createElement("input")).value="t",e.type="radio",B.radioValue=e.value==="t"}();var hn,_r=a.expr.attrHandle;a.fn.extend({attr:function(e,t){return Re(this,a.attr,e,t,arguments.length>1)},removeAttr:function(e){return this.each(function(){a.removeAttr(this,e)})}}),a.extend({attr:function(e,t,i){var o,u,p=e.nodeType;if(p!==3&&p!==8&&p!==2)return e.getAttribute===void 0?a.prop(e,t,i):(p===1&&a.isXMLDoc(e)||(u=a.attrHooks[t.toLowerCase()]||(a.expr.match.bool.test(t)?hn:void 0)),i!==void 0?i===null?void a.removeAttr(e,t):u&&"set"in u&&(o=u.set(e,i,t))!==void 0?o:(e.setAttribute(t,i+""),i):u&&"get"in u&&(o=u.get(e,t))!==null?o:(o=a.find.attr(e,t))==null?void 0:o)},attrHooks:{type:{set:function(e,t){if(!B.radioValue&&t==="radio"&&Qe(e,"input")){var i=e.value;return e.setAttribute("type",t),i&&(e.value=i),t}}}},removeAttr:function(e,t){var i,o=0,u=t&&t.match(mt);if(u&&e.nodeType===1)for(;i=u[o++];)e.removeAttribute(i)}}),hn={set:function(e,t,i){return t===!1?a.removeAttr(e,i):e.setAttribute(i,i),i}},a.each(a.expr.match.bool.source.match(/\w+/g),function(e,t){var i=_r[t]||a.find.attr;_r[t]=function(o,u,p){var h,x,_=u.toLowerCase();return p||(x=_r[_],_r[_]=h,h=i(o,u,p)!=null?_:null,_r[_]=x),h}});var An=/^(?:input|select|textarea|button)$/i,Pn=/^(?:a|area)$/i;function er(e){return(e.match(mt)||[]).join(" ")}function tr(e){return e.getAttribute&&e.getAttribute("class")||""}function Kr(e){return Array.isArray(e)?e:typeof e=="string"&&e.match(mt)||[]}a.fn.extend({prop:function(e,t){return Re(this,a.prop,e,t,arguments.length>1)},removeProp:function(e){return this.each(function(){delete this[a.propFix[e]||e]})}}),a.extend({prop:function(e,t,i){var o,u,p=e.nodeType;if(p!==3&&p!==8&&p!==2)return p===1&&a.isXMLDoc(e)||(t=a.propFix[t]||t,u=a.propHooks[t]),i!==void 0?u&&"set"in u&&(o=u.set(e,i,t))!==void 0?o:e[t]=i:u&&"get"in u&&(o=u.get(e,t))!==null?o:e[t]},propHooks:{tabIndex:{get:function(e){var t=a.find.attr(e,"tabindex");return t?parseInt(t,10):An.test(e.nodeName)||Pn.test(e.nodeName)&&e.href?0:-1}}},propFix:{for:"htmlFor",class:"className"}}),B.optSelected||(a.propHooks.selected={get:function(e){var t=e.parentNode;return t&&t.parentNode&&t.parentNode.selectedIndex,null},set:function(e){var t=e.parentNode;t&&(t.selectedIndex,t.parentNode&&t.parentNode.selectedIndex)}}),a.each(["tabIndex","readOnly","maxLength","cellSpacing","cellPadding","rowSpan","colSpan","useMap","frameBorder","contentEditable"],function(){a.propFix[this.toLowerCase()]=this}),a.fn.extend({addClass:function(e){var t,i,o,u,p,h,x,_=0;if(L(e))return this.each(function(q){a(this).addClass(e.call(this,q,tr(this)))});if((t=Kr(e)).length){for(;i=this[_++];)if(u=tr(i),o=i.nodeType===1&&" "+er(u)+" "){for(h=0;p=t[h++];)o.indexOf(" "+p+" ")<0&&(o+=p+" ");u!==(x=er(o))&&i.setAttribute("class",x)}}return this},removeClass:function(e){var t,i,o,u,p,h,x,_=0;if(L(e))return this.each(function(q){a(this).removeClass(e.call(this,q,tr(this)))});if(!arguments.length)return this.attr("class","");if((t=Kr(e)).length){for(;i=this[_++];)if(u=tr(i),o=i.nodeType===1&&" "+er(u)+" "){for(h=0;p=t[h++];)for(;o.indexOf(" "+p+" ")>-1;)o=o.replace(" "+p+" "," ");u!==(x=er(o))&&i.setAttribute("class",x)}}return this},toggleClass:function(e,t){var i=typeof e,o=i==="string"||Array.isArray(e);return typeof t=="boolean"&&o?t?this.addClass(e):this.removeClass(e):L(e)?this.each(function(u){a(this).toggleClass(e.call(this,u,tr(this),t),t)}):this.each(function(){var u,p,h,x;if(o)for(p=0,h=a(this),x=Kr(e);u=x[p++];)h.hasClass(u)?h.removeClass(u):h.addClass(u);else e!==void 0&&i!=="boolean"||((u=tr(this))&&X.set(this,"__className__",u),this.setAttribute&&this.setAttribute("class",u||e===!1?"":X.get(this,"__className__")||""))})},hasClass:function(e){var t,i,o=0;for(t=" "+e+" ";i=this[o++];)if(i.nodeType===1&&(" "+er(tr(i))+" ").indexOf(t)>-1)return!0;return!1}});var Dn=/\r/g;a.fn.extend({val:function(e){var t,i,o,u=this[0];return arguments.length?(o=L(e),this.each(function(p){var h;this.nodeType===1&&((h=o?e.call(this,p,a(this).val()):e)==null?h="":typeof h=="number"?h+="":Array.isArray(h)&&(h=a.map(h,function(x){return x==null?"":x+""})),(t=a.valHooks[this.type]||a.valHooks[this.nodeName.toLowerCase()])&&"set"in t&&t.set(this,h,"value")!==void 0||(this.value=h))})):u?(t=a.valHooks[u.type]||a.valHooks[u.nodeName.toLowerCase()])&&"get"in t&&(i=t.get(u,"value"))!==void 0?i:typeof(i=u.value)=="string"?i.replace(Dn,""):i??"":void 0}}),a.extend({valHooks:{option:{get:function(e){var t=a.find.attr(e,"value");return t??er(a.text(e))}},select:{get:function(e){var t,i,o,u=e.options,p=e.selectedIndex,h=e.type==="select-one",x=h?null:[],_=h?p+1:u.length;for(o=p<0?_:h?p:0;o<_;o++)if(((i=u[o]).selected||o===p)&&!i.disabled&&(!i.parentNode.disabled||!Qe(i.parentNode,"optgroup"))){if(t=a(i).val(),h)return t;x.push(t)}return x},set:function(e,t){for(var i,o,u=e.options,p=a.makeArray(t),h=u.length;h--;)((o=u[h]).selected=a.inArray(a.valHooks.option.get(o),p)>-1)&&(i=!0);return i||(e.selectedIndex=-1),p}}}}),a.each(["radio","checkbox"],function(){a.valHooks[this]={set:function(e,t){if(Array.isArray(t))return e.checked=a.inArray(a(e).val(),t)>-1}},B.checkOn||(a.valHooks[this].get=function(e){return e.getAttribute("value")===null?"on":e.value})}),B.focusin="onfocusin"in N;var mn=/^(?:focusinfocus|focusoutblur)$/,fn=function(e){e.stopPropagation()};a.extend(a.event,{trigger:function(e,t,i,o){var u,p,h,x,_,q,A,P,S=[i||$],E=Je.call(e,"type")?e.type:e,W=Je.call(e,"namespace")?e.namespace.split("."):[];if(p=P=h=i=i||$,i.nodeType!==3&&i.nodeType!==8&&!mn.test(E+a.event.triggered)&&(E.indexOf(".")>-1&&(W=E.split("."),E=W.shift(),W.sort()),_=E.indexOf(":")<0&&"on"+E,(e=e[a.expando]?e:new a.Event(E,typeof e=="object"&&e)).isTrigger=o?2:3,e.namespace=W.join("."),e.rnamespace=e.namespace?new RegExp("(^|\\.)"+W.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,e.result=void 0,e.target||(e.target=i),t=t==null?[e]:a.makeArray(t,[e]),A=a.event.special[E]||{},o||!A.trigger||A.trigger.apply(i,t)!==!1)){if(!o&&!A.noBubble&&!f(i)){for(x=A.delegateType||E,mn.test(x+E)||(p=p.parentNode);p;p=p.parentNode)S.push(p),h=p;h===(i.ownerDocument||$)&&S.push(h.defaultView||h.parentWindow||N)}for(u=0;(p=S[u++])&&!e.isPropagationStopped();)P=p,e.type=u>1?x:A.bindType||E,(q=(X.get(p,"events")||Object.create(null))[e.type]&&X.get(p,"handle"))&&q.apply(p,t),(q=_&&p[_])&&q.apply&&ee(p)&&(e.result=q.apply(p,t),e.result===!1&&e.preventDefault());return e.type=E,o||e.isDefaultPrevented()||A._default&&A._default.apply(S.pop(),t)!==!1||!ee(i)||_&&L(i[E])&&!f(i)&&((h=i[_])&&(i[_]=null),a.event.triggered=E,e.isPropagationStopped()&&P.addEventListener(E,fn),i[E](),e.isPropagationStopped()&&P.removeEventListener(E,fn),a.event.triggered=void 0,h&&(i[_]=h)),e.result}},simulate:function(e,t,i){var o=a.extend(new a.Event,i,{type:e,isSimulated:!0});a.event.trigger(o,null,t)}}),a.fn.extend({trigger:function(e,t){return this.each(function(){a.event.trigger(e,t,this)})},triggerHandler:function(e,t){var i=this[0];if(i)return a.event.trigger(e,t,i,!0)}}),B.focusin||a.each({focus:"focusin",blur:"focusout"},function(e,t){var i=function(o){a.event.simulate(t,o.target,a.event.fix(o))};a.event.special[t]={setup:function(){var o=this.ownerDocument||this.document||this,u=X.access(o,t);u||o.addEventListener(e,i,!0),X.access(o,t,(u||0)+1)},teardown:function(){var o=this.ownerDocument||this.document||this,u=X.access(o,t)-1;u?X.access(o,t,u):(o.removeEventListener(e,i,!0),X.remove(o,t))}}});var Cr=N.location,yn={guid:Date.now()},Gr=/\?/;a.parseXML=function(e){var t,i;if(!e||typeof e!="string")return null;try{t=new N.DOMParser().parseFromString(e,"text/xml")}catch{}return i=t&&t.getElementsByTagName("parsererror")[0],t&&!i||a.error("Invalid XML: "+(i?a.map(i.childNodes,function(o){return o.textContent}).join(`
`):e)),t};var Qn=/\[\]$/,gn=/\r?\n/g,Rn=/^(?:submit|button|image|reset|file)$/i,Mn=/^(?:input|select|textarea|keygen)/i;function Jr(e,t,i,o){var u;if(Array.isArray(t))a.each(t,function(p,h){i||Qn.test(e)?o(e,h):Jr(e+"["+(typeof h=="object"&&h!=null?p:"")+"]",h,i,o)});else if(i||be(t)!=="object")o(e,t);else for(u in t)Jr(e+"["+u+"]",t[u],i,o)}a.param=function(e,t){var i,o=[],u=function(p,h){var x=L(h)?h():h;o[o.length]=encodeURIComponent(p)+"="+encodeURIComponent(x??"")};if(e==null)return"";if(Array.isArray(e)||e.jquery&&!a.isPlainObject(e))a.each(e,function(){u(this.name,this.value)});else for(i in e)Jr(i,e[i],t,u);return o.join("&")},a.fn.extend({serialize:function(){return a.param(this.serializeArray())},serializeArray:function(){return this.map(function(){var e=a.prop(this,"elements");return e?a.makeArray(e):this}).filter(function(){var e=this.type;return this.name&&!a(this).is(":disabled")&&Mn.test(this.nodeName)&&!Rn.test(e)&&(this.checked||!Kt.test(e))}).map(function(e,t){var i=a(this).val();return i==null?null:Array.isArray(i)?a.map(i,function(o){return{name:t.name,value:o.replace(gn,`\r
`)}}):{name:t.name,value:i.replace(gn,`\r
`)}}).get()}});var In=/%20/g,Nn=/#.*$/,Fn=/([?&])_=[^&]*/,Bn=/^(.*?):[ \t]*([^\r\n]*)$/gm,Hn=/^(?:GET|HEAD)$/,zn=/^\/\//,bn={},Zr={},vn="*/".concat("*"),en=$.createElement("a");function xn(e){return function(t,i){typeof t!="string"&&(i=t,t="*");var o,u=0,p=t.toLowerCase().match(mt)||[];if(L(i))for(;o=p[u++];)o[0]==="+"?(o=o.slice(1)||"*",(e[o]=e[o]||[]).unshift(i)):(e[o]=e[o]||[]).push(i)}}function wn(e,t,i,o){var u={},p=e===Zr;function h(x){var _;return u[x]=!0,a.each(e[x]||[],function(q,A){var P=A(t,i,o);return typeof P!="string"||p||u[P]?p?!(_=P):void 0:(t.dataTypes.unshift(P),h(P),!1)}),_}return h(t.dataTypes[0])||!u["*"]&&h("*")}function tn(e,t){var i,o,u=a.ajaxSettings.flatOptions||{};for(i in t)t[i]!==void 0&&((u[i]?e:o||(o={}))[i]=t[i]);return o&&a.extend(!0,e,o),e}en.href=Cr.href,a.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:Cr.href,type:"GET",isLocal:/^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(Cr.protocol),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",accepts:{"*":vn,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",json:"application/json, text/javascript"},contents:{xml:/\bxml\b/,html:/\bhtml/,json:/\bjson\b/},responseFields:{xml:"responseXML",text:"responseText",json:"responseJSON"},converters:{"* text":String,"text html":!0,"text json":JSON.parse,"text xml":a.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(e,t){return t?tn(tn(e,a.ajaxSettings),t):tn(a.ajaxSettings,e)},ajaxPrefilter:xn(bn),ajaxTransport:xn(Zr),ajax:function(e,t){typeof e=="object"&&(t=e,e=void 0),t=t||{};var i,o,u,p,h,x,_,q,A,P,S=a.ajaxSetup({},t),E=S.context||S,W=S.context&&(E.nodeType||E.jquery)?a(E):a.event,G=a.Deferred(),V=a.Callbacks("once memory"),Ee=S.statusCode||{},Ue={},gt={},ke="canceled",ne={readyState:0,getResponseHeader:function(ye){var Le;if(_){if(!p)for(p={};Le=Bn.exec(u);)p[Le[1].toLowerCase()+" "]=(p[Le[1].toLowerCase()+" "]||[]).concat(Le[2]);Le=p[ye.toLowerCase()+" "]}return Le==null?null:Le.join(", ")},getAllResponseHeaders:function(){return _?u:null},setRequestHeader:function(ye,Le){return _==null&&(ye=gt[ye.toLowerCase()]=gt[ye.toLowerCase()]||ye,Ue[ye]=Le),this},overrideMimeType:function(ye){return _==null&&(S.mimeType=ye),this},statusCode:function(ye){var Le;if(ye)if(_)ne.always(ye[ne.status]);else for(Le in ye)Ee[Le]=[Ee[Le],ye[Le]];return this},abort:function(ye){var Le=ye||ke;return i&&i.abort(Le),ut(0,Le),this}};if(G.promise(ne),S.url=((e||S.url||Cr.href)+"").replace(zn,Cr.protocol+"//"),S.type=t.method||t.type||S.method||S.type,S.dataTypes=(S.dataType||"*").toLowerCase().match(mt)||[""],S.crossDomain==null){x=$.createElement("a");try{x.href=S.url,x.href=x.href,S.crossDomain=en.protocol+"//"+en.host!=x.protocol+"//"+x.host}catch{S.crossDomain=!0}}if(S.data&&S.processData&&typeof S.data!="string"&&(S.data=a.param(S.data,S.traditional)),wn(bn,S,t,ne),_)return ne;for(A in(q=a.event&&S.global)&&a.active++==0&&a.event.trigger("ajaxStart"),S.type=S.type.toUpperCase(),S.hasContent=!Hn.test(S.type),o=S.url.replace(Nn,""),S.hasContent?S.data&&S.processData&&(S.contentType||"").indexOf("application/x-www-form-urlencoded")===0&&(S.data=S.data.replace(In,"+")):(P=S.url.slice(o.length),S.data&&(S.processData||typeof S.data=="string")&&(o+=(Gr.test(o)?"&":"?")+S.data,delete S.data),S.cache===!1&&(o=o.replace(Fn,"$1"),P=(Gr.test(o)?"&":"?")+"_="+yn.guid+++P),S.url=o+P),S.ifModified&&(a.lastModified[o]&&ne.setRequestHeader("If-Modified-Since",a.lastModified[o]),a.etag[o]&&ne.setRequestHeader("If-None-Match",a.etag[o])),(S.data&&S.hasContent&&S.contentType!==!1||t.contentType)&&ne.setRequestHeader("Content-Type",S.contentType),ne.setRequestHeader("Accept",S.dataTypes[0]&&S.accepts[S.dataTypes[0]]?S.accepts[S.dataTypes[0]]+(S.dataTypes[0]!=="*"?", "+vn+"; q=0.01":""):S.accepts["*"]),S.headers)ne.setRequestHeader(A,S.headers[A]);if(S.beforeSend&&(S.beforeSend.call(E,ne,S)===!1||_))return ne.abort();if(ke="abort",V.add(S.complete),ne.done(S.success),ne.fail(S.error),i=wn(Zr,S,t,ne)){if(ne.readyState=1,q&&W.trigger("ajaxSend",[ne,S]),_)return ne;S.async&&S.timeout>0&&(h=N.setTimeout(function(){ne.abort("timeout")},S.timeout));try{_=!1,i.send(Ue,ut)}catch(ye){if(_)throw ye;ut(-1,ye)}}else ut(-1,"No Transport");function ut(ye,Le,qr,Ir){var bt,rr,hr,dt,mr,Ct=Le;_||(_=!0,h&&N.clearTimeout(h),i=void 0,u=Ir||"",ne.readyState=ye>0?4:0,bt=ye>=200&&ye<300||ye===304,qr&&(dt=function(Oe,vt,xt){for(var Qt,Fe,ve,$e,wt=Oe.contents,Be=Oe.dataTypes;Be[0]==="*";)Be.shift(),Qt===void 0&&(Qt=Oe.mimeType||vt.getResponseHeader("Content-Type"));if(Qt){for(Fe in wt)if(wt[Fe]&&wt[Fe].test(Qt)){Be.unshift(Fe);break}}if(Be[0]in xt)ve=Be[0];else{for(Fe in xt){if(!Be[0]||Oe.converters[Fe+" "+Be[0]]){ve=Fe;break}$e||($e=Fe)}ve=ve||$e}if(ve)return ve!==Be[0]&&Be.unshift(ve),xt[ve]}(S,ne,qr)),!bt&&a.inArray("script",S.dataTypes)>-1&&a.inArray("json",S.dataTypes)<0&&(S.converters["text script"]=function(){}),dt=function(Oe,vt,xt,Qt){var Fe,ve,$e,wt,Be,kt={},fr=Oe.dataTypes.slice();if(fr[1])for($e in Oe.converters)kt[$e.toLowerCase()]=Oe.converters[$e];for(ve=fr.shift();ve;)if(Oe.responseFields[ve]&&(xt[Oe.responseFields[ve]]=vt),!Be&&Qt&&Oe.dataFilter&&(vt=Oe.dataFilter(vt,Oe.dataType)),Be=ve,ve=fr.shift()){if(ve==="*")ve=Be;else if(Be!=="*"&&Be!==ve){if(!($e=kt[Be+" "+ve]||kt["* "+ve])){for(Fe in kt)if((wt=Fe.split(" "))[1]===ve&&($e=kt[Be+" "+wt[0]]||kt["* "+wt[0]])){$e===!0?$e=kt[Fe]:kt[Fe]!==!0&&(ve=wt[0],fr.unshift(wt[1]));break}}if($e!==!0)if($e&&Oe.throws)vt=$e(vt);else try{vt=$e(vt)}catch(Nr){return{state:"parsererror",error:$e?Nr:"No conversion from "+Be+" to "+ve}}}}return{state:"success",data:vt}}(S,dt,ne,bt),bt?(S.ifModified&&((mr=ne.getResponseHeader("Last-Modified"))&&(a.lastModified[o]=mr),(mr=ne.getResponseHeader("etag"))&&(a.etag[o]=mr)),ye===204||S.type==="HEAD"?Ct="nocontent":ye===304?Ct="notmodified":(Ct=dt.state,rr=dt.data,bt=!(hr=dt.error))):(hr=Ct,!ye&&Ct||(Ct="error",ye<0&&(ye=0))),ne.status=ye,ne.statusText=(Le||Ct)+"",bt?G.resolveWith(E,[rr,Ct,ne]):G.rejectWith(E,[ne,Ct,hr]),ne.statusCode(Ee),Ee=void 0,q&&W.trigger(bt?"ajaxSuccess":"ajaxError",[ne,S,bt?rr:hr]),V.fireWith(E,[ne,Ct]),q&&(W.trigger("ajaxComplete",[ne,S]),--a.active||a.event.trigger("ajaxStop")))}return ne},getJSON:function(e,t,i){return a.get(e,t,i,"json")},getScript:function(e,t){return a.get(e,void 0,t,"script")}}),a.each(["get","post"],function(e,t){a[t]=function(i,o,u,p){return L(o)&&(p=p||u,u=o,o=void 0),a.ajax(a.extend({url:i,type:t,dataType:p,data:o,success:u},a.isPlainObject(i)&&i))}}),a.ajaxPrefilter(function(e){var t;for(t in e.headers)t.toLowerCase()==="content-type"&&(e.contentType=e.headers[t]||"")}),a._evalUrl=function(e,t,i){return a.ajax({url:e,type:"GET",dataType:"script",cache:!0,async:!1,global:!1,converters:{"text script":function(){}},dataFilter:function(o){a.globalEval(o,t,i)}})},a.fn.extend({wrapAll:function(e){var t;return this[0]&&(L(e)&&(e=e.call(this[0])),t=a(e,this[0].ownerDocument).eq(0).clone(!0),this[0].parentNode&&t.insertBefore(this[0]),t.map(function(){for(var i=this;i.firstElementChild;)i=i.firstElementChild;return i}).append(this)),this},wrapInner:function(e){return L(e)?this.each(function(t){a(this).wrapInner(e.call(this,t))}):this.each(function(){var t=a(this),i=t.contents();i.length?i.wrapAll(e):t.append(e)})},wrap:function(e){var t=L(e);return this.each(function(i){a(this).wrapAll(t?e.call(this,i):e)})},unwrap:function(e){return this.parent(e).not("body").each(function(){a(this).replaceWith(this.childNodes)}),this}}),a.expr.pseudos.hidden=function(e){return!a.expr.pseudos.visible(e)},a.expr.pseudos.visible=function(e){return!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)},a.ajaxSettings.xhr=function(){try{return new N.XMLHttpRequest}catch{}};var Wn={0:200,1223:204},Tr=a.ajaxSettings.xhr();B.cors=!!Tr&&"withCredentials"in Tr,B.ajax=Tr=!!Tr,a.ajaxTransport(function(e){var t,i;if(B.cors||Tr&&!e.crossDomain)return{send:function(o,u){var p,h=e.xhr();if(h.open(e.type,e.url,e.async,e.username,e.password),e.xhrFields)for(p in e.xhrFields)h[p]=e.xhrFields[p];for(p in e.mimeType&&h.overrideMimeType&&h.overrideMimeType(e.mimeType),e.crossDomain||o["X-Requested-With"]||(o["X-Requested-With"]="XMLHttpRequest"),o)h.setRequestHeader(p,o[p]);t=function(x){return function(){t&&(t=i=h.onload=h.onerror=h.onabort=h.ontimeout=h.onreadystatechange=null,x==="abort"?h.abort():x==="error"?typeof h.status!="number"?u(0,"error"):u(h.status,h.statusText):u(Wn[h.status]||h.status,h.statusText,(h.responseType||"text")!=="text"||typeof h.responseText!="string"?{binary:h.response}:{text:h.responseText},h.getAllResponseHeaders()))}},h.onload=t(),i=h.onerror=h.ontimeout=t("error"),h.onabort!==void 0?h.onabort=i:h.onreadystatechange=function(){h.readyState===4&&N.setTimeout(function(){t&&i()})},t=t("abort");try{h.send(e.hasContent&&e.data||null)}catch(x){if(t)throw x}},abort:function(){t&&t()}}}),a.ajaxPrefilter(function(e){e.crossDomain&&(e.contents.script=!1)}),a.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents:{script:/\b(?:java|ecma)script\b/},converters:{"text script":function(e){return a.globalEval(e),e}}}),a.ajaxPrefilter("script",function(e){e.cache===void 0&&(e.cache=!1),e.crossDomain&&(e.type="GET")}),a.ajaxTransport("script",function(e){var t,i;if(e.crossDomain||e.scriptAttrs)return{send:function(o,u){t=a("<script>").attr(e.scriptAttrs||{}).prop({charset:e.scriptCharset,src:e.url}).on("load error",i=function(p){t.remove(),i=null,p&&u(p.type==="error"?404:200,p.type)}),$.head.appendChild(t[0])},abort:function(){i&&i()}}});var kn,_n=[],rn=/(=)\?(?=&|$)|\?\?/;a.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var e=_n.pop()||a.expando+"_"+yn.guid++;return this[e]=!0,e}}),a.ajaxPrefilter("json jsonp",function(e,t,i){var o,u,p,h=e.jsonp!==!1&&(rn.test(e.url)?"url":typeof e.data=="string"&&(e.contentType||"").indexOf("application/x-www-form-urlencoded")===0&&rn.test(e.data)&&"data");if(h||e.dataTypes[0]==="jsonp")return o=e.jsonpCallback=L(e.jsonpCallback)?e.jsonpCallback():e.jsonpCallback,h?e[h]=e[h].replace(rn,"$1"+o):e.jsonp!==!1&&(e.url+=(Gr.test(e.url)?"&":"?")+e.jsonp+"="+o),e.converters["script json"]=function(){return p||a.error(o+" was not called"),p[0]},e.dataTypes[0]="json",u=N[o],N[o]=function(){p=arguments},i.always(function(){u===void 0?a(N).removeProp(o):N[o]=u,e[o]&&(e.jsonpCallback=t.jsonpCallback,_n.push(o)),p&&L(u)&&u(p[0]),p=u=void 0}),"script"}),B.createHTMLDocument=((kn=$.implementation.createHTMLDocument("").body).innerHTML="<form></form><form></form>",kn.childNodes.length===2),a.parseHTML=function(e,t,i){return typeof e!="string"?[]:(typeof t=="boolean"&&(i=t,t=!1),t||(B.createHTMLDocument?((o=(t=$.implementation.createHTMLDocument("")).createElement("base")).href=$.location.href,t.head.appendChild(o)):t=$),p=!i&&[],(u=rt.exec(e))?[t.createElement(u[1])]:(u=Ar([e],t,p),p&&p.length&&a(p).remove(),a.merge([],u.childNodes)));var o,u,p},a.fn.load=function(e,t,i){var o,u,p,h=this,x=e.indexOf(" ");return x>-1&&(o=er(e.slice(x)),e=e.slice(0,x)),L(t)?(i=t,t=void 0):t&&typeof t=="object"&&(u="POST"),h.length>0&&a.ajax({url:e,type:u||"GET",dataType:"html",data:t}).done(function(_){p=arguments,h.html(o?a("<div>").append(a.parseHTML(_)).find(o):_)}).always(i&&function(_,q){h.each(function(){i.apply(this,p||[_.responseText,q,_])})}),this},a.expr.pseudos.animated=function(e){return a.grep(a.timers,function(t){return e===t.elem}).length},a.offset={setOffset:function(e,t,i){var o,u,p,h,x,_,q=a.css(e,"position"),A=a(e),P={};q==="static"&&(e.style.position="relative"),x=A.offset(),p=a.css(e,"top"),_=a.css(e,"left"),(q==="absolute"||q==="fixed")&&(p+_).indexOf("auto")>-1?(h=(o=A.position()).top,u=o.left):(h=parseFloat(p)||0,u=parseFloat(_)||0),L(t)&&(t=t.call(e,i,a.extend({},x))),t.top!=null&&(P.top=t.top-x.top+h),t.left!=null&&(P.left=t.left-x.left+u),"using"in t?t.using.call(e,P):A.css(P)}},a.fn.extend({offset:function(e){if(arguments.length)return e===void 0?this:this.each(function(u){a.offset.setOffset(this,e,u)});var t,i,o=this[0];return o?o.getClientRects().length?(t=o.getBoundingClientRect(),i=o.ownerDocument.defaultView,{top:t.top+i.pageYOffset,left:t.left+i.pageXOffset}):{top:0,left:0}:void 0},position:function(){if(this[0]){var e,t,i,o=this[0],u={top:0,left:0};if(a.css(o,"position")==="fixed")t=o.getBoundingClientRect();else{for(t=this.offset(),i=o.ownerDocument,e=o.offsetParent||i.documentElement;e&&(e===i.body||e===i.documentElement)&&a.css(e,"position")==="static";)e=e.parentNode;e&&e!==o&&e.nodeType===1&&((u=a(e).offset()).top+=a.css(e,"borderTopWidth",!0),u.left+=a.css(e,"borderLeftWidth",!0))}return{top:t.top-u.top-a.css(o,"marginTop",!0),left:t.left-u.left-a.css(o,"marginLeft",!0)}}},offsetParent:function(){return this.map(function(){for(var e=this.offsetParent;e&&a.css(e,"position")==="static";)e=e.offsetParent;return e||Dt})}}),a.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(e,t){var i=t==="pageYOffset";a.fn[e]=function(o){return Re(this,function(u,p,h){var x;if(f(u)?x=u:u.nodeType===9&&(x=u.defaultView),h===void 0)return x?x[t]:u[p];x?x.scrollTo(i?x.pageXOffset:h,i?h:x.pageYOffset):u[p]=h},e,o,arguments.length)}}),a.each(["top","left"],function(e,t){a.cssHooks[t]=l(B.pixelPosition,function(i,o){if(o)return o=n(i,t),dr.test(o)?a(i).position()[t]+"px":o})}),a.each({Height:"height",Width:"width"},function(e,t){a.each({padding:"inner"+e,content:t,"":"outer"+e},function(i,o){a.fn[o]=function(u,p){var h=arguments.length&&(i||typeof u!="boolean"),x=i||(u===!0||p===!0?"margin":"border");return Re(this,function(_,q,A){var P;return f(_)?o.indexOf("outer")===0?_["inner"+e]:_.document.documentElement["client"+e]:_.nodeType===9?(P=_.documentElement,Math.max(_.body["scroll"+e],P["scroll"+e],_.body["offset"+e],P["offset"+e],P["client"+e])):A===void 0?a.css(_,q,x):a.style(_,q,A,x)},t,h?u:void 0,h)}})}),a.each(["ajaxStart","ajaxStop","ajaxComplete","ajaxError","ajaxSuccess","ajaxSend"],function(e,t){a.fn[t]=function(i){return this.on(t,i)}}),a.fn.extend({bind:function(e,t,i){return this.on(e,null,t,i)},unbind:function(e,t){return this.off(e,null,t)},delegate:function(e,t,i,o){return this.on(t,e,i,o)},undelegate:function(e,t,i){return arguments.length===1?this.off(e,"**"):this.off(t,e||"**",i)},hover:function(e,t){return this.mouseenter(e).mouseleave(t||e)}}),a.each("blur focus focusin focusout resize scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup contextmenu".split(" "),function(e,t){a.fn[t]=function(i,o){return arguments.length>0?this.on(t,null,i,o):this.trigger(t)}});var Vn=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g;a.proxy=function(e,t){var i,o,u;if(typeof t=="string"&&(i=e[t],t=e,e=i),L(e))return o=me.call(arguments,2),u=function(){return e.apply(t||this,o.concat(me.call(arguments)))},u.guid=e.guid=e.guid||a.guid++,u},a.holdReady=function(e){e?a.readyWait++:a.ready(!0)},a.isArray=Array.isArray,a.parseJSON=JSON.parse,a.nodeName=Qe,a.isFunction=L,a.isWindow=f,a.camelCase=j,a.type=be,a.now=Date.now,a.isNumeric=function(e){var t=a.type(e);return(t==="number"||t==="string")&&!isNaN(e-parseFloat(e))},a.trim=function(e){return e==null?"":(e+"").replace(Vn,"")},(K=function(){return a}.apply(ge,[]))===void 0||(ae.exports=K);var Un=N.jQuery,$n=N.$;return a.noConflict=function(e){return N.$===a&&(N.$=$n),e&&N.jQuery===a&&(N.jQuery=Un),a},ce===void 0&&(N.jQuery=N.$=a),a})},703:(ae,ge,K)=>{var N=K(414);function ce(){}function se(){}se.resetWarningCache=ce,ae.exports=function(){function pe(We,xe,Ye,de,Je,Ze){if(Ze!==N){var g=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");throw g.name="Invariant Violation",g}}function me(){return pe}pe.isRequired=pe;var tt={array:pe,bool:pe,func:pe,number:pe,object:pe,string:pe,symbol:pe,any:pe,arrayOf:me,element:pe,elementType:pe,instanceOf:me,node:pe,objectOf:me,oneOf:me,oneOfType:me,shape:me,exact:me,checkPropTypes:se,resetWarningCache:ce};return tt.PropTypes=tt,tt}},697:(ae,ge,K)=>{ae.exports=K(703)()},414:ae=>{ae.exports="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED"},156:ae=>{ae.exports=_t}},un={};function pt(ae){var ge=un[ae];if(ge!==void 0)return ge.exports;var K=un[ae]={id:ae,exports:{}};return Ur[ae].call(K.exports,K,K.exports,pt),K.exports}pt.n=ae=>{var ge=ae&&ae.__esModule?()=>ae.default:()=>ae;return pt.d(ge,{a:ge}),ge},pt.d=(ae,ge)=>{for(var K in ge)pt.o(ge,K)&&!pt.o(ae,K)&&Object.defineProperty(ae,K,{enumerable:!0,get:ge[K]})},pt.o=(ae,ge)=>Object.prototype.hasOwnProperty.call(ae,ge),pt.r=ae=>{typeof Symbol<"u"&&Symbol.toStringTag&&Object.defineProperty(ae,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(ae,"__esModule",{value:!0})};var $r={};return(()=>{pt.r($r),pt.d($r,{addStyles:()=>ge,EditableMathField:()=>K,StaticMathField:()=>N,default:()=>ce});var ae=pt(527);function ge(){if(document.getElementById("react-mathquill-styles")==null){var se=document.createElement("style");se.setAttribute("id","react-mathquill-styles"),se.innerHTML=ae.Z[0][1],document.getElementsByTagName("head")[0].appendChild(se)}}var K=pt(991).Z,N=pt(717).Z;const ce=K})(),$r})()})}(reactMathquill_min)),reactMathquill_min.exports}var reactMathquill={exports:{}},hasRequiredReactMathquill;function requireReactMathquill(){return hasRequiredReactMathquill||(hasRequiredReactMathquill=1,function(module,exports){(function(Ae,at){module.exports=at(M)})(commonjsGlobal$1,function(__WEBPACK_EXTERNAL_MODULE_react__){return(()=>{var __webpack_modules__={"./src/EditableMathField.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{eval(`__webpack_require__.r(__webpack_exports__);
